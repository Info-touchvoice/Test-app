...
import 'package:tiki/view/screens/chat/widgets/unread_message.dart';
import 'package:tiki/view_model/chat_list_controller.dart';
        ...
        builder: (controller) {
          return Column(
            children: [
              ...
              if (chatListViewModel.messagesResults.isNotEmpty &&
                  chatListViewModel.status != Status.Loading)
                Container(
                  height: 650.h,
                  child: ListView.builder(
                    shrinkWrap: true,
                    padding:
                        EdgeInsets.only(left: 5.w, right: 5.w, bottom: 35.h),
                    // itemCount: chatListViewModel.messagesResults.length,
                    itemCount: chatListViewModel.messagesResults.length,
                    itemBuilder: (context, index) {
                      MessageListModel chatMessage =
                          chatListViewModel.messagesResults[index];

                      UserModel chatUser = chatMessage.getAuthorId! ==
                              Get.find<UserViewModel>().currentUser.objectId!
              ...
              if (chatListViewModel.messagesResults.isEmpty &&
                  chatListViewModel.status != Status.Loading)
                Expanded(
                  child: Column(
