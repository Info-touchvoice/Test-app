...
import 'package:tiki/ui/gradient_text_widget.dart';
...
import 'package:tiki/view_model/whisper_controller.dart';
...
class MessageGiftSheet extends StatefulWidget {
  ...
  MessageGiftSheet(
      {this.profileUser, this.whisper = false, this.isProfileUser = false});
        ...
        Padding(
          ...
          child: Row(
            children: [
              Text('Lv.1',
                  style:
                      sfProDisplayMedium.copyWith(color: AppColors.greyText)),
              const Spacer(),
              Text('EXP  3350/5000',
                  style:
                      sfProDisplayMedium.copyWith(color: AppColors.greyText)),
                ...
                children: [
                  Expanded(
                    child: StreamerGiftCard(
                      ...
                      score: '5/5',
                      progress: 0.9,
                      bgColor: selectedGift == AppImagePath.lamborghiniImage
                          ? AppColors.yellow
                  ...
                  Expanded(
                    child: StreamerGiftCard(
                      ...
                      score: '4/5',
                      progress: 0.7,
                      bgColor: selectedGift == AppImagePath.bearCastleImage
                          ? AppColors.yellow
                          : AppColors.borderColor.withOpacity(0.15),
                      onSelect: () {
                        setState(() {
                  ...
                  Expanded(
                    child: StreamerGiftCard(
                      ...
                      score: '5/10',
                      progress: 0.5,
                      bgColor: selectedGift == AppImagePath.yachtIslandImage
                          ? AppColors.yellow
                          : AppColors.borderColor.withOpacity(0.15),
                      onSelect: () {
                        setState(() {
                ...
                children: [
                  Expanded(
                    child: StreamerGiftCard(
                      ...
                      score: '5/5',
                      progress: 0.9,
                      bgColor: selectedGift == AppImagePath.babyDragonImage
                          ? AppColors.yellow
                          : AppColors.borderColor.withOpacity(0.15),
                      onSelect: () {
                        setState(() {
                  ...
                  Expanded(
                    child: StreamerGiftCard(
                      ...
                      score: '5/10',
                      progress: 0.5,
                      bgColor: selectedGift == AppImagePath.heartsImage
                          ? AppColors.yellow
                          : AppColors.borderColor.withOpacity(0.15),
                      onSelect: () {
                        setState(() {
                  ...
                  Expanded(
                    child: StreamerGiftCard(
                      ...
                      score: '5/5',
                      progress: 0.9,
                      bgColor: selectedGift == AppImagePath.kissingImage
                          ? AppColors.yellow
                          : AppColors.borderColor.withOpacity(0.15),
                      onSelect: () {
                        setState(() {
                ...
                children: [
                  ...
                  Expanded(
                    child: StreamerGiftCard(
                      ...
                      score: '4/5',
                      progress: 0.7,
                      bgColor: selectedGift == AppImagePath.motorCycleImage
                          ? AppColors.yellow
                          : AppColors.borderColor.withOpacity(0.15),
                      onSelect: () {
                        setState(() {
                    ...
                    PrimaryButton(
                      ...
                      onTap: () {
                        if (widget.whisper == false)
                          Get.find<ChatViewModel>().saveMessage(
                              MessageModel.messageTypeGif,
                              messageType: MessageModel.messageTypeGif,
                              onTap: () {},
                              gif: selectedGift,
                              coins: selectedCoin,
                              amount: int.parse(selectedQuantity));
                        else
                          Get.find<WhisperViewModel>().saveMessage(
                              MessageModel.messageTypeGif,
                              messageType: MessageModel.messageTypeGif,
                              onTap: () {},
                              gif: selectedGift,
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: GradientText(
            ...
            style: sfProDisplayRegular.copyWith(color: AppColors.white),
          ),
        ),
      ),
    );
