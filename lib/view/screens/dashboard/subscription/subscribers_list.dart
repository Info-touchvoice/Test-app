        ...
        child: ListView(
          children: [
            ...
            FutureBuilder<List<SubscriptionModel>>(
              future: subscriptionViewModel.getUserSubscribers(Get.find<
                      UserViewModel>()
                  .currentUser), // Replace fetchData() with your actual function to fetch data
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  List<SubscriptionModel> modelList =
                      snapshot.data as List<SubscriptionModel>;
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Padding(
                        padding: EdgeInsets.only(
                            bottom: 18, left: 15.w, right: 18.w),
                        child: Row(
                          children: [
                            Stack(
                              children: [
                                CircleAvatar(
                                  ...
                                  backgroundImage: NetworkImage(subscription
                                      .getSubscriber!.getAvatar!.url!),
                                ),
                                Positioned(
                                  bottom: 0,
                                  right: 1,
                            ...
                            Column(
                              ...
                              children: [
                                Row(
                                  children: [
                                    Text(subscription
                                        .getSubscriber!.getFullName!),
                                    const SizedBox(width: 16),
                                    if (subscription
                                            .getSubscriber!.getHideMyLocation ==
                                        false)
                                      SvgPicture.asset(
