...
import 'package:tiki/view/screens/userProfileView/widget/share_modal_sheet.dart';
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      color: Colors.red,
                      child: Image(
                        image: QuickHelp.getUserAvatarProvider(controller.profile),
                              ...
                              children: [
                                ...
                                Text(
                                  QuickHelp.getAgeFromDate(
                                          controller.profile!.getBirthday!)
                                      .toString(),
                                  style: TextStyle(
                                    fontSize: 9.sp,
                        ...
                        children: [
                          GestureDetector(
                            onTap: () => Get.toNamed(
                              ...
                              arguments: {'userModel': controller.profile},
                            ),
                            child: Column(
                              children: [
                                Text(
