        ...
        child: SingleChildScrollView(
          child: GetBuilder<UserViewModel>(
              ...
              builder: (userViewModel) {
                return Padding(
                  padding:
                      EdgeInsets.only(left: 20.w, right: 20.w, bottom: 45.h),
                  child: Column(
                        ...
                        child: Row(
                          children: [
                            ...
                            CircleAvatar(
                              ...
                              backgroundImage: NetworkImage(rankingViewModel
                                  .ranking[index + 3]
                                  .getGifter!
                                  .getAvatar!
                                  .url!),
                            ...
                            Column(
                              ...
                              children: [
                                Row(
                                  children: [
                                    Text(rankingViewModel.ranking[index + 3]
                                        .getGifter!.getFullName!),
                                    SizedBox(width: 12.w),
                                    Container(
                                      width: 39.w,
                                      height: 12.h,
                            ...
                            GestureDetector(
                              onTap: () {
                                userViewModel.followOrUnFollow(rankingViewModel
                                    .ranking[index + 3].getGifter!.objectId!);
                              },
                              child: Container(
                                width: 62.w,
                                height: 32.h,
