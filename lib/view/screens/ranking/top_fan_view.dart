...
class _TopFanViewState extends State<TopFanView> {
  ...
  Widget build(BuildContext context) {
    ...
    final backgroundColor = isLightTheme ? Colors.white : AppColors.cardBg;

    rankingViewModel.fetchTopFansRanking();
    if (activeTab == "Daily")
      ranking = rankingViewModel.dailyTopFansRanking;
    else if (activeTab == "Weekly")
      ranking = rankingViewModel.dailyLevelRanking;
    else
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            capitalizeEachWord(author?.getFullName ?? ''),
