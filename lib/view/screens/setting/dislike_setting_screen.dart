                  ...
                  builder: (controller) {
                    return Column(
                      children: [
                        ...
                        ...List.generate(userViewModel.blockList.length,
                            (index) {
                          UserModel user =
                              userViewModel.blockList[index] as UserModel;
                          return Padding(
                            padding: const EdgeInsets.only(bottom: 18),
                            child: Row(
                              children: [
                                ...
                                PrimaryButton(
                                  ...
                                  height: 32.h,
                                  title: controller
                                          .currentUser.getBlockedUsersIds!
                                          .contains(user.getUid!)
                                      ? 'Unblock'
                                      : 'Block',
                                  borderRadius: 35,
                                  textStyle: sfProDisplayMedium.copyWith(
                                  ...
                                  onTap: () {
                                    if (controller
                                        ...
                                        .contains(user.getUid!))
                                      controller
                                          .removeFromBlockList(user.getUid!);
                                    else
