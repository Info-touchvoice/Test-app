                  ...
                  child: Column(
                    children: [
                      ...
                      PrimaryButton(
                          ...
                          title: userViewModel.currentUser.getSelfBanStatus
                              ? "Remove Ban"
                              : "Self Ban",
                          onTap: () {
                            QuickActions.showAlertDialog(
                                context,
                                userViewModel.currentUser.getSelfBanStatus
                                    ? "Are you sure you want to remove ban?"
                                    : "Are you sure you want to self ban?", () {
                              Get.back();
                              userViewModel.changeSelfBanStatus();
                            });
                          }),
                    ],
                  ),
