...
// import 'package:tiki/ui/app_bar.dart';
...
//   final vFile;
//
//   ReelsVideosScreen({this.currentUser, this.mUser, this.preferences, this.uploadVideo='',this.vFile, required this.videoFile, required this.parseFileBase, required this.uploadPhoto,required this.isVideo});
//
//   @override
...
//     parseFileThumbnail=widget.parseFileBase;
...
//                                   height: 400,
//                                   borderRadius: 10,
//                                   child: Image.file(File(uploadPhoto!)),
//                                       // : Icon(
...
//                                   //     MaterialPageRoute(
//                                   //         builder: (context) =>
//                                   //             CustomVideoRecordingScreen(currentUser:widget.currentUser))).then((result) {
//                                   //               if (result != null && result is Map) {
//                                   //               // Access the parameters using result['parameterKey']
//                                   //                 setState((){
...
//                                           //   // Check if the route's name is '/target'
//                                           //   return route.settings.name == '/home/reels';
//                                           // });
...
//                                         if (parseFile != null &&
//                                             uploadPhoto != null) {
//                                           await savePost(text: postContent.text);
//                                           Navigator.of(context).popUntil((route) {
//                                             // Check if the route's name is '/target'
//                                             return route.settings.name == '/home/reels';
//                                           });
