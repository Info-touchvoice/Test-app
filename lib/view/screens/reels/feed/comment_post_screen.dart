...
class _CommentPostScreenState extends State<CommentPostScreen> {
                    ...
                    Flexible(
                      child: Column(
                        ...
                        children: [
                          ...
                          TextWithTap(QuickHelp.getTimeAgo(commentsModel.createdAt!),
                            marginLeft: 10,
                            color: Color(0xff000000),
                            fontWeight: FontWeight.w500,
                            marginTop: 10,
  ...
  Widget liveReply(CommentsModel commentModel, bool showAll) {
    ...
    return ParseLiveListWidget<ReplyModel>(
      ...
      childBuilder: (BuildContext context,
        ...
        if (snapshot.hasData) {
          ...
          ReplyModel replyModel = snapshot.loadedData as ReplyModel;
            ...
            child: Column(
              children: [
                Row(
                  ...
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: [
                    QuickActions.avatarWidget(replyModel.getAuthor!,
                        width: 60, height: 60
                    ),
                    Flexible(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          TextWithTap(replyModel.getAuthor!.getFullName!,
                            marginLeft: 10,
                            marginBottom: 5,
                            fontWeight: FontWeight.bold,
                            color: kGrayColor,
                          ...
                          TextWithTap(replyModel.getText!,
                            marginLeft: 10,
                            marginRight: 10,
                            color: kGrayColor,
                          ),
                          TextWithTap(QuickHelp.getTimeAgoForFeed(replyModel.createdAt!),
                            marginLeft: 10,
                            color: kGrayColor,
                            marginTop: 10,
                            fontSize: 12,
  ...
  _blockUser(UserModel author) async {
    ...
    currentUser!.setBlockedUserIds = author.getUid!;
