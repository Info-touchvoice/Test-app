  ...
  Widget build(BuildContext context) {
    return BaseScaffold(
      padding: EdgeInsets.only(
          left: Dimension.borderRadius, right: Dimension.borderRadius),
              ...
              children: [
                ...
                AppTextFormField(
                    ...
                    suffixIcon: IconButton(
                      ...
                      icon: Icon(isConfirmPasswordObscure.value
                          ? Icons.visibility_off_outlined
                          : Icons.visibility_outlined),
                    ),
                    validator: (value) {
                ...
                appButton(context, "Create Account", () {
                  if (_formKey.currentState!.validate()) {
                    authViewModel.signUpWithUserName(
                ...
                SizedBox(
                  height: isFormDirty.value ? Dimension.borderRadius : 0,
                )
              ],
            ),
          );
