...
class SocialLogin {
    ...
    try {
      ...
      if (authentication.accessToken == null || authentication.idToken == null) {
        ...
        QuickHelp.showAppNotificationAdvanced(
          ...
          message:
              "Missing Google token(s). This is usually a Firebase/Google config issue.\n"
              "Please add SHA-1 to Firebase for your debug keystore and re-download google-services.json.",
        );
        await _googleSignIn.signOut();
        return;
      }
  ...
  static void getAppleUserDetails(BuildContext context, UserModel user, AuthorizationCredentialAppleID credentialAppleID, SharedPreferences preferences) async {
    ...
    //     width: 640, height: 640, keywords: ["people", "sexy", "parse"], random: true);
    //
