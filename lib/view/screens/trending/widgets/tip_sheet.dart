        ...
        child: Column(
          ...
          children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Center(
                            child: Text(
                              goldData[index]['amount'] == '5000'
                                  ? '5k'
                                  : goldData[index]['amount'] == '10000'
                                      ? '10k'
                                      : goldData[index]['amount'] == '100000'
                                          ? '100k'
                                          : goldData[index]['amount'],
                              style: TextStyle(
                                fontSize: 14,
            ...
            PrimaryButton(
                ...
                onTap: () {
                  if (selectedIndex != -1) {
                    if (Get.find<UserViewModel>().checkCoins(
                        int.parse(goldData[selectedIndex]["amount"]))) {
                      Get.find<UserViewModel>().deductBalance(
                          int.parse(goldData[selectedIndex]["amount"]));
                      Get.back();
                      QuickHelp.showAppNotification(
                          title: 'Reward successfully sent to the creator.',
                          context: context,
                          isError: false);
                    } else {
