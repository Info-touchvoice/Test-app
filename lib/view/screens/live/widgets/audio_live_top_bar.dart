...
import 'package:tiki/view/screens/live/widgets/subscrption/subscriber_detail_sheet.dart';
                    ...
                    children: [
                        ...
                        children: [
                          Container(
                            ...
                            child: Row(
                              children: [
                                GestureDetector(
                                  onTap: () => HiloAudioRoomInfoSheet.show(context),
                                  child: Row(
                                    children: [
                                      CircleAvatar(
                                        radius: 17,
                                ...
                                if (liveViewModel.role == ZegoLiveRole.audience)
                                  GestureDetector(
                                      ...
                                      child: Image.asset(AppImagePath.badge,
                                          width: 28, height: 28)),
                                SizedBox(
                                    width: liveViewModel.role ==
                                            ZegoLiveRole.audience
                                        ? 5
                                        : 12),
                                if (liveViewModel.role ==
                                        ZegoLiveRole.audience &&
                                    !userViewModel.followingUser(liveViewModel
                                ...
                                if (liveViewModel.role ==
                                  ...
                                  GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      child:
                                          Image.asset(AppImagePath.filterStar),
                                    ),
                                  ),
                              ],
                            ),
                      ...
                      InkWell(
                        ...
                        child: CircleAvatar(
                          ...
                          child: Text(
                            liveViewModel
                                .liveStreamingModel.getViewersId!.length
                                .toString(),
                            style: sfProDisplayMedium.copyWith(
                          ...
                          child: Align(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: liveViewModel.liveStreamingModel
                                            .getDisableWishList ==
                                        false
                                    ? AppColors.divider
                                    : Colors.transparent,
                              ...
                              child: Visibility(
                                visible: liveViewModel.liveStreamingModel
                                        .getDisableWishList ==
                                    false,
                                child: Row(
                          ...
                          child: GestureDetector(
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  padding:
                                      EdgeInsets.fromLTRB(3.w, 2.h, 9.w, 0.h),
                                  height: 32.h,
                                  decoration: BoxDecoration(
