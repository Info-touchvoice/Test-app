...
import 'package:tiki/view/screens/live/widgets/subscrption/subscriber_sheet.dart';
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        ...
                        ToolWidget(
                            title: 'Beauty',
                            icon: AppImagePath.beauty,
                            onTap: () => openBottomSheet(
                                StickerModalSheet(), context,
                                back: true)),
                        SizedBox(width: 32),
                        ToolWidget(
                            title: 'BGM',
                            icon: AppImagePath.bgm,
                            onTap: () => openBottomSheet(
                                LocalMusicWidget(), context,
                                back: true)),
                        SizedBox(width: 32),
                        ToolWidget(
                            title: 'Whispers',
                            icon: AppImagePath.whisper,
                            onTap: () => openBottomSheet(
                                WhisperModal(), context,
                                back: true)),
                        SizedBox(width: 32),
                        ToolWidget(
                            title: 'Announcement',
                      ...
                      children: [
                          ...
                          ValueListenableBuilder<bool>(
                              ...
                              builder: (context, cameraOn, _) {
                                return ToolWidget(
                                  ...
                                  iconColor:
                                      cameraOn ? null : AppColors.yellowColor,
                        ...
                        ValueListenableBuilder<bool>(
                            valueListenable: zegoController
                                .expressService.currentUser!.isMicOnNotifier,
                            builder: (context, micOn, _) {
                              return ToolWidget(
                                ...
                                icon: micOn
                                    ...
                                    : AppImagePath.micOff,
                                onTap: () {
                                  final user = zegoController
                                      .expressService.currentUser!;
                                  user.isMicOnNotifier.value =
                                      !user.isMicOnNotifier.value;
                                  ZEGOSDKManager.instance.expressService
                                      .turnMicrophoneOn(
                                          user.isMicOnNotifier.value);
                        ...
                        ToolWidget(
                            title: 'Data',
                            icon: AppImagePath.dataIcon,
                            onTap: () => openBottomSheet(
                                DataSheetWidget(), context,
                                back: true)),
                        SizedBox(width: 32),
                        ToolWidget(
                            title: 'Record',
                        ...
                        GestureDetector(
                            ...
                            child: ToolWidget(
                                title: 'Setting',
                                icon: AppImagePath.settings,
                                onTap: () => openBottomSheet(
                                    LiveSettingSheet(), context,
                                    back: true))),
                      ],
                    ),
                  ),
