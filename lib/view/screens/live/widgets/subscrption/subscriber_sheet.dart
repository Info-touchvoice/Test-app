...
import 'package:tiki/view/screens/live/widgets/subscrption/single_live_subscriber_sheet.dart';
...
class _SubscriberSheetState extends State<SubscriberSheet> {
  ...
  void initState() {
    textEditingController.text =
        Get.find<UserViewModel>().currentUser.getSubscribeAnnouncement ??
  ...
  @override
  void dispose() {
    Get.find<UserViewModel>().currentUser.setSubscriptionAnnouncement =
        textEditingController.text;
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                  color: Color(0xffBD8DF4), width: 3)),
                          child: Padding(
                            ...
                            onSubmitted: (value) {
                              if (value.isNotEmpty) {
                                Get.find<UserViewModel>()
                                    .currentUser
                                    .setSubscriptionAnnouncement = value;
                                Get.find<UserViewModel>().update();
                              }
                            },
