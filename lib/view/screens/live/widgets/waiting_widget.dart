          ...
          child: SingleChildScrollView(
            child: ValueListenableBuilder(
                ...
                builder: (context, Map<String, dynamic> requestMap, _) {
                  ...
                  List userIdList =
                      requestList.map((obj) => obj.senderID).toList();
                  numberOfItems = requestMap.values.toList().length;
                              ...
                              return Padding(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    const Spacer(),
                                    if (Get.find<LiveViewModel>().role ==
                                        ZegoLiveRole.host)
                                                ...
                                                if (liveViewModel
                                                  ...
                                                  QuickHelp
                                                      .showAppNotificationAdvanced(
                                                          title:
                                                              'You currently have a co-host. To add a new one, please remove the existing co-host first.',
                                                          context: context);
                                                } else {
                                                  ZEGOSDKManager
                                                      .instance.zimService
