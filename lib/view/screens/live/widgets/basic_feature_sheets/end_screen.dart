                    ...
                    child: Padding(
                      ...
                      child: CircleAvatar(
                        backgroundImage: NetworkImage(
                          liveViewModel
                              .liveStreamingModel.getAuthor!.getAvatar!.url!,
                        ),
                      ),
                    ),
                  ),
                  ...
                  child: Row(
                    ...
                    children: [
                      Column(
                        children: [
                          Text(
                            "${liveViewModel.liveStreamingModel.getViewsCount ?? 0}",
                            style: TextStyle(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        GradientText(
                          text: formatTime(int.parse(
                              liveViewModel.liveStreamingModel.getLiveTime ??
                                  "0")),
                          // '0',
                          style: TextStyle(
                              fontSize: 16.sp,
