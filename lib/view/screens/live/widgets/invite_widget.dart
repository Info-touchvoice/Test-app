                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        children: [
                          ...
                          ...List.generate(
                            liveViewModel.friendsList.length <= 2
                                ? liveViewModel.friendsList.length
                                : seeMore == false
                                    ? 3
                                    : liveViewModel.friendsList.length,
                            (index) => Padding(
                              ...
                              child: Row(
                                children: [
                                  CircleAvatar(
                                    ...
                                    backgroundImage: NetworkImage(liveViewModel
                                        .friendsList[index].getAvatar!.url!),
                                  ),
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          Text(liveViewModel.friendsList[index]
                                                  .getFullName ??
                                              ''),
                                          const SizedBox(width: 16),
                                          if (liveViewModel.friendsList[index]
                                                  .getHideMyLocation ==
                                              false)
                                            SvgPicture.asset(
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          Text(liveViewModel.liveUsers[index]
                                                  .getFullName ??
                                              ''),
                                          const SizedBox(width: 16),
                                          if (liveViewModel.liveUsers[index]
                                                  .getHideMyLocation ==
                                              false)
                                            SvgPicture.asset(
                                              QuickActions.getCountryFlag(
              ...
              onTap: () {
                if (selectedIndex != -1)
                  ...
                  QuickHelp.showAppNotificationAdvanced(
                      title: "Please select a user", context: context);
              },
            ),
          ),
        ),
