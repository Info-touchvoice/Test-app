...
class _WishListStreamerSheetState extends State<WishListStreamerSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < liveViewModel.myWishList!.length; i++) {
      temp = temp +
          (int.parse(
                  liveViewModel.myWishList![i][LiveStreamingModel.keyAmount]) *
              3);
    ...
    return GetBuilder<LiveViewModel>(
        ...
        builder: (liveViewModel) {
          ...
          for (int i = 0; i < liveViewModel.myWishList!.length; i++) {
            temp = temp +
                (int.parse(liveViewModel.myWishList![i]
                              ...
                              Positioned(
                                ...
                                child: Align(
                                  child: SizedBox(
                                    ...
                                    height: 14 * fem,
                                    child: Text(
                                      ' Make a wish and your audience will help achieve it- ',
                          ...
                          child: Column(children: [
                            Row(
                              children: [
                                ...
                                GradientCupertinoSwitch(
                                  value: !liveViewModel
                                      .liveStreamingModel.getDisableWishList!,
                                  onChanged: (val) {
                                    liveViewModel.liveStreamingModel
                                        .setDisableWishList = !val;
                            ...
                            Expanded(
                              child: GridView.builder(
                                ...
                                itemCount: length,
                                shrinkWrap:
                                    true, // Provide the number of items in your grid
                                gridDelegate:
                                    SliverGridDelegateWithFixedCrossAxisCount(
                                  crossAxisCount: 3,
                                  childAspectRatio:
                                      0.75, // Set the number of columns
                                  crossAxisSpacing: 12.42 *
                                      fem, // Set spacing between columns
                                  mainAxisSpacing:
                                      12 * fem, // Set spacing between rows
                                ),
                                                      ...
                                                      child:
                                                        ...
                                                        valueColor:
                                                            AlwaysStoppedAnimation<
                                                                    Color>(
                                                                AppColors
                                                                    .progressLinearGreenColor1), // Color of the progress indicator
                                                        value: double.parse(liveViewModel
                                                                        .myWishList![
                                                                    index][
                                                                LiveStreamingModel
                                                                    .keyReceived]) /
                                                            double.parse(liveViewModel
                                                                        .myWishList![
                                                                    index][
                                                                LiveStreamingModel
