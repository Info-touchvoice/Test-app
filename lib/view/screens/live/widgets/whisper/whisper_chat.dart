...
class _WhisperChatState extends State<WhisperChat> {
  ...
  void dispose() {
    if (whisperViewModel.subscription != null) {
      whisperViewModel.liveQuery.client
          .unSubscribe(whisperViewModel.subscription!);
    }
    if (Get.find<LiveViewModel>().role == ZegoLiveRole.audience)
  ...
  Widget build(BuildContext context) {
    return GetBuilder<WhisperListViewModel>(builder: (controller) {
      return GetBuilder<WhisperViewModel>(builder: (whisperViewModel) {
        return Container(
          height: 520.h,
          child: Stack(
            children: [
                  ...
                  children: [
                          ...
                          builder:
                            ...
                            if (snapshot.hasData) {
                              ...
                              return StickyGroupedListView<dynamic, DateTime>(
                                ...
                                itemComparator:
                                    (dynamic element1, dynamic element2) {
                                ...
                                itemBuilder: (context, dynamic chatMessage) {
                                  ...
                                  if (chatMessage.getMessageList != null &&
                                    ...
                                    WhisperListModel chatList = chatMessage
                                        .getMessageList as WhisperListModel;

                                    if (!chatList.isRead! &&
                                        chatList.objectId ==
                                            chatMessage.getMessageListId) {
                                      whisperViewModel.updateMessageList(
                                      ...
                                      children: [
                                        if (!isMe) ...[
                                          Container(
                                            ...
                                            child: widget.mUser!.getAvatar !=
                                                    null
                                                ? ClipOval(
                                                    child: Image.network(
                                                      widget.mUser!.getAvatar!
                                                          .url!,
                                                      height: double.infinity,
                                                      width: double.infinity,
                                                      fit: BoxFit.cover,
                    ...
                    Row(
                      children: [
                        GestureDetector(
                          onTap: () {
                            whisperViewModel.saveMessage(
                                whisperViewModel.messageController.text,
                                messageType: WhisperModel.messageTypeText,
                                onTap: () {});
                            whisperViewModel.messageController.text = "";
              ...
              Align(
                ...
                child: Padding(
                  padding: EdgeInsets.fromLTRB(
                      15, 0, 15, MediaQuery.of(context).viewInsets.bottom + 15),
                  child: Row(
                    children: [
                      GestureDetector(
                        onTap: () {
