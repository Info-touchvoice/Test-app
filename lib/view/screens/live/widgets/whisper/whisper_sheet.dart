        ...
        builder: (controller) {
          return Column(
            ...
            children: [
              Expanded(
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...List.generate(
                          whisperListViewModel.messagesResults.length, (index) {
                        WhisperListModel chatMessage =
                            whisperListViewModel.messagesResults[index];
                          ...
                          child: Row(
                            children: [
                              CircleAvatar(
                                ...
                                backgroundImage:
                                    NetworkImage(chatUser.getAvatar!.url!),
                              ),
              ...
              if (controller.messagesResults.isEmpty &&
