...
import 'package:tiki/view/screens/live/single_live_streaming/single_audience_live/widgets/screen_recording_sheet.dart';
import 'package:tiki/view/screens/live/widgets/subscrption/susbcription_audience_sheet.dart';
import 'package:tiki/view/screens/live/widgets/whisper/whisper_chat.dart';
import 'package:tiki/view_model/subscription_model.dart';
                            ...
                            children: [
                              Obx(() {
                                return GestureDetector(
                                  onTap: () {
                                    Get.find<LiveViewModel>().toggleDislike =
                                        Get.find<LiveViewModel>().dislike.value;
                                  },
                                  child: ToolWidget(
                                    title: 'Dislike',
                                    icon: AppImagePath.dislikeIcon,
                                    color:
                                        Get.find<LiveViewModel>().dislike.value
                              ...
                              if (Get.find<SubscriptionViewModel>()
                              ...
                              if (Get.find<SubscriptionViewModel>()
                                ...
                                GestureDetector(
                                    onTap: () {
                                      openBottomSheet(
                                          WhisperChat(Get.find<LiveViewModel>()
                                              .liveStreamingModel
                                              .getAuthor),
                                          context);
                                    },
