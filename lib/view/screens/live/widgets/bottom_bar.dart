...
import 'audio_live_invitation_sheet.dart';
    ...
    return GetBuilder<ZegoController>(
        ...
        builder: (zegoController) {
          return ValueListenableBuilder<ZegoLiveRole>(
              valueListenable: liveViewModel.isAudioLive
                  ? ZegoLiveAudioRoomManager.instance.roleNoti
              ...
              builder: (context, role, _) {
                return Row(
                  children: [
                    ...
                    if (role != ZegoLiveRole.audience) const SizedBox(width: 8),
                    ...
                    if (role == ZegoLiveRole.host)
                      ValueListenableBuilder(
                          valueListenable: ZEGOSDKManager
                              .instance.zimService.roomRequestMapNoti,
                          builder:
                              (context, Map<String, dynamic> requestMap, _) {
                            return GestureDetector(
                              onTap: () {
                                showModalBottomSheet(
                                  context: context,
                              ...
                              child: CircleAvatar(
                                ...
                                backgroundColor: Colors.black.withOpacity(0.5),
                                child: GradientWrapper(
                                  applyGradient: requestMap.isNotEmpty,
                    ...
                    if (role == ZegoLiveRole.coHost)
                      GestureDetector(
                        onTap: () {
                          if (liveViewModel.isAudioLive)
                            for (final element in zegoController
                                .liveAudioRoomManager.seatList) {
                              if (element.currentUser.value?.userID ==
                                ...
                                zegoController.liveAudioRoomManager
                                    ...
                                    .then((value) {
                                  zegoController.liveAudioRoomManager.roleNoti
                                      .value = ZegoLiveRole.audience;
