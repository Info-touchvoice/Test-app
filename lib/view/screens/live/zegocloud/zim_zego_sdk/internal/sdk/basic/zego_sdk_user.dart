...
class ZegoSDKUser {
  ...
  /// Voice activity indicator (0.0..100.0-ish depending on SDK settings).
  /// Updated via ZegoExpressEngine sound level callbacks.
  ValueNotifier<double> soundLevelNotifier = ValueNotifier(0.0);
}
