...
Future<void> createEngine(
  ...
  try {
    await ZEGOSDKManager.instance.expressService.uninit();
  } catch (_) {}
  try {
    await ZEGOSDKManager.instance.zimService.uninit();
  } catch (_) {}

  await ZEGOSDKManager.instance
      .init(SDKKeyCenter.appID, kIsWeb ? null : SDKKeyCenter.appSign, scenario: scenario)
