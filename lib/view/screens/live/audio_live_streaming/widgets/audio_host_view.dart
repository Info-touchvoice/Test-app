      ...
      children: [
        ValueListenableBuilder<ZegoSDKUser?>(
            ...
            builder: (context, user, _) {
              ...
              if (user == null) return avatar;

              return ValueListenableBuilder<double>(
                valueListenable: user.soundLevelNotifier,
                builder: (context, level, _) {
                  return ValueListenableBuilder<bool?>(
                    valueListenable: user.isMicOnNotifier,
                    builder: (context, isMicOn, __) {
                      final speaking = (isMicOn != false) && level > _speakThreshold;
                      return SpeakingWave(
                        isSpeaking: speaking,
                        size: 73.r,
                        color: AppColors.yellowBtnColor,
        ...
        Row(
          ...
          children: [
            ...
            GradientText(
              text: liveViewModel.liveStreamingModel.getTotalCoins.toString(),
