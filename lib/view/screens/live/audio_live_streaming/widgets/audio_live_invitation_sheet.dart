...
import 'package:tiki/view/screens/live/audio_live_streaming/widgets/waiting_widget.dart';
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              mainAxisAlignment:
                  Get.find<LiveViewModel>().role == ZegoLiveRole.host
