...
import 'package:tiki/view/screens/live/single_live_streaming/single_audience_live/widgets/audience_gift_card.dart';
...
class AudienceGiftSheet extends StatefulWidget {
  ...
  AudienceGiftSheet(
      {this.battleViewModel, this.profileUser, this.isProfileUser = false});
...
class _AudienceGiftSheetState extends State<AudienceGiftSheet> {
  ...
  void initState() {
    ...
    Get.find<LiveViewModel>().receiverUid =
        Get.find<LiveViewModel>().liveStreamingModel.getAuthorUid ?? 0;
    super.initState();
  }
                ...
                return ValueListenableBuilder<List<ZegoSDKUser>>(
                    ...
                    builder: (context, coHostList, _) {
                      ...
                      return Column(
                        ...
                        children: [
                          SizedBox(
                              height: battleViewModel != null &&
                                      battleViewModel!.isBattleView
                                  ? 16
                                  : 12),
                          if ((liveViewModel.isMultiGuest ||
                                  (liveViewModel.isSingleLive &&
                                      length != 0)) &&
                              liveViewModel.role == ZegoLiveRole.audience &&
                              widget.isProfileUser == false)
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  const Spacer(),
                                  if (battleViewModel!.battleModel.getHost !=
                                      null)
                                    GestureDetector(
                                      onTap: () {
                                        setState(() {
                              ...
                              children: [
                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: LinearPercentIndicator(
                                          ...
                                          percent: userViewModel.xpFactor,
                                ...
                                Align(
                                  ...
                                  child: Container(
                                    ...
                                    child: Image.asset(AppImagePath.chestIcon,
                                        height: 28, width: 28),
                                  ),
                                ),
                              ],
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                const Spacer(),
                                Text('EXP  ${userViewModel.xp}/5000',
                                    style: sfProDisplayMedium.copyWith(
                                        color: AppColors.greyText)),
                                    ...
                                    children: [
                                      Expanded(
                                        child: StreamerGiftCard(
                                          giftImage:
                                              AppImagePath.lamborghiniImage,
                                          giftName: 'Lamborghini',
                                          coins: '10',
                                          score: '5/5',
                                          progress: 0.9,
                                          bgColor: selectedGift ==
                                          ...
                                          onSelect: () {
                                            setState(() {
                                              selectedGift =
                                                  AppImagePath.hearts;
                                              selectedGiftMp3 =
                                                  AppImagePath.heartMp3;
                                              selectedGiftPath =
                                                  AppImagePath.heartsImage;
                                          ...
                                          onSelect: () {
                                            setState(() {
                                              selectedGift =
                                                  AppImagePath.kissingGift;
                                              selectedGiftMp3 =
                                                  AppImagePath.kissingGiftMp3;
                                              selectedGiftPath =
                                                  AppImagePath.kissingImage;
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                Row(
                                  children: [
                                    Image.asset(AppImagePath.coinsIcon,
                                        width: 15, height: 15),
                                    const SizedBox(width: 5),
                                    Text(
                                      QuickActions.formatValue(
                                          userViewModel.currentUser.getCoins),
                                    ),
                                    const SizedBox(width: 5),
                                    GradientWrapper(
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border.all(
              color: AppColors.borderColor.withOpacity(0.15), width: 2),
        ...
        child: Padding(
          ...
          child: GradientText(
            ...
            style: sfProDisplayRegular.copyWith(
                color: isSelected ? AppColors.yellowColor : AppColors.white),
          ),
        ),
      ),
    );
