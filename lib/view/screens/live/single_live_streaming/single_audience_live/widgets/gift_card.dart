              ...
              child: Container(
                ...
                child: ClipRRect(
                  ...
                  child: LinearProgressIndicator(
                    ...
                    value:
                        progress, // Set the value of the progress bar (between 0.0 and 1.0)
                  ),
                ),
              ),
            ),
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  PrimaryButton(
                    title: int.parse(score) >= int.parse(coins)
                        ? 'Completed'
                        : 'Send',
                    textStyle: sfProDisplayRegular.copyWith(
                        fontSize:
                            int.parse(score) >= int.parse(coins) ? 13 : 15,
