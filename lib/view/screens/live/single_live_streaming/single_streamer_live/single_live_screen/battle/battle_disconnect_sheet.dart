      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: NetworkImage(Get.find<BattleViewModel>()
                        .battleModel
                        .getHost!
                        .getAvatar!
                        .url!),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image:
                        NetworkImage(Get.find<BattleViewModel>().playerBAvatar),
                  ),
                  shape: BoxShape.circle,
                  border: Border.all(color: AppColors.white, width: 2.5),
                ),
          ...
          PrimaryButton(
            ...
            textStyle:
                sfProDisplayBold.copyWith(fontSize: 16, color: AppColors.white),
            onTap: () {
