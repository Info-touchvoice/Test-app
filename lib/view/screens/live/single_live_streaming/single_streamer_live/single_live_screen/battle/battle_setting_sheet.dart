              ...
              GestureDetector(
                onTap: () {
                  showModalBottomSheet(
                    ...
                    builder: (context) => BattleTimeSheet(
                      time: time,
                    ),
                  );
                },
          ...
          Row(
            children: [
              ...
              PrimaryButton(
                ...
                bgColor: _isSingleRound ? null : AppColors.card,
                borderColor: _isSingleRound ? null : AppColors.divider,
                onTap: () {
                  setState(() {
                    _isSingleRound = true;
                  });
              ...
              PrimaryButton(
                ...
                gradient: _isSingleRound
                    ? null
                    : AppColors.secondaryGradient(stops: [0.0, 1.0]),
                borderColor: _isSingleRound ? AppColors.divider : null,
                bgColor: _isSingleRound ? AppColors.card : null,
                onTap: () {
                  setState(() {
          ...
          PrimaryButton(
            ...
            onTap: () {
              ...
              showModalBottomSheet(
                ...
                isScrollControlled: true,
                backgroundColor: AppColors.grey500,
                builder: (context) => BattleInviteSheet(
                  time: time.value,
                  top: 1,
                  round: _isSingleRound ? 1 : 3,
                ),
              );
            },
          ),
