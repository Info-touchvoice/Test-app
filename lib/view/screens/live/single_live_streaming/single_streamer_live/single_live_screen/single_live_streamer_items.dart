...
import 'package:tiki/view/screens/live/single_live_streaming/single_streamer_live/single_live_screen/widgets/bottom_bar.dart';
import 'package:tiki/view/screens/live/single_live_streaming/single_streamer_live/single_live_screen/widgets/chat_feature.dart';
...
import '../../widgets/single_live_top_bar.dart';
        ...
        return Stack(
          children: [
            Column(
              children: [
                SizedBox(height: 45),
                SingleLiveTopBar(liveViewModel, battleViewModel),
                const SizedBox(height: 10),
                if (battleViewModel.isBattleView) BattleView(),
                if (battleViewModel.isBattleView == false) const Spacer(),
