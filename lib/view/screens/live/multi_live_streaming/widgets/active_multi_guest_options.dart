                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      zegoController.liveStreamingManager
                          .kickOutRoom(user!.userID.toString());
                    },
                    child: Row(
                      children: [
          ...
          Row(
            ...
            children: [
                ...
                ValueListenableBuilder<bool>(
                    ...
                    builder: (context, isMicOn, _) {
                      return GestureDetector(
                        onTap: () {
                          zegoController.liveStreamingManager
                              .muteSpeaker(user!.userID.toString(), isMicOn);
                        },
                        child: Column(
                          children: [
                            CircleAvatar(
              ...
              InkWell(
                onTap: () {
                  zegoController.liveStreamingManager
                      .requestCameraOff(user!.userID.toString());
                  QuickHelp.showAppNotificationAdvanced(
                      title: "Request sent to cohost to turn off the camera.",
                      context: context);
                },
                child: Column(
                  children: [
              ...
              if ((seat6 || seat9) &&
                  (!_controller.isExpanded.value || _controller.seat == 0))
                Column(
                  children: [
                      ...
                      return GestureDetector(
                        onTap: () {
                          ...
                          Get.find<LiveViewModel>()
                              .setExpandedFeature(true, _controller.seat);
                          Get.back();
                        },
                        child: CircleAvatar(
                          radius: 30,
