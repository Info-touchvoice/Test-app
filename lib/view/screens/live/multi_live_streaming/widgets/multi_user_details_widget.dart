...
class MultiUserDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool seats12 = liveViewModel.liveStreamingModel.getMultiSeats ==
        LiveStreamingModel.keyTypeMultiTwelveSeat;
    bool seats9 = liveViewModel.liveStreamingModel.getMultiSeats ==
        LiveStreamingModel.keyTypeMultiNineSeat;
    bool seats6 = liveViewModel.liveStreamingModel.getMultiSeats ==
        LiveStreamingModel.keyTypeMultiSixSeat;
    bool seats4 = liveViewModel.liveStreamingModel.getMultiSeats ==
              ...
              child: Visibility(
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text(
                      '$index',
                      style: sfProDisplayRegular.copyWith(fontSize: 10.sp),
                    ),
                  ),
                ),
              ),
