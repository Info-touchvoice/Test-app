...
import 'package:tiki/view/screens/live/multi_live_streaming/widgets/multi_live_view/six_expanded_multi_guest.dart';
                          ...
                          Expanded(
                            ...
                            child: Row(
                              children: [
                                Expanded(
                                    child: ZegoMultiLiveView(
                                  userInfo: length >= 3 ? coHostList[2] : null,
                                  seat: 3,
                                )),
                                Expanded(
                                    child: ZegoMultiLiveView(
                                  userInfo: length >= 4 ? coHostList[3] : null,
                                  seat: 4,
                                )),
                              ],
                            ),
