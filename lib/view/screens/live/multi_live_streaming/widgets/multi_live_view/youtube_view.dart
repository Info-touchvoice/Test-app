...
class _YoutubeViewState extends State<YoutubeView> {
  ...
  void initState() {
    ...
    Get.find<YoutubeController>().videoId =
        liveViewModel.liveStreamingModel.getYoutubeVideoId!;
    ...
    youtubeController.youtubePlayerController = YoutubePlayerController(
      ...
      flags: YoutubePlayerFlags(
        autoPlay: true,
        mute: false,
        hideControls: liveViewModel.role == ZegoLiveRole.host
            ? false
            : true, // Hides the controls bar
      ),
    );
    ...
    if (liveViewModel.role == ZegoLiveRole.host)
      youtubeController.youtubePlayerController.addListener(() {
        ...
        } else if (youtubeController.youtubePlayerController.value.isPlaying ==
            false) {
          if (playing == true) {
            playing = false;
                    ...
                    child: Column(
                      children: [
                        ...
                        ValueListenableBuilder<ZegoSDKUser?>(
                            valueListenable:
                                zegoController.liveStreamingManager.hostNoti,
                            builder: (context, host, _) {
                              return ValueListenableBuilder<List<ZegoSDKUser>>(
                                  valueListenable: zegoController
                                      .liveStreamingManager.coHostUserListNoti,
