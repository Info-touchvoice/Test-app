...
import 'package:tiki/view/screens/live/zegocloud/zim_zego_sdk/internal/internal_defines.dart';
...
class CameraOffWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool seat4 =
        liveViewModel.isMultiSeat4 && gridController.isExpanded.value == false;
    bool seat6 =
        liveViewModel.isMultiSeat6 && gridController.isExpanded.value == false;
    bool seat9 =
        liveViewModel.isMultiSeat9 && gridController.isExpanded.value == false;
    bool seat9Expanded =
        liveViewModel.isMultiSeat9 && gridController.isExpanded.value == true;
    bool seat12 =
        liveViewModel.isMultiSeat12 && gridController.isExpanded.value == false;
    ...
    if (liveViewModel.liveStreamingModel.getYoutube == false)
      return Container(
        ...
        decoration: BoxDecoration(
          border: !seat9 && !seat9Expanded && !seat12
              ? Border(
                  right: BorderSide(
                      color: seat4 && !host
                          ? Colors.transparent
                          : AppColors.divider),
                  bottom: BorderSide(
                      color: seat6 ? AppColors.divider : Colors.transparent))
                                    ...
                                    : seat6
                                        ...
                                        : seat9
                                            ...
                                            : seat12
                                                ...
                                                : 35,
                            backgroundImage:
                                NetworkImage(user.avatarUrlNotifier.value!),
                          ),
                        );
                      else
                        return SizedBox();
