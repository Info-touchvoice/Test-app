...
class PostsModel extends ParseObject implements ParseCloneable {
  ...
  static String keySelectedMusic = "selectedMusic";
  ...
  set setImageAllList(List<ParseFileBase> image) =>
      setAddAll(keyImageList, image);
  ...
  set addMusicFile(MusicModel musicFile) =>
      set<MusicModel>(keySelectedMusic, musicFile);

  MusicModel? get getMusicFile => get<MusicModel>(keySelectedMusic);
}
