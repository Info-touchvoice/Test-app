...
import 'package:tiki/view/screens/authentication/broadcaster.dart';
import 'package:tiki/view/screens/authentication/createAccount.dart';
import 'package:tiki/view/screens/authentication/forgotPassword.dart';
import 'package:tiki/view/screens/authentication/language_screen.dart';
import 'package:tiki/view/screens/authentication/logIn.dart';
import 'package:tiki/view/screens/authentication/passwordChanged.dart';
import 'package:tiki/view/screens/authentication/resetPassword.dart';
import 'package:tiki/view/screens/chat/chat_screen.dart';
import 'package:tiki/view/screens/dashboard_screen.dart';
import 'package:tiki/view/screens/home/home_screen/home_screen.dart';
import 'package:tiki/view/screens/trending/trending_screen.dart';
import 'package:tiki/view_model/theme_controller.dart';

import '../../view/screens/authentication/gender_screen.dart';
...
import '../../view/screens/dashboard/profile/user_subscriptions_list_screen.dart';
import '../../view/screens/dashboard/profile/user_subscribers_list_screen.dart';
...
import '../../view/screens/reels/audio/audio_screen.dart';
...
class AppRoutes {
  ...
  static const String trendingBroadcastersScreen =
      '/TrendingBroadcastersScreen';
  ...
  static const String userSubscriptionsList = '/userSubscriptionsList';
  static const String userSubscribersList = '/userSubscribersList';
  static const String verifiedMemberScreen = '/verifiedMemberScreen';
  ...
  static List<GetPage> pages = [
    ...
    GetPage(
      ...
      page: () => UserSubscriptionsListScreen(userModel: Get.arguments?['userModel']),
    ),
    GetPage(
      name: userSubscribersList,
      page: () => UserSubscribersListScreen(userModel: Get.arguments?['userModel']),
    ),
    GetPage(name: wallet, page: () => Wallet()),
    GetPage(name: verifiedMemberScreen, page: () => VerifiedMemberScreen()),
    GetPage(name: audioScreen, page: () => AudioScreen()),
