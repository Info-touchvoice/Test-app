...
class QuickCloudCode {
  ...
  // Stripe Connect
  static Future<ParseResponse> stripeConnectOnboard() async {
    ParseCloudFunction function = ParseCloudFunction(CloudParams.stripeConnectOnboardParam);
    return await function.execute();
  }

  static Future<ParseResponse> stripeConnectStatus() async {
    ParseCloudFunction function = ParseCloudFunction(CloudParams.stripeConnectStatusParam);
    return await function.execute();
  }

  static Future<ParseResponse> stripeConnectLoginLink() async {
    ParseCloudFunction function = ParseCloudFunction(CloudParams.stripeConnectLoginParam);
    return await function.execute();
  }
