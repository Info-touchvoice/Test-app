...
import 'package:tiki/ui/container_with_corner.dart';
...
class QuickActions {
  ...
  static Future<void> showPaymentConfirmationSheet(
      BuildContext context, double fem, double ffem, Function() confirm,
  ...
  static void showCongratulationsDialog(
      ...
      {String description = 'Your account is ready to use',
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return Dialog(
          ...
          child: Container(
            padding: EdgeInsets.fromLTRB(20 * fem, 40 * fem, 20 * fem, 0 * fem),
            width: 360 * fem,
            height: 482 * fem,
            decoration: BoxDecoration(
              color: Color(0xffffffff),
  ...
  static Future<void> privateKeyDialog(
      ...
      builder: (BuildContext context) {
        return Dialog(
          ...
          child: Container(
            ...
            // pop59A (1:4055)
            padding:
                EdgeInsets.fromLTRB(20 * fem, 20 * fem, 25 * fem, 20 * fem),
            decoration: BoxDecoration(
              color: Color(0xffffffff),
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  margin:
                      EdgeInsets.fromLTRB(0 * fem, 0 * fem, 6 * fem, 12 * fem),
                  constraints: BoxConstraints(
                    maxWidth: 252 * fem,
                  ),
                  child: Text(
                    'Please ${set ? 'set' : 'enter'} the private key ${set ? 'to proceed.' : '.'}',
                    style: SafeGoogleFont(
                      'DM Sans',
                      fontSize: 14 * ffem,
                      fontWeight: FontWeight.w600,
                ...
                Column(
                  ...
                  children: [
                    Container(
                      ...
                      padding:
                          EdgeInsets.fromLTRB(22.92 * fem, 0, 0 * fem, 0 * fem),
                      height: 34 * fem,
                      width: double.infinity,
                      decoration: BoxDecoration(
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                contentPadding:
                                    EdgeInsets.fromLTRB(0, 0, 0, 10.5 * fem),
  ...
  static Future<void> paidEntryDialog(
      BuildContext context,
      double fem,
      double ffem,
      TextEditingController diamondEntryController,
      Function() onCancel,
      Function() onContinue,
      {bool set = true}) async {
    RxString errorText = ''.obs;
      ...
      builder: (BuildContext context) {
        return Dialog(
          ...
          child: Container(
            ...
            // pop59A (1:4055)
            padding:
                EdgeInsets.fromLTRB(20 * fem, 20 * fem, 25 * fem, 19 * fem),
            decoration: BoxDecoration(
              color: Color(0xffffffff),
              borderRadius: BorderRadius.circular(20 * fem),
            ),
            child: Column(
              ...
              children: [
                Container(
                  // areyousureyouwanttodisconnecta (1:4057)
                  margin:
                      EdgeInsets.fromLTRB(0 * fem, 0 * fem, 6 * fem, 36 * fem),
                  constraints: BoxConstraints(
                    maxWidth: 252 * fem,
                  ),
                  child: Text(
  ...
  static double wishListProgressValue(LiveViewModel liveViewModel) {
    ...
    if (liveViewModel.myWishList != null &&
        liveViewModel.myWishList!.isNotEmpty) {
      for (int i = 0; i < liveViewModel.myWishList!.length; i++) {
        totalReceived = totalReceived +
            double.parse(liveViewModel.myWishList![i]
                    [LiveStreamingModel.keyReceived]
                .toString());
        totalAmount = totalAmount +
            double.parse(liveViewModel.myWishList![i]
                    [LiveStreamingModel.keyAmount]
                .toString());
      }
  ...
  static myWishListAudience(
      double fem,
      double ffem,
      BuildContext context,
      UserModel broadcasterModel,
      UserModel currentUser,
      LiveStreamingModel liveStreamingModel) {
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: GridView.builder(
                        padding: EdgeInsets.fromLTRB(0, 0, 0 * fem, 85 * fem),
                        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                          crossAxisCount: 3, // Adjust as needed
                          mainAxisSpacing: 14.64 * fem,
                          crossAxisSpacing: 12 * fem,
                          childAspectRatio:
                              0.75, // Adjust this ratio to fit your needs
                        ),
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return Container(
                            padding: EdgeInsets.fromLTRB(
                                9 * fem, 2.12 * fem, 9.58 * fem, 3.46 * fem),
                            width: 106.58 * fem,
                            height: 140.58 * fem,
                            decoration: BoxDecoration(
                            ...
                            child: Column(
                              ...
                              children: [
                                      ...
                                      Positioned(
                                        ...
                                        child: Align(
                                          child: SizedBox(
                                            ...
                                            height: 56.12 * fem,
                                            child: Image.asset(
                                              "assets/dino/${wishList[index][LiveStreamingModel.keyName]}.png",
                                              fit: BoxFit.cover,
                                            ),
                                          ),
                                        ),
                                ...
                                Container(
                                  // buttonWh5 (1:24897)
                                  margin: EdgeInsets.fromLTRB(
                                      int.parse(wishList[index][LiveStreamingModel.keyAmount]) <=
                                              int.parse(wishList[index][
                                                  LiveStreamingModel
                                                      .keyReceived])
                                          ? 5 * fem
                                          : 18 * fem,
                                  ...
                                  child: Stack(
                                    children: [
                                      Positioned(
                                        ...
                                        child: Align(
                                          child: SizedBox(
                                            width: int.parse(wishList[index][
                                                        LiveStreamingModel
                                                            .keyAmount]) <=
                                                    int.parse(wishList[index][
                                                        LiveStreamingModel
                                      ...
                                      Positioned(
                                        ...
                                        child: Align(
                                          child: InkWell(
                                            onTap: () {
                                              if (currentUser.getCoins! >= 3) {
                                                if (int.parse(wishList[index][
                                                        LiveStreamingModel
                                                            .keyAmount]) !=
                                                    int.parse(wishList[index][
                                                        LiveStreamingModel
                                ...
                                Center(
                                  child: Container(
                                    ...
                                    child: Text(
                                      '${wishList[index][LiveStreamingModel.keyReceived]}/${wishList[index][LiveStreamingModel.keyAmount]}',
                                      style: SafeGoogleFont(
                                        'DM Sans',
                                        fontSize: 10 * ffem,
                                        fontWeight: FontWeight.w700,
                        ...
                        Positioned(
                          ...
                          child: Align(
                            child: SizedBox(
                              ...
                              height: 14 * fem,
                              child: Text(
                                'You have added ${wishItems.length} gifts worth ',
                                style: SafeGoogleFont(
                                  'DM Sans',
                                  fontSize: 11 * ffem,
                                  fontWeight: FontWeight.w500,
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return index != (length - 1)
                                    ...
                                    Positioned(
                                      ...
                                      child: Align(
                                        child: SizedBox(
                                          height: 14 * fem,
                                          child: Text(
                                            '${wishItems[index][LiveStreamingModel.keyReceived]}/${wishItems[index][LiveStreamingModel.keyAmount].toString()}',
                                            style: SafeGoogleFont(
                                              'DM Sans',
                                              fontSize: 10 * ffem,
                                              fontWeight: FontWeight.w700,
                                    ...
                                    Positioned(
                                      ...
                                      child: Align(
                                        child: SizedBox(
                                          ...
                                          height: 76.12 * fem,
                                          child: Image.asset(
                                            'assets/dino/${wishItems[index][LiveStreamingModel.keyName]}.png',
                                            fit: BoxFit.cover,
                                          ),
                                        ),
                                      ),
                            ...
                            : InkWell(
                                onTap: () {
                                  QuickActions.myWishListOptionsBroadcaster(fem,
                                          ffem, context, liveStreamingModel)
                                      .then((value) => setModalState(() {}));
                                },
                                child: Container(
                                  padding: EdgeInsets.fromLTRB(27 * fem,
                                      52.45 * fem, 22.58 * fem, 44.13 * fem),
                                  width: 106.58 * fem,
                                  height: 140.58 * fem,
                                  decoration: BoxDecoration(
  ...
  static Future myWishListOptionsBroadcaster(double fem, double ffem,
    ...
    List images = [
      AppImagePath.lamborghini,
      AppImagePath.bearCastle,
      AppImagePath.yachtIsland,
      AppImagePath.babyDragon,
      AppImagePath.hearts,
      AppImagePath.kissingGift,
      AppImagePath.motorCycleEntry
    ];
                      ...
                      child: Row(children: [
                        ...
                        InkWell(
                          onTap: () {
                            ...
                            if (selected != -1) {
                              Map<String, dynamic> item = {
                                LiveStreamingModel.keyAmount: amount.toString(),
                              ...
                              liveStreamingModel
                                  .save()
                                  .then((value) => QuickHelp.goBack(context));
                            } else {
                              QuickHelp.goBack(context);
                            }
                          },
                          child: Center(
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                border:
                                    Border.all(color: const Color(0xff50b0ed)),
                                borderRadius: BorderRadius.circular(24 * fem),
                                gradient: const LinearGradient(
                                  begin: Alignment(0, -1),
                                  end: Alignment(0, 1),
                        ...
                        SizedBox(
                          ...
                          child: GridView.builder(
                            ...
                            gridDelegate:
                              ...
                              childAspectRatio:
                                  0.87, // Adjust this ratio to fit your needs
                            ),
                            itemCount: 6,
                            // Set itemCount to the number of items you have
                            itemBuilder: (BuildContext context, int index) {
    ...
    return Positioned(
      ...
      child: Visibility(
        ...
        child: liveStreamingModel.getDiamonds! / liveStreamingModel.getGoal! >=
                1.0
            ? QuickActions.goalCompletedWidget(
                fem, ffem, context, liveStreamingModel)
            : Container(
                // licv3 (5:38216)
                padding:
                    EdgeInsets.fromLTRB(10 * fem, 2 * fem, 8.48 * fem, 0 * fem),
                width: 132 * fem,
                decoration: BoxDecoration(
                    ...
                    Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: LinearProgressIndicator(
                          ...
                          value: liveStreamingModel.getDiamonds! /
                              liveStreamingModel
        ...
        child: Column(
          children: [
            Container(
              // liasy (5:39974)
              padding:
                  EdgeInsets.fromLTRB(6 * fem, 9 * fem, 4.57 * fem, 0 * fem),
              width: 141 * fem,
              decoration: BoxDecoration(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    padding:
                        EdgeInsets.fromLTRB(2 * fem, 2 * fem, 0 * fem, 3 * fem),
                    width: double.infinity,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
    ...
    return showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        return StatefulBuilder(builder: (BuildContext context,
          ...
          return Container(
            padding:
                EdgeInsets.fromLTRB(8 * fem, 5.41 * fem, 0 * fem, 22 * fem),
            width: 375 * fem,
            height: 490 * fem,
            decoration: BoxDecoration(
              color: const Color(0xffffffff),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  margin:
                      EdgeInsets.fromLTRB(0 * fem, 0 * fem, 15 * fem, 40 * fem),
                  width: 350 * fem,
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      Obx(() {
                        return Container(
                          ...
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              amountWidget(fem, ffem, 10, amount.value == 10,
                                  amount, other),
                              SizedBox(
                                width: 7 * fem,
                              ),
                              amountWidget(fem, ffem, 50, amount.value == 50,
                                  amount, other),
                              SizedBox(
                                width: 7 * fem,
                              ),
                              amountWidget(fem, ffem, 100, amount.value == 100,
                                  amount, other),
                            ],
                          ),
                        );
                      ...
                      Obx(() {
                        return SizedBox(
                          ...
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              amountWidget(fem, ffem, 200, amount.value == 200,
                                  amount, other),
                              SizedBox(
                                width: 7 * fem,
                              ),
                              amountWidget(fem, ffem, 1000,
                                  amount.value == 1000, amount, other),
                              SizedBox(
                                width: 7 * fem,
                              ),
                              InkWell(
                                ...
                                child: Container(
                                  padding: EdgeInsets.all(other.value ? 2 : 0),
                                  width: 110 * fem,
                                  height: double.infinity,
                                  decoration: BoxDecoration(
                  ...
                  onTap: () {
                    if (other.value == true) {
                      ...
                      QuickActions.addGoalMessage(
                          fem, ffem, context, liveStreamingModel, amount.value);
                    }
                  },
                  child: Container(
                    // buttonqVZ (4:34646)
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  margin:
                      EdgeInsets.fromLTRB(8 * fem, 0 * fem, 16 * fem, 8 * fem),
                  width: double.infinity,
                  height: 42 * fem,
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.center,
          ...
          return Container(
            ...
            child: Padding(
              padding: EdgeInsets.only(
                  bottom: MediaQuery.of(context).viewInsets.bottom * 0.44),
              child: Container(
                padding:
                    EdgeInsets.fromLTRB(17 * fem, 5 * fem, 15 * fem, 22 * fem),
                width: 375 * fem,
                height: 453 * fem,
                decoration: BoxDecoration(
                  color: Color(0xffffffff),
  ...
  static void showCountryPicker(BuildContext context, String selectedCountry) {
  ...
  static final Map<String, String> countryFlagMap = {
    // RegionViewModel
    'Sweden': AppImagePath.swedishFlag,
    'USA': AppImagePath.americanFlag, // or AppImagePath.USA if consistent
    'UK': AppImagePath.englandFlag,
    'Saudi Arabia': AppImagePath.saudiFlag,
    'Canada': AppImagePath.canadaFlag,
    'Pakistan': AppImagePath.pakistanFlag,
    'Ukraine': AppImagePath.ukraineFlag,
    'France': AppImagePath.franceFlag,

    // AmericaRegionViewModel
    'Brazil': AppImagePath.Brazil,
    'Argentina': AppImagePath.Argentina,
    'Colombia': AppImagePath.Colombia,
    'Mexico': AppImagePath.Mexico,
    'Peru': AppImagePath.Peru,
    'Chile': AppImagePath.Chile,
    'Nigeria': AppImagePath.Nigeria,
    'Venezuela': AppImagePath.Venezuela,
    'Boliva': AppImagePath.Bolivia,
    'Ecuador': AppImagePath.Ecuador,
    'Panama': AppImagePath.Panama,
    'El Salvador': AppImagePath.EL_Salvador,
    'Costa Rico': AppImagePath.Costa_Rico,
    'Uruguay': AppImagePath.Uruguay,

    // AsiaRegionViewModel
    'India': AppImagePath.India,
    'Bangladesh': AppImagePath.Bangladesh,
    'China': AppImagePath.China,

    // EuropeRegionViewModel
    'Germany': AppImagePath.Germany,
    'Italy': AppImagePath.Italy,

    // MiddleEastRegionViewModel
    'Israel': AppImagePath.Israel,
    'Qatar': AppImagePath.Qatar,
    'Turkey': AppImagePath.Turkey,
    'UAE': AppImagePath.UAE,
  };
  ...
  static String getCountryCode(UserModel currentUser) {
    ...
    return countryCodeMap[country] ?? AppCountryCode.pakistanCode;
  }

  static final Map<String, String> countryCodeMap = {
    // RegionViewModel
    'Sweden': AppCountryCode.swedenCode,
    'USA': AppCountryCode.americanCode,
    'UK': AppCountryCode.englandCode,
    'Saudi Arabia': AppCountryCode.saudiCode,
    'Canada': AppCountryCode.canadaCode,
    'Pakistan': AppCountryCode.pakistanCode,
    'Ukraine': AppCountryCode.ukraineCode,
    'France': AppCountryCode.franceCode,

    // AmericaRegionViewModel
    'Brazil': AppCountryCode.brazilCode,
    'Argentina': AppCountryCode.argentinaCode,
    'Colombia': AppCountryCode.colombiaCode,
    'Mexico': AppCountryCode.mexicoCode,
    'Peru': AppCountryCode.peruCode,
    'Chile': AppCountryCode.chileCode,
    'Nigeria': AppCountryCode.nigeriaCode,
    'Venezuela': AppCountryCode.venezuelaCode,
    'Boliva': AppCountryCode.boliviaCode,
    'Ecuador': AppCountryCode.ecuadorCode,
    'Panama': AppCountryCode.panamaCode,
    'El Salvador': AppCountryCode.elSalvadorCode,
    'Costa Rico': AppCountryCode.costaRicoCode,
    'Uruguay': AppCountryCode.uruguayCode,

    // AsiaRegionViewModel
    'India': AppCountryCode.indiaCode,
    'Bangladesh': AppCountryCode.bangladeshCode,
    'China': AppCountryCode.chinaCode,

    // EuropeRegionViewModel
    'Germany': AppCountryCode.germanyCode,
    'Italy': AppCountryCode.italyCode,

    // MiddleEastRegionViewModel
    'Israel': AppCountryCode.israelCode,
    'Qatar': AppCountryCode.qatarCode,
    'Turkey': AppCountryCode.turkeyCode,
    'UAE': AppCountryCode.uaeCode,
  };
...
class AppCountryCode {
  // RegionViewModel
  static const String swedenCode = 'SE';
  static const String americanCode = 'US';
  static const String englandCode = 'GB'; // UK
  static const String saudiCode = 'SA';
  ...
  // AmericaRegionViewModel
  static const String brazilCode = 'BR';
  static const String argentinaCode = 'AR';
  static const String colombiaCode = 'CO';
  static const String mexicoCode = 'MX';
  static const String peruCode = 'PE';
  static const String chileCode = 'CL';
  static const String nigeriaCode = 'NG';
  static const String venezuelaCode = 'VE';
  static const String boliviaCode = 'BO';
  static const String ecuadorCode = 'EC';
  static const String panamaCode = 'PA';
  static const String elSalvadorCode = 'SV';
  static const String costaRicoCode = 'CR';
  static const String uruguayCode = 'UY';

  // AsiaRegionViewModel
  static const String indiaCode = 'IN';
  static const String bangladeshCode = 'BD';
  static const String chinaCode = 'CN';

  // EuropeRegionViewModel
  static const String germanyCode = 'DE';
  static const String italyCode = 'IT';

  // MiddleEastRegionViewModel
  static const String israelCode = 'IL';
  static const String qatarCode = 'QA';
  static const String turkeyCode = 'TR';
  static const String uaeCode = 'AE';
}

void openBottomSheet(Widget widget, BuildContext context,
    {bool back = false, Color? color}) {
  if (back == true) Get.back();
...
void goToProfile({bool otherProfile = false, UserModel? mUser}) {
  ...
  // Always set otherProfile to true if viewing a different user's profile
  final bool isOtherUser = Get.find<UserViewModel>().currentUser.objectId != mUser.objectId;
  Get.toNamed(AppRoutes.profileScreen,
      arguments: {"otherProfile": isOtherUser || otherProfile, "mUser": mUser});
}
