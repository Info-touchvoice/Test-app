...
class BattleViewModel extends GetxController with GetTickerProviderStateMixin {
 ...
 // Step 1 , on Pk START
  ...
  sendGiftToTeamA({required String gift, required String audio, required int coins}){
    ...
    _battleModel.setTeamAGift={"gift": gift, "audio" : audio, "name" : Get.find<UserViewModel>().currentUser.getFullName, LiveStreamingModel.keyCoins: coins,  LiveStreamingModel.keySenderAvatar : senderAvatar, LiveStreamingModel.keyReceiverUid : battleModel.getHost!.getUid! };
    _battleModel.setTeamScoreA= coins + _battleModel.getTeamScoreA;
    _battleModel.setHostGifterAvatarList= senderAvatar;
    _battleModel.save();
  ...
  sendGiftToTeamB({required String gift, required String audio, required int coins}){
    final String senderAvatar =
        Get.find<UserViewModel>().currentUser.getAvatar?.url ?? '';
    _battleModel.setTeamBGift={"gift": gift, "audio" : audio, "name" : Get.find<UserViewModel>().currentUser.getFullName, LiveStreamingModel.keyCoins: coins, LiveStreamingModel.keySenderAvatar : senderAvatar, LiveStreamingModel.keySenderAvatar : senderAvatar, LiveStreamingModel.keyReceiverUid : battleModel.getPlayerB!.getUid! };
    _battleModel.setTeamScoreB= coins + _battleModel.getTeamScoreB;
    _battleModel.setPlayerGifterAvatarList= senderAvatar;
    _battleModel.save();
    Get.find<RankingViewModel>().addRecord(coins,RankingModel.keyCategoryGifter);
    Get.find<UserViewModel>().deductBalance(coins);
    Get.find<LiveViewModel>().incrementCount(coins);
  ...
  sendGiftToAllTeams({required String gift, required String audio, required int coins}){
    final String senderAvatar =
        Get.find<UserViewModel>().currentUser.getAvatar?.url ?? '';
    _battleModel.setTeamAGift={"gift": gift, "audio" : audio, "name" : Get.find<UserViewModel>().currentUser.getFullName, LiveStreamingModel.keyCoins: coins, LiveStreamingModel.keySenderAvatar : senderAvatar, LiveStreamingModel.keySenderAvatar : senderAvatar, LiveStreamingModel.keyReceiverUid : battleModel.getHost!.getUid! };
    _battleModel.setTeamBGift={"gift": gift, "audio" : audio, "name" : Get.find<UserViewModel>().currentUser.getFullName, LiveStreamingModel.keyCoins: coins, LiveStreamingModel.keySenderAvatar : senderAvatar, LiveStreamingModel.keySenderAvatar : senderAvatar, LiveStreamingModel.keyReceiverUid : battleModel.getPlayerB!.getUid!};
    _battleModel.setTeamScoreA= coins + _battleModel.getTeamScoreA;
    _battleModel.setTeamScoreB= coins + _battleModel.getTeamScoreB;
    _battleModel.setHostGifterAvatarList= senderAvatar;
