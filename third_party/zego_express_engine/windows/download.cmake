...
function(download_native_sdk WORKSPACE)
  ...
  if($ENV{DEPS} MATCHES "^http.+")
    ...
    string(REGEX MATCH "windows: .+ZegoExpress.+-win-shared-cpp\.zip\\?version=[0-9]+(\.[0-9]+)+" DEPSURL ${DEPSYAML})
  ...
  file(DOWNLOAD "${DEPSURL}" "${LIBSDIR}/sdk.zip" TLS_VERIFY OFF TIMEOUT 600)
