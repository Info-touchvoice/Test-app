...
protected:
    ...
    void onPlayerSwitched(const std::string& streamID, int errorCode) override;
...
protected:
    ...
    void onRtcStats(const EXPRESS::ZegoRtcStatsInfo &info) override;
...
protected:
    ...
    void onRemoteDataRecordStateUpdate(EXPRESS::ZegoDataRecordState state, int errorCode, EXPRESS::ZegoDataRecordConfig config, const std::string & streamID) override;

    void onRemoteDataRecordProgressUpdate(EXPRESS::ZegoDataRemoteRecordProgress progress, EXPRESS::ZegoDataRecordConfig config, const std::string & streamID) override;
...
protected:
    ...
    void onBeforeAudioPrepAudioData(const unsigned char *data, unsigned int dataLength,
                                    EXPRESS::ZegoAudioFrameParam param) override;
