...
public class ZIMPluginMethodHandler {
    ...
    public static void create(MethodCall call, Result result,
                              FlutterPlugin.FlutterPluginBinding binding,
                              ZIMPluginEventHandler eventHandler) {
        ...
        ZIMAppConfig appConfig =
            ZIMPluginConverter.oZIMAppConfig(Objects.requireNonNull(call.argument("config")));
    ...
    public static void callExperimentalAPI(MethodCall call, Result result) {
        ...
        zim.callExperimentalAPI(params, new ZIMExperimentalAPICalledCallback() {
            @Override
            public void onExperimentalAPICalled(String cb_result, ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    result.success(cb_result);
                } else {
                    result.error(String.valueOf(errorInfo.code.value()), errorInfo.message, null);
                }
            }
    ...
    public static void querySelfUserInfo(MethodCall call, Result result) {
        ...
        zim.querySelfUserInfo(new ZIMSelfUserInfoQueriedCallback() {
            ...
            public void onSelfUserInfoQueried(ZIMSelfUserInfo selfUserInfo, ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    resultMap.put("selfUserInfo",
                                  ZIMPluginConverter.mZIMSelfUserInfo(selfUserInfo));
                    result.success(resultMap);
                } else {
                    result.error(String.valueOf(errorInfo.code.value()), errorInfo.message, null);
                }
    ...
    public static void queryUsersInfo(MethodCall call, Result result) {
        ...
        ZIMUsersInfoQueryConfig config = ZIMPluginConverter.oZIMUsersInfoQueryConfig(
            Objects.requireNonNull(call.argument("config")));
    ...
    public static void updateUserOfflinePushRule(MethodCall call, Result result) {
        ...
        ZIMUserOfflinePushRule offlinePushRule = ZIMPluginConverter.oZIMUserOfflinePushRule(
            Objects.requireNonNull(call.argument("offlinePushRule")));
        zim.updateUserOfflinePushRule(offlinePushRule, new ZIMUserOfflinePushRuleUpdatedCallback() {
            @Override
            public void onUserOfflinePushRuleInfoUpdated(ZIMUserOfflinePushRule offlinePushRule,
                                                         ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    resultMap.put("offlinePushRule",
                                  ZIMPluginConverter.mZIMUserOfflinePushRule(offlinePushRule));
                    result.success(resultMap);
                } else {
                    result.error(String.valueOf(errorInfo.code.value()), errorInfo.message, null);
                }
    ...
    public static void updateUserCustomStatus(MethodCall call, Result result) {
        String handle = call.argument("handle");
        ZIM zim = engineMap.get(handle);
        if (zim == null) {
            result.error("-1", "no native instance", null);
        ...
        String customStatus = call.argument("customStatus");
        ZIMUserCustomStatusUpdateConfig config = ZIMPluginConverter.oZIMUserCustomStatusUpdateConfig(call.argument("config"));
        zim.updateUserCustomStatus(customStatus, config, new ZIMUserCustomStatusUpdatedCallback() {
            @Override
            public void onUserCustomStatusUpdated(String customStatus, ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    resultMap.put("customStatus", customStatus);
                    result.success(resultMap);
                } else {
                    result.error(String.valueOf(errorInfo.code.value()), errorInfo.message, null);
                }
    ...
    public static void updateUserBadge(MethodCall call, Result result) {
        String handle = call.argument("handle");
        ZIM zim = engineMap.get(handle);
        if (zim == null) {
            result.error("-1", "no native instance", null);
        ...
        int badge = (int)call.argument("badge");
        zim.updateUserBadge(badge, new ZIMUserBadgeUpdatedCallback() {
            @Override
    ...
    public static void queryUsersStatus(MethodCall call, Result result) {
        String handle = call.argument("handle");
        ZIM zim = engineMap.get(handle);
        if (zim == null) {
            result.error("-1", "no native instance", null);
        ...
        zim.queryUsersStatus(userIDs, new ZIMUsersStatusQueriedCallback() {
            ...
            public void onUsersStatusQueried(ArrayList<ZIMUserStatus> userStatusList,
                ...
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    resultMap.put("userStatusList",
                                  ZIMPluginConverter.mZIMUserStatusList(userStatusList));
                    resultMap.put("errorUserList",
                                  ZIMPluginConverter.mZIMErrorUserInfoList(errorUserList));
                    result.success(resultMap);
                } else {
    ...
    public static void subscribeUsersStatus(MethodCall call, Result result) {
        String handle = call.argument("handle");
        ZIM zim = engineMap.get(handle);
        if (zim == null) {
            result.error("-1", "no native instance", null);
        ...
        ZIMUserStatusSubscribeConfig config =
            ZIMPluginConverter.oZIMUserStatusSubscribeConfig(call.argument("config"));
        zim.subscribeUsersStatus(userIDs, config, new ZIMUsersStatusSubscribedCallback() {
            @Override
            public void onUsersStatusSubscribed(ArrayList<ZIMErrorUserInfo> errorUserList,
                                                ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    resultMap.put("errorUserList",
    ...
    public static void querySubscribedUserStatusList(MethodCall call, Result result) {
        String handle = call.argument("handle");
        ZIM zim = engineMap.get(handle);
        if (zim == null) {
            result.error("-1", "no native instance", null);
        ...
        ZIMSubscribedUserStatusQueryConfig config =
            ZIMPluginConverter.oZIMSubscribedUserStatusQueryConfig(call.argument("config"));
        zim.querySubscribedUserStatusList(config, new ZIMSubscribedUserStatusListQueriedCallback() {
            ...
            public void onSubscribedUserStatusListQueried(
                ...
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    resultMap.put("userStatusSubscriptionList",
                                  ZIMPluginConverter.mZIMUserStatusSubscriptionList(
    ...
    public static void queryConversationList(MethodCall call, Result result) {
        ...
        ZIMConversationQueryConfig config =
            ZIMPluginConverter.oZIMConversationQueryConfig(configMap);
        HashMap<String, Object> optionMap =
            ZIMPluginCommonTools.safeGetHashMap(call.argument("option"));
        if (optionMap == null) {
            zim.queryConversationList(config, new ZIMConversationListQueriedCallback() {
                @Override
                public void onConversationListQueried(ArrayList<ZIMConversation> conversationList,
                                                      ZIMError errorInfo) {
                    if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                        HashMap<String, Object> resultMap = new HashMap<>();
                        ArrayList<HashMap<String, Object>> basicConversationList =
                            ZIMPluginConverter.mZIMConversationList(conversationList);
                        resultMap.put("conversationList", basicConversationList);
                        result.success(resultMap);
                    } else {
                        result.error(String.valueOf(errorInfo.code.value()), errorInfo.message,
                                     null);
                    }
                }
            });
            ...
            ZIMConversationFilterOption option =
                ZIMPluginConverter.oZIMConversationFilterOption(optionMap);
    ...
    public static void queryConversation(MethodCall call, Result result) {
        ...
        ZIMConversationType conversationType = ZIMConversationType.getZIMConversationType(
            ZIMPluginCommonTools.safeGetIntValue(call.argument("conversationType")));
        zim.queryConversation(
            conversationID, conversationType, new ZIMConversationQueriedCallback() {
                @Override
                public void onConversationQueried(ZIMConversation conversation,
                                                  ZIMError errorInfo) {
                    if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                        HashMap<String, Object> resultMap = new HashMap<>();
                        resultMap.put("conversation",
                                      ZIMPluginConverter.mZIMConversation(conversation));
                        result.success(resultMap);
                    } else {
                        result.error(String.valueOf(errorInfo.code.value()), errorInfo.message,
                                     null);
    ...
    public static void queryConversationTotalUnreadMessageCount(MethodCall call, Result result) {
        String handle = call.argument("handle");
        ZIM zim = engineMap.get(handle);
        if (zim == null) {
            result.error("-1", "no native instance", null);
        ...
        ZIMConversationTotalUnreadMessageCountQueryConfig config =
            ZIMPluginConverter.oZIMConversationTotalUnreadMessageCountQueryConfig(configMap);

        zim.queryConversationTotalUnreadMessageCount(
            config, new ZIMConversationTotalUnreadMessageCountQueriedCallback() {
                @Override
                public void onConversationTotalUnreadMessageCountQueried(int unreadCount,
                                                                         ZIMError errorInfo) {
                    if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                        HashMap<String, Object> resultMap = new HashMap<>();
    ...
    public static void deleteConversation(MethodCall call, Result result) {
        ...
        ZIMConversationType conversationType = ZIMConversationType.getZIMConversationType(
            ZIMPluginCommonTools.safeGetIntValue(call.argument("conversationType")));
        ZIMConversationDeleteConfig config = ZIMPluginConverter.oZIMConversationDeleteConfig(
            Objects.requireNonNull(call.argument("config")));
        zim.deleteConversation(
            conversationID, conversationType, config, new ZIMConversationDeletedCallback() {
                @Override
    ...
    public static void setConversationNotificationStatus(MethodCall call, Result result) {
        ...
        ZIMConversationNotificationStatus status =
            ZIMConversationNotificationStatus.getZIMConversationNotificationStatus(
                ZIMPluginCommonTools.safeGetIntValue(call.argument("status")));
        String conversationID = call.argument("conversationID");
        ZIMConversationType conversationType = ZIMConversationType.getZIMConversationType(
            ZIMPluginCommonTools.safeGetIntValue(call.argument("conversationType")));
    ...
    public static void sendConversationMessageReceiptRead(MethodCall call, Result result) {
        ...
        zim.sendConversationMessageReceiptRead(
            conversationID, conversationType, new ZIMConversationMessageReceiptReadSentCallback() {
                @Override
    ...
    public static void setConversationDraft(MethodCall call, Result result) {
        ...
        zim.setConversationDraft(
            draft, conversationID, conversationType, new ZIMConversationDraftSetCallback() {
                @Override
                public void onConversationDraftSet(String conversationID,
                                                   ZIMConversationType conversationType,
                                                   ZIMError errorInfo) {
                    if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                        HashMap<String, Object> resultMap = new HashMap<>();
    ...
    public static void setConversationMark(MethodCall call, Result result) {
        ...
        ArrayList<ZIMConversationBaseInfo> convList =
            ZIMPluginConverter.oZIMConversationBaseInfoList(
                Objects.requireNonNull(call.argument("infos")));
        zim.setConversationMark(markType, enable, convList, new ZIMConversationMarkSetCallback() {
            @Override
            public void onConversationMarkSet(ArrayList<ZIMConversationBaseInfo> failedInfos,
                                              ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    ArrayList<HashMap<String, Object>> basicConversationList =
                        ZIMPluginConverter.mZIMConversationBaseInfoList(failedInfos);
    ...
    public static void sendMessageReceiptsRead(MethodCall call, Result result) {
        ...
        ZIMConversationType conversationType = ZIMConversationType.getZIMConversationType(
            ZIMPluginCommonTools.safeGetIntValue(call.argument("conversationType")));
        ArrayList<ZIMMessage> messageList = ZIMPluginConverter.oZIMMessageList(
            Objects.requireNonNull(call.argument("messageList")));
    ...
    public static void queryGroupMessageReceiptReadMemberList(MethodCall call, Result result) {
        ...
        ZIMGroupMessageReceiptMemberQueryConfig config =
            ZIMPluginConverter.oZIMGroupMessageReceiptMemberQueryConfig(
                Objects.requireNonNull(call.argument("config")));
        zim.queryGroupMessageReceiptReadMemberList(
            message, groupID, config, new ZIMGroupMessageReceiptMemberListQueriedCallback() {
                @Override
                public void onGroupMessageReceiptMemberListQueried(
                    String groupID, ArrayList<ZIMGroupMemberInfo> userList, int nextFlag,
                    ZIMError errorInfo) {
                    if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                        HashMap<String, Object> resultMap = new HashMap<>();
    ...
    public static void revokeMessage(MethodCall call, Result result) {
        ...
        ZIMMessage message = ZIMPluginConverter.oZIMMessage(call.argument("message"));
        ZIMMessageRevokeConfig revokeConfig = ZIMPluginConverter.oZIMMessageRevokeConfig(
            Objects.requireNonNull(call.argument("config")));
    ...
    public static void sendPeerMessage(MethodCall call, Result result) {
        ...
        ZIMMessage message =
            ZIMPluginConverter.oZIMMessage(Objects.requireNonNull(call.argument("message")));
        String toUserID = (String)Objects.requireNonNull(call.argument("toUserID"));
        ZIMMessageSendConfig config = ZIMPluginConverter.oZIMMessageSendConfig(
            Objects.requireNonNull(call.argument("config")));
    ...
    public static void downloadMediaFile(MethodCall call, Result result) {
        ...
        ZIMMessage mediaMessage =
            ZIMPluginConverter.oZIMMessage(Objects.requireNonNull(call.argument("message")));
        ZIMMediaFileType fileType = ZIMMediaFileType.getZIMMediaFileType(
            ZIMPluginCommonTools.safeGetIntValue(call.argument("fileType")));
        Integer progressID = call.argument("progressID");
        ZIMMediaDownloadConfig config = ZIMPluginConverter.oZIMMediaDownloadConfig(
            Objects.requireNonNull(call.argument("config")));
        zim.downloadMediaFile(mediaMessage, fileType, config, new ZIMMediaDownloadedCallback() {
            @Override
    ...
    public static void sendMessage(MethodCall call, Result result) {
        ...
        ZIMMessage message = (ZIMMessage)ZIMPluginConverter.oZIMMessage(
            Objects.requireNonNull(call.argument("message")));
        ...
        Integer mediaUploadingCallbackID = call.argument("mediaUploadingCallbackID");
        Integer multipleMediaUploadingCallbackID =
            call.argument("multipleMediaUploadingCallbackID");
        ...
        ZIMMessageSendConfig config = ZIMPluginConverter.oZIMMessageSendConfig(
            Objects.requireNonNull(call.argument("config")));
        zim.sendMessage(
            message, toConversationID, conversationType, config, new ZIMMessageSentFullCallback() {
                @Override
                public void onMessageAttached(ZIMMessage message) {
                ...
                public void onMediaUploadingProgress(ZIMMediaMessage message, long currentFileSize,
                                                     long totalFileSize) {
                    if (mediaUploadingCallbackID == null) {
                        return;
                    }
                    HashMap<String, Object> messageMap = ZIMPluginConverter.mZIMMessage(message);
                    HashMap<String, Object> resultMap = new HashMap<>();
                    ...
                    resultMap.put("mediaUploadingCallbackID", mediaUploadingCallbackID);
                    resultMap.put("messageID", messageID);
                    resultMap.put("message", messageMap);
                    resultMap.put("currentFileSize", currentFileSize);
                    resultMap.put("totalFileSize", totalFileSize);
                ...
                public void onMultipleMediaUploadingProgress(
                    ZIMMultipleMessage message, long currentFileSize, long totalFileSize,
                    int messageInfoIndex, long currentIndexFileSize, long totalIndexFileSize) {
                    if (multipleMediaUploadingCallbackID == null) {
                        return;
                    }
                    HashMap<String, Object> messageMap = ZIMPluginConverter.mZIMMessage(message);
                    HashMap<String, Object> resultMap = new HashMap<>();
                    resultMap.put("handle", handle);
                    resultMap.put("method", "multipleUploadMediaProgress");
                    resultMap.put("multipleMediaUploadingCallbackID",
                                  multipleMediaUploadingCallbackID);
                    resultMap.put("messageID", messageID);
                    resultMap.put("message", messageMap);
                    resultMap.put("currentFileSize", currentFileSize);
                    resultMap.put("totalFileSize", totalFileSize);
                    resultMap.put("messageInfoIndex", messageInfoIndex);
                    resultMap.put("currentIndexFileSize", currentIndexFileSize);
                    resultMap.put("totalIndexFileSize", totalIndexFileSize);
                    ZIMPluginEventHandler.mysink.success(resultMap);
                }
    ...
    public static void insertMessageToLocalDB(MethodCall call, Result result) {
        ...
        zim.insertMessageToLocalDB(
            message, conversationID, conversationType, senderUserID,
    ...
    public static void updateMessageLocalExtendedData(MethodCall call, Result result) {
        ...
        zim.updateMessageLocalExtendedData(
            localExtendedData, message, new ZIMMessageLocalExtendedDataUpdatedCallback() {
                @Override
    ...
    public static void sendMediaMessage(MethodCall call, Result result) {
        ...
        ZIMMediaMessage mediaMessage = (ZIMMediaMessage)ZIMPluginConverter.oZIMMessage(
            Objects.requireNonNull(call.argument("message")));
        ...
        ZIMMessageSendConfig config = ZIMPluginConverter.oZIMMessageSendConfig(
            Objects.requireNonNull(call.argument("config")));
        Integer progressID = call.argument("mediaUploadingCallbackID");
        Integer messageID = call.argument("messageID");
        Integer messageAttachedCallbackID = call.argument("messageAttachedCallbackID");

        zim.sendMediaMessage(
            mediaMessage, toConversationID, conversationType, config,
            new ZIMMediaMessageSentCallback() {
                ...
                public void onMediaUploadingProgress(ZIMMediaMessage message, long currentFileSize,
                    ...
                    resultMap.put("handle", handle);
                    resultMap.put("method", "uploadMediaProgress");
                    resultMap.put("mediaUploadingCallbackID", progressID);
                    resultMap.put("message", messageMap);
                    resultMap.put("currentFileSize", currentFileSize);
                    resultMap.put("totalFileSize", totalFileSize);
                    ZIMPluginEventHandler.mysink.success(resultMap);
    ...
    public static void replyMessage(MethodCall call, Result result) {
        String handle = call.argument("handle");
        ZIM zim = engineMap.get(handle);
        if (zim == null) {
            result.error("-1", "no native instance", null);
        ...
        ZIMMessage message = (ZIMMessage)ZIMPluginConverter.oZIMMessage(
            Objects.requireNonNull(call.argument("message")));
        ZIMMessage toOriginalMessage = (ZIMMessage)ZIMPluginConverter.oZIMMessage(
            Objects.requireNonNull(call.argument("toOriginalMessage")));
        ZIMMessageSendConfig config = ZIMPluginConverter.oZIMMessageSendConfig(
            Objects.requireNonNull(call.argument("config")));
        Integer messageID = call.argument("messageID");
        Integer messageAttachedCallbackID = call.argument("messageAttachedCallbackID");
        ...
        zim.replyMessage(message, toOriginalMessage, config, new ZIMMessageSentFullCallback() {
            @Override
            public void onMessageAttached(ZIMMessage message) {
                if (messageAttachedCallbackID == null) {
                    return;
            ...
            public void onMultipleMediaUploadingProgress(
                ...
                resultMap.put("handle", handle);
                resultMap.put("method", "multipleUploadMediaProgress");
                resultMap.put("multipleMediaUploadingCallbackID", multipleMediaUploadingCallbackID);
                resultMap.put("messageID", messageID);
                resultMap.put("message", messageMap);
                resultMap.put("currentFileSize", currentFileSize);
                resultMap.put("totalFileSize", totalFileSize);
    ...
    public static void editMessage(MethodCall call, Result result) {
        String handle = call.argument("handle");
        ZIM zim = engineMap.get(handle);
        if (zim == null) {
            result.error("-1", "no native instance", null);
        ...
        zim.editMessage(message, new ZIMMessageEditConfig(), new ZIMMessageSentFullCallback() {
            @Override
            public void onMessageAttached(ZIMMessage message) {
                if (messageAttachedCallbackID == null) {
                    return;
    ...
    public static void cancelSendingMessage(MethodCall call, Result result) {
        String handle = call.argument("handle");
        ZIM zim = engineMap.get(handle);
        if (zim == null) {
            result.error("-1", "no native instance", null);
        ...
        zim.cancelSendingMessage(message, new ZIMSendingMessageCancelConfig(),
    ...
    public static void queryHistoryMessage(MethodCall call, Result result) {
        ...
        ZIMConversationType conversationType = ZIMConversationType.getZIMConversationType(
            ZIMPluginCommonTools.safeGetIntValue(call.argument("conversationType")));
        ZIMMessageQueryConfig config = ZIMPluginConverter.oZIMMessageQueryConfig(
            Objects.requireNonNull(call.argument("config")));

        zim.queryHistoryMessage(
            conversationID, conversationType, config, new ZIMMessageQueriedCallback() {
                @Override
    ...
    public static void queryMessages(MethodCall call, Result result) {
        String handle = call.argument("handle");
        ZIM zim = engineMap.get(handle);
        if (zim == null) {
            result.error("-1", "no native instance", null);
        ...
        zim.queryMessages(
            messageSeqs, conversationID, conversationType, new ZIMMessageQueriedCallback() {
                @Override
                public void onMessageQueried(
                    String conversationID, ZIMConversationType conversationType,
                    ArrayList<ZIMMessage> messageList, ZIMError errorInfo) {
    ...
    public static void queryMessageRepliedList(MethodCall call, Result result) {
        String handle = call.argument("handle");
        ZIM zim = engineMap.get(handle);
        if (zim == null) {
            result.error("-1", "no native instance", null);
        ...
        ZIMMessageRepliedListQueryConfig config =
            ZIMPluginConverter.oZIMMessageRepliedListQueryConfig(
                Objects.requireNonNull(call.argument("config")));

        zim.queryMessageRepliedList(message, config, new ZIMMessageRepliedListQueriedCallback() {
            @Override
            public void onMessageRepliedListQueried(
                ArrayList<ZIMMessage> messageList, long nextFlag,
                ZIMMessageRootRepliedInfo rootRepliedInfo, ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    resultMap.put("nextFlag", nextFlag);
                    resultMap.put("rootRepliedInfo",
                                  ZIMPluginConverter.mZIMMessageRootRepliedInfo(rootRepliedInfo));
    ...
    public static void deleteAllMessage(MethodCall call, Result result) {
        ...
        ZIMConversationType conversationType = ZIMConversationType.getZIMConversationType(
            ZIMPluginCommonTools.safeGetIntValue(call.argument("conversationType")));
        ZIMMessageDeleteConfig config = ZIMPluginConverter.oZIMMessageDeleteConfig(
            Objects.requireNonNull(call.argument("config")));

        zim.deleteAllMessage(
            conversationID, conversationType, config, new ZIMMessageDeletedCallback() {
                @Override
    ...
    public static void deleteMessages(MethodCall call, Result result) {
        ...
        zim.deleteMessages(messageList, conversationID, conversationType, config,
    ...
    public static void pinMessage(MethodCall call, Result result) {
        String handle = call.argument("handle");
        ZIM zim = engineMap.get(handle);
        if (zim == null) {
            result.error("-1", "no native instance", null);
        ...
        ZIMMessage message = (ZIMMessage)ZIMPluginConverter.oZIMMessage(
            Objects.requireNonNull(call.argument("message")));
        boolean isPinned = ZIMPluginCommonTools.safeGetBoolValue(call.argument("isPinned"));
        ZIMMessagePinConfig config = new ZIMMessagePinConfig();

        HashMap<String, Object> configMap =
            (HashMap<String, Object>)Objects.requireNonNull(call.argument("config"));
        config.disableAutoReplace = (boolean)configMap.get("disableAutoReplace");
        zim.pinMessage(message, isPinned, config, new ZIMMessagePinnedCallback() {
            @Override
    ...
    public static void queryPinnedMessageList(MethodCall call, Result result) {
        String handle = call.argument("handle");
        ZIM zim = engineMap.get(handle);
        if (zim == null) {
            result.error("-1", "no native instance", null);
        ...
        zim.queryPinnedMessageList(
            conversationID, conversationType, new ZIMPinnedMessageListQueriedCallback() {
                @Override
                public void onPinnedMessageListQueried(ArrayList<ZIMMessage> messageList,
                                                       ZIMError errorInfo) {
                    if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                        HashMap<String, Object> resultMap = new HashMap<>();
                        resultMap.put("messageList",
    ...
    public static void searchLocalMessages(MethodCall call, Result result) {
        ...
        ZIMConversationType conversationType = ZIMConversationType.getZIMConversationType(
            ZIMPluginCommonTools.safeGetIntValue(call.argument("conversationType")));
        ZIMMessageSearchConfig config = ZIMPluginConverter.oZIMMessageSearchConfig(
            Objects.requireNonNull(call.argument("config")));
        zim.searchLocalMessages(
            conversationID, conversationType, config, new ZIMMessagesSearchedCallback() {
                @Override
                public void onMessagesSearched(
                    String conversationID, ZIMConversationType conversationType,
                    ArrayList<ZIMMessage> messageList, ZIMMessage nextMessage, ZIMError errorInfo) {
                    if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                        HashMap<String, Object> resultMap = new HashMap<>();
                        ...
                        resultMap.put("messageList",
                                      ZIMPluginConverter.mZIMMessageList(messageList));
                        if (nextMessage != null) {
                            resultMap.put("nextMessage",
                                          ZIMPluginConverter.mZIMMessage(nextMessage));
                        } else {
    ...
    public static void searchGlobalLocalMessages(MethodCall call, Result result) {
        ...
        zim.searchGlobalLocalMessages(config, new ZIMMessagesGlobalSearchedCallback() {
            @Override
            public void onMessagesGlobalSearched(ArrayList<ZIMMessage> messageList,
    ...
    public static void searchLocalConversations(MethodCall call, Result result) {
        ...
        ZIMConversationSearchConfig config =
            ZIMPluginConverter.oZIMConversationMessageGlobalSearchConfig(
                Objects.requireNonNull(call.argument("config")));
        zim.searchLocalConversations(config, new ZIMConversationsSearchedCallback() {
            @Override
            public void onConversationsSearched(
                ArrayList<ZIMConversationSearchInfo> globalMessageInfoList, int nextFlag,
                ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    ...
                    resultMap.put(
                        ...
                        ZIMPluginConverter.mZIMConversationSearchInfoList(globalMessageInfoList));
                    resultMap.put("nextFlag", nextFlag);
                    result.success(resultMap);
                } else {
                    result.error(String.valueOf(errorInfo.code.value()), errorInfo.message, null);
    ...
    public static void createRoom(MethodCall call, Result result) {
        ...
        ZIMRoomInfo roomInfo =
            ZIMPluginConverter.oZIMRoomInfo(Objects.requireNonNull(call.argument("roomInfo")));
    ...
    public static void switchRoom(MethodCall call, Result result) {
        ...
        boolean isCreateWhenRoomNotExisted =
            ZIMPluginCommonTools.safeGetBoolValue(call.argument("isCreateWhenRoomNotExisted"));
    ...
    public static void leaveAllRoom(MethodCall call, Result result) {
        ...
        zim.leaveAllRoom(new ZIMRoomAllLeftCallback() {
            ...
            public void onRoomAllLeft(ArrayList<String> roomIDList, ZIMError errorInfo) {
                ...
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    resultMap.put("roomIDs", roomIDList);
                    result.success(resultMap);
                } else {
                    result.error(String.valueOf(errorInfo.code.value()), errorInfo.message, null);
                }
    ...
    public static void queryRoomMemberList(MethodCall call, Result result) {
        ...
        String roomID = call.argument("roomID");
        ZIMRoomMemberQueryConfig config = ZIMPluginConverter.oZIMRoomMemberQueryConfig(
            Objects.requireNonNull(ZIMPluginCommonTools.safeGetHashMap(call.argument("config"))));

        zim.queryRoomMemberList(roomID, config, new ZIMRoomMemberQueriedCallback() {
            @Override
            public void onRoomMemberQueried(String roomID, ArrayList<ZIMUserInfo> memberList,
                                            String nextFlag, ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    resultMap.put("roomID", roomID);
                    ArrayList<HashMap<String, Object>> basicMemberList =
    ...
    public static void queryRoomMembers(MethodCall call, Result result) {
        ...
        zim.queryRoomMembers(userIDs, roomID, new ZIMRoomMembersQueriedCallback() {
            @Override
            public void onRoomMembersQueried(String roomID, ArrayList<ZIMRoomMemberInfo> memberList,
                                             ArrayList<ZIMErrorUserInfo> errorUserList,
                                             ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    resultMap.put("roomID", roomID);
                    ArrayList<HashMap<String, Object>> basicMemberList =
                        ZIMPluginConverter.mZIMRoomMemberInfoList(memberList);
                    ArrayList<HashMap<String, Object>> basicErrorUserList =
                        ZIMPluginConverter.mZIMErrorUserInfoList(errorUserList);
    ...
    public static void queryRoomOnlineMemberCount(MethodCall call, Result result) {
        ...
        zim.queryRoomOnlineMemberCount(roomID, new ZIMRoomOnlineMemberCountQueriedCallback() {
            @Override
            public void onRoomOnlineMemberCountQueried(String roomID, int count,
                                                       ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    resultMap.put("roomID", roomID);
    ...
    public static void setRoomAttributes(MethodCall call, Result result) {
        ...
        ZIMRoomAttributesSetConfig config =
            ZIMPluginConverter.oZIMRoomAttributesSetConfig(call.argument("config"));
        zim.setRoomAttributes(
            roomAttributes, roomID, config, new ZIMRoomAttributesOperatedCallback() {
                @Override
    ...
    public static void deleteRoomAttributes(MethodCall call, Result result) {
        ...
        ZIMRoomAttributesDeleteConfig config =
            ZIMPluginConverter.oZIMRoomAttributesDeleteConfig(call.argument("config"));
    ...
    public static void beginRoomAttributesBatchOperation(MethodCall call, Result result) {
        ...
        ZIMRoomAttributesBatchOperationConfig config =
            ZIMPluginConverter.oZIMRoomAttributesBatchOperationConfig(call.argument("config"));
    ...
    public static void queryRoomAllAttributes(MethodCall call, Result result) {
        ...
        zim.queryRoomAllAttributes(roomID, new ZIMRoomAttributesQueriedCallback() {
            ...
            public void onRoomAttributesQueried(
                String roomID, HashMap<String, String> roomAttributes, ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    resultMap.put("roomID", roomID);
    ...
    public static void setRoomMembersAttributes(MethodCall call, Result result) {
        ...
        ZIMRoomMemberAttributesSetConfig setConfig =
            ZIMPluginConverter.oZIMRoomMemberAttributesSetConfig(call.argument("config"));
        ArrayList<String> userIDs = call.argument("userIDs");
        zim.setRoomMembersAttributes(
            attributes, userIDs, roomID, setConfig, new ZIMRoomMembersAttributesOperatedCallback() {
                @Override
                public void onRoomMembersAttributesOperated(
                    String roomID, ArrayList<ZIMRoomMemberAttributesOperatedInfo> infos,
                    ArrayList<String> errorUserList, ZIMError errorInfo) {
                    if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                        HashMap<String, Object> resultMap = new HashMap<>();
                        resultMap.put("roomID", roomID);
                        ArrayList<HashMap<String, Object>> infosModel = new ArrayList<>();
                        for (ZIMRoomMemberAttributesOperatedInfo info : infos) {
                            infosModel.add(
                                ZIMPluginConverter.mZIMRoomMemberAttributesOperatedInfo(info));
                        }
                        resultMap.put("infos", infosModel);
    ...
    public static void queryRoomMembersAttributes(MethodCall call, Result result) {
        ...
        zim.queryRoomMembersAttributes(
            userIDs, roomID, new ZIMRoomMembersAttributesQueriedCallback() {
                @Override
                public void onRoomMembersAttributesQueried(
                    String roomID, ArrayList<ZIMRoomMemberAttributesInfo> infos,
                    ZIMError errorInfo) {
                    if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                        HashMap<String, Object> resultMap = new HashMap<>();
                        ArrayList<HashMap<String, Object>> infosModel = new ArrayList<>();
    ...
    public static void queryRoomMemberAttributesList(MethodCall call, Result result) {
        ...
        ZIMRoomMemberAttributesQueryConfig queryConfig =
            ZIMPluginConverter.oZIMRoomMemberAttributesQueryConfig(call.argument("config"));
        zim.queryRoomMemberAttributesList(
            roomID, queryConfig, new ZIMRoomMemberAttributesListQueriedCallback() {
                ...
                public void onRoomMemberAttributesListQueried(
                    String roomID, ArrayList<ZIMRoomMemberAttributesInfo> infos, String nextFlag,
                    ZIMError errorInfo) {
                    if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                        HashMap<String, Object> resultMap = new HashMap<>();
                        ArrayList<HashMap<String, Object>> infosModel = new ArrayList<>();
    ...
    public static void createGroup(MethodCall call, Result result) {
        ...
        ZIMGroupInfo groupInfo =
            ZIMPluginConverter.oZIMGroupInfo(Objects.requireNonNull(call.argument("groupInfo")));
        ArrayList<String> userIDs = call.argument("userIDs");
        HashMap<String, Object> configMap =
            ZIMPluginCommonTools.safeGetHashMap(call.argument("config"));

        if (configMap == null) {
            zim.createGroup(groupInfo, userIDs, new ZIMGroupCreatedCallback() {
                @Override
                public void onGroupCreated(
                    ZIMGroupFullInfo groupInfo, ArrayList<ZIMGroupMemberInfo> userList,
                    ArrayList<ZIMErrorUserInfo> errorUserList, ZIMError errorInfo) {

                    if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                        HashMap<String, Object> resultMap = new HashMap<>();
                        HashMap<String, Object> groupInfoMap =
                            ZIMPluginConverter.mZIMGroupFullInfo(groupInfo);
                        ArrayList<HashMap<String, Object>> basicUserList =
                            ZIMPluginConverter.mZIMGroupMemberInfoList(userList);
                        ArrayList<HashMap<String, Object>> basicErrorUserList =
                            ZIMPluginConverter.mZIMErrorUserInfoList(errorUserList);
            ...
            ZIMGroupAdvancedConfig config = ZIMPluginConverter.oZIMGroupAdvancedConfig(
                Objects.requireNonNull(call.argument("config")));
    ...
    public static void kickGroupMembers(MethodCall call, Result result) {
        ...
        zim.kickGroupMembers(userIDs, groupID, new ZIMGroupMemberKickedCallback() {
            @Override
            public void onGroupMemberKicked(String groupID, ArrayList<String> kickedUserIDList,
                                            ArrayList<ZIMErrorUserInfo> errorUserList,
                                            ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
    ...
    public static void transferGroupOwner(MethodCall call, Result result) {
        ...
        zim.transferGroupOwner(toUserID, groupID, new ZIMGroupOwnerTransferredCallback() {
            @Override
            public void onGroupOwnerTransferred(String groupID, String toUserID,
                                                ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
    ...
    public static void updateGroupAvatarUrl(MethodCall call, Result result) {
        ...
        zim.updateGroupAvatarUrl(groupAvatarUrl, groupID, new ZIMGroupAvatarUrlUpdatedCallback() {
            @Override
            public void onGroupAvatarUrlUpdated(String groupID, String groupAvatarUrl,
                                                ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
    ...
    public static void updateGroupNotice(MethodCall call, Result result) {
        ...
        zim.updateGroupNotice(groupNotice, groupID, new ZIMGroupNoticeUpdatedCallback() {
            @Override
            public void onGroupNoticeUpdated(String groupID, String groupNotice,
                                             ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
    ...
    public static void updateGroupJoinMode(MethodCall call, Result result) {
        String handle = call.argument("handle");
        ZIM zim = engineMap.get(handle);
        if (zim == null) {
            result.error("-1", "no native instance", null);
        ...
        ZIMGroupJoinMode mode = ZIMGroupJoinMode.getZIMGroupJoinMode(
            ZIMPluginCommonTools.safeGetIntValue(call.argument("mode")));
        String groupID = call.argument("groupID");
        zim.updateGroupJoinMode(mode, groupID, (groupID1, mode1, errorInfo) -> {
            if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                HashMap<String, Object> resultMap = new HashMap<>();
                resultMap.put("groupID", groupID1);
                resultMap.put("mode", mode1.value());
                result.success(resultMap);
            } else {
                result.error(String.valueOf(errorInfo.code.value()), errorInfo.message, null);
            }
    ...
    public static void updateGroupInviteMode(MethodCall call, Result result) {
        String handle = call.argument("handle");
        ZIM zim = engineMap.get(handle);
        if (zim == null) {
            result.error("-1", "no native instance", null);
        ...
        ZIMGroupInviteMode mode = ZIMGroupInviteMode.getZIMGroupInviteMode(
            ZIMPluginCommonTools.safeGetIntValue(call.argument("mode")));
        String groupID = call.argument("groupID");
        zim.updateGroupInviteMode(mode, groupID, (groupID1, mode1, errorInfo) -> {
            if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                HashMap<String, Object> resultMap = new HashMap<>();
                resultMap.put("groupID", groupID1);
                resultMap.put("mode", mode1.value());
    ...
    public static void updateGroupBeInviteMode(MethodCall call, Result result) {
        String handle = call.argument("handle");
        ZIM zim = engineMap.get(handle);
        if (zim == null) {
            result.error("-1", "no native instance", null);
        ...
        ZIMGroupBeInviteMode mode = ZIMGroupBeInviteMode.getZIMGroupBeInviteMode(
            ZIMPluginCommonTools.safeGetIntValue(call.argument("mode")));
        String groupID = call.argument("groupID");
        zim.updateGroupBeInviteMode(mode, groupID, (groupID1, mode1, errorInfo) -> {
            if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                HashMap<String, Object> resultMap = new HashMap<>();
                resultMap.put("groupID", groupID1);
                resultMap.put("mode", mode1.value());
    ...
    public static void sendGroupJoinApplication(MethodCall call, Result result) {
        String handle = call.argument("handle");
        ZIM zim = engineMap.get(handle);
        if (zim == null) {
            result.error("-1", "no native instance", null);
        ...
        ZIMGroupJoinApplicationSendConfig config =
            ZIMPluginConverter.oZIMGroupJoinApplicationSendConfig(
                Objects.requireNonNull(call.argument("config")));
        String groupID = call.argument("groupID");
        zim.sendGroupJoinApplication(groupID, config, (groupID1, errorInfo) -> {
            if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                HashMap<String, Object> resultMap = new HashMap<>();
                resultMap.put("groupID", groupID1);
                result.success(resultMap);
    ...
    public static void acceptGroupJoinApplication(MethodCall call, Result result) {
        String handle = call.argument("handle");
        ZIM zim = engineMap.get(handle);
        if (zim == null) {
            result.error("-1", "no native instance", null);
        ...
        ZIMGroupJoinApplicationAcceptConfig config =
            ZIMPluginConverter.oZIMGroupJoinApplicationAcceptConfig(
                Objects.requireNonNull(call.argument("config")));
        String groupID = call.argument("groupID");
        String userID = call.argument("userID");
        zim.acceptGroupJoinApplication(userID, groupID, config, (groupID1, userID1, errorInfo) -> {
            if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                HashMap<String, Object> resultMap = new HashMap<>();
                resultMap.put("groupID", groupID1);
    ...
    public static void rejectGroupJoinApplication(MethodCall call, Result result) {
        String handle = call.argument("handle");
        ZIM zim = engineMap.get(handle);
        if (zim == null) {
            result.error("-1", "no native instance", null);
        ...
        ZIMGroupJoinApplicationRejectConfig config =
            ZIMPluginConverter.oZIMGroupJoinApplicationRejectConfig(
                Objects.requireNonNull(call.argument("config")));
        String groupID = call.argument("groupID");
        String userID = call.argument("userID");
        zim.rejectGroupJoinApplication(userID, groupID, config, (groupID1, userID1, errorInfo) -> {
            if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                HashMap<String, Object> resultMap = new HashMap<>();
                resultMap.put("groupID", groupID1);
                resultMap.put("userID", userID1);
    ...
    public static void sendGroupInviteApplications(MethodCall call, Result result) {
        String handle = call.argument("handle");
        ZIM zim = engineMap.get(handle);
        if (zim == null) {
            result.error("-1", "no native instance", null);
        ...
        ZIMGroupInviteApplicationSendConfig config =
            ZIMPluginConverter.oZIMGroupInviteApplicationSendConfig(
                Objects.requireNonNull(call.argument("config")));
        String groupID = call.argument("groupID");
        ArrayList<String> userIDs = call.argument("userIDs");
        zim.sendGroupInviteApplications(
            userIDs, groupID, config, (groupID1, errorUserList, errorInfo) -> {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    resultMap.put("groupID", groupID1);
                    ArrayList<HashMap<String, Object>> basicErrorUserList =
    ...
    public static void acceptGroupInviteApplication(MethodCall call, Result result) {
        String handle = call.argument("handle");
        ZIM zim = engineMap.get(handle);
        if (zim == null) {
            result.error("-1", "no native instance", null);
        ...
        ZIMGroupInviteApplicationAcceptConfig config =
            ZIMPluginConverter.oZIMGroupInviteApplicationAcceptConfig(
                Objects.requireNonNull(call.argument("config")));
        String groupID = call.argument("groupID");
        String inviterUserID = call.argument("inviterUserID");
        zim.acceptGroupInviteApplication(
            inviterUserID, groupID, config, (groupInfo, inviterUserID1, errorInfo) -> {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    HashMap<String, Object> groupInfoMap =
                        ZIMPluginConverter.mZIMGroupFullInfo(groupInfo);
                    resultMap.put("groupInfo", groupInfoMap);
                    resultMap.put("inviterUserID", inviterUserID1);
                    result.success(resultMap);
                } else {
                    result.error(String.valueOf(errorInfo.code.value()), errorInfo.message, null);
                }
    ...
    public static void rejectGroupInviteApplication(MethodCall call, Result result) {
        String handle = call.argument("handle");
        ZIM zim = engineMap.get(handle);
        if (zim == null) {
            result.error("-1", "no native instance", null);
        ...
        ZIMGroupInviteApplicationRejectConfig config =
            ZIMPluginConverter.oZIMGroupInviteApplicationRejectConfig(
                Objects.requireNonNull(call.argument("config")));
        String groupID = call.argument("groupID");
        String inviterUserID = call.argument("inviterUserID");
        zim.rejectGroupInviteApplication(
            inviterUserID, groupID, config, (groupID1, inviterUserID1, errorInfo) -> {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    resultMap.put("groupID", groupID1);
                    resultMap.put("inviterUserID", inviterUserID1);
    ...
    public static void queryGroupApplicationList(MethodCall call, Result result) {
        String handle = call.argument("handle");
        ZIM zim = engineMap.get(handle);
        if (zim == null) {
            result.error("-1", "no native instance", null);
        ...
        ZIMGroupApplicationListQueryConfig config =
            ZIMPluginConverter.oZIMGroupApplicationListQueryConfig(
                Objects.requireNonNull(call.argument("config")));
        zim.queryGroupApplicationList(config, (applicationList, nextFlag, errorInfo) -> {
            if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                HashMap<String, Object> resultMap = new HashMap<>();
    ...
    public static void muteGroup(MethodCall call, Result result) {
        ...
        ZIMGroupMuteConfig config =
            ZIMPluginConverter.oZIMGroupMuteConfig(Objects.requireNonNull(call.argument("config")));

        zim.muteGroup(isMute, groupID, config, new ZIMGroupMutedCallback() {
            @Override
            public void onGroupMuted(String groupID, boolean isMute, ZIMGroupMuteInfo info,
                                     ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    HashMap<String, Object> groupMuteInfoMap =
                        ZIMPluginConverter.mZIMGroupMuteInfo(info);
                    resultMap.put("isMute", isMute);
                    resultMap.put("groupID", groupID);
                    resultMap.put("mutedInfo", groupMuteInfoMap);
                    result.success(resultMap);
                } else {
                    result.error(String.valueOf(errorInfo.code.value()), errorInfo.message, null);
                }
    ...
    public static void muteGroupMembers(MethodCall call, Result result) {
        ...
        String groupID = call.argument("groupID");
        ArrayList<String> userIDs = call.argument("userIDs");
        ZIMGroupMemberMuteConfig config = ZIMPluginConverter.oZIMGroupMemberMuteConfig(
            Objects.requireNonNull(call.argument("config")));

        zim.muteGroupMembers(isMute, userIDs, groupID, config, new ZIMGroupMembersMutedCallback() {
            @Override
            public void onGroupMembersMuted(
                String groupID, boolean isMute, int duration, ArrayList<String> mutedMemberIDs,
                ArrayList<ZIMErrorUserInfo> errorUserList, ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
    ...
    public static void queryGroupMemberMutedList(MethodCall call, Result result) {
        ...
        ZIMGroupMemberMutedListQueryConfig config =
            ZIMPluginConverter.oZIMGroupMemberMutedListQueryConfig(
                Objects.requireNonNull(call.argument("config")));
        zim.queryGroupMemberMutedList(
            groupID, config, new ZIMGroupMemberMutedListQueriedCallback() {
                @Override
    ...
    public static void setGroupAttributes(MethodCall call, Result result) {
        ...
        zim.setGroupAttributes(groupAttributes, groupID, new ZIMGroupAttributesOperatedCallback() {
            @Override
            public void onGroupAttributesOperated(String groupID, ArrayList<String> errorKeys,
                                                  ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    resultMap.put("groupID", groupID);
    ...
    public static void queryGroupAttributes(MethodCall call, Result result) {
        ...
        zim.queryGroupAttributes(keys, groupID, new ZIMGroupAttributesQueriedCallback() {
            ...
            public void onGroupAttributesQueried(
                String groupID, HashMap<String, String> groupAttributes, ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    resultMap.put("groupID", groupID);
    ...
    public static void setGroupMemberRole(MethodCall call, Result result) {
        ...
        zim.setGroupMemberRole(role, forUserID, groupID, new ZIMGroupMemberRoleUpdatedCallback() {
            @Override
            public void onGroupMemberRoleUpdated(String groupID, String forUserID, int role,
                                                 ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    resultMap.put("groupID", groupID);
    ...
    public static void setGroupMemberNickname(MethodCall call, Result result) {
        ...
        zim.setGroupMemberNickname(
            nickname, forUserID, groupID, new ZIMGroupMemberNicknameUpdatedCallback() {
                @Override
                public void onGroupMemberNicknameUpdated(String groupID, String forUserID,
    ...
    public static void queryGroupMemberInfo(MethodCall call, Result result) {
        ...
        zim.queryGroupMemberInfo(userID, groupID, new ZIMGroupMemberInfoQueriedCallback() {
            @Override
            public void onGroupMemberInfoQueried(String groupID, ZIMGroupMemberInfo userInfo,
                                                 ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
    ...
    public static void queryGroupList(MethodCall call, Result result) {
        ...
        if (call.argument("count") != null) {
            int count = ZIMPluginCommonTools.safeGetIntValue(call.argument("count"));
            if (count < 0) {
                count = 0;
            }
            ...
            if (call.argument("config") != null) {
                ...
                config.userIDs = (ArrayList<String>)configMap.get("userIDs");
            ...
            zim.queryGroupList(count, config, new ZIMGroupListQueriedCallback() {
                @Override
                public void onGroupListQueried(ArrayList<ZIMGroup> groupList, long nextFlag,
                                               ZIMError errorInfo) {
                    if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                        HashMap<String, Object> resultMap = new HashMap<>();
                        ArrayList<HashMap<String, Object>> basicGroupList =
                            ZIMPluginConverter.mZIMGroupList(groupList);
    ...
    public static void queryGroupMemberList(MethodCall call, Result result) {
        ...
        String groupID = call.argument("groupID");
        ZIMGroupMemberQueryConfig config = ZIMPluginConverter.oZIMGroupMemberQueryConfig(
            Objects.requireNonNull(call.argument("config")));
    ...
    public static void searchLocalGroups(MethodCall call, Result result) {
        ...
        ZIMGroupSearchConfig config = ZIMPluginConverter.oZIMGroupSearchConfig(
            Objects.requireNonNull(call.argument("config")));
        zim.searchLocalGroups(config, new ZIMGroupsSearchedCallback() {
            @Override
            public void onGroupsSearched(ArrayList<ZIMGroupSearchInfo> groupSearchInfoList,
                                         int nextFlag, ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();

                    resultMap.put("groupSearchInfoList",
                                  ZIMPluginConverter.mZIMGroupSearchInfoList(groupSearchInfoList));
                    resultMap.put("nextFlag", nextFlag);
                    result.success(resultMap);
                } else {
                    result.error(String.valueOf(errorInfo.code.value()), errorInfo.message, null);
    ...
    public static void searchLocalGroupMembers(MethodCall call, Result result) {
        ...
        String groupID = call.argument("groupID");
        ZIMGroupMemberSearchConfig config = ZIMPluginConverter.oZIMGroupMemberSearchConfig(
            Objects.requireNonNull(call.argument("config")));
        zim.searchLocalGroupMembers(groupID, config, new ZIMGroupMembersSearchedCallback() {
            @Override
            public void onGroupMembersSearched(String groupID,
                                               ArrayList<ZIMGroupMemberInfo> userList, int nextFlag,
                                               ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
    ...
    public static void callInvite(MethodCall call, Result result) {
        ...
        ZIMCallInviteConfig config = ZIMPluginConverter.oZIMCallInviteConfig(
            Objects.requireNonNull(call.argument("config")));
    ...
    public static void callingInvite(MethodCall call, Result result) {
        ...
        ArrayList<String> invitees = call.argument("invitees");
        ZIMCallingInviteConfig config = ZIMPluginConverter.oZIMCallingInviteConfig(
            Objects.requireNonNull(call.argument("config")));
    ...
    public static void callJoin(MethodCall call, Result result) {
        ...
        String callID = call.argument("callID");
        ZIMCallJoinConfig joinConfig =
            ZIMPluginConverter.oZIMCallJoinConfig(call.argument("config"));
        zim.callJoin(callID, joinConfig, new ZIMCallJoinSentCallback() {
            @Override
            public void onCallJoinSent(String callID, ZIMCallJoinSentInfo info,
                                       ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
    ...
    public static void callQuit(MethodCall call, Result result) {
        ...
        ZIMCallQuitConfig config =
            ZIMPluginConverter.oZIMCallQuitConfig(Objects.requireNonNull(call.argument("config")));
        zim.callQuit(callID, config, new ZIMCallQuitSentCallback() {
            @Override
            public void onCallQuitSent(String callID, ZIMCallQuitSentInfo info,
                                       ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
    ...
    public static void callEnd(MethodCall call, Result result) {
        ...
        ZIMCallEndConfig config =
            ZIMPluginConverter.oZIMCallEndConfig(Objects.requireNonNull(call.argument("config")));

        zim.callEnd(callID, config, new ZIMCallEndSentCallback() {
            @Override
            public void onCallEndSent(String callID, ZIMCallEndedSentInfo info,
                                      ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
    ...
    public static void callCancel(MethodCall call, Result result) {
        ...
        ArrayList<String> invitees = call.argument("invitees");
        ZIMCallCancelConfig config = ZIMPluginConverter.oZIMCallCancelConfig(
            Objects.requireNonNull(call.argument("config")));
        String callID = call.argument("callID");
        zim.callCancel(invitees, callID, config, new ZIMCallCancelSentCallback() {
            @Override
            public void onCallCancelSent(String callID, ArrayList<String> errorInvitees,
                                         ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
    ...
    public static void callAccept(MethodCall call, Result result) {
        ...
        String callID = call.argument("callID");
        ZIMCallAcceptConfig config = ZIMPluginConverter.oZIMCallAcceptConfig(
            Objects.requireNonNull(call.argument("config")));
    ...
    public static void callReject(MethodCall call, Result result) {
        ...
        String callID = call.argument("callID");
        ZIMCallRejectConfig config = ZIMPluginConverter.oZIMCallRejectConfig(
            Objects.requireNonNull(call.argument("config")));
    ...
    public static void addMessageReaction(MethodCall call, Result result) {
        ...
        ZIMMessageReactionAddConfig config = ZIMPluginConverter.oZIMMessageReactionAddConfig(
            Objects.requireNonNull(call.argument("config")));

        zim.addMessageReaction(
            reactionType, message, config, new ZIMMessageReactionAddedCallback() {
                @Override
    ...
    public static void deleteMessageAllReactions(MethodCall call, Result result) {
        String handle = call.argument("handle");
        ZIM zim = engineMap.get(handle);
        if (zim == null) {
            result.error("-1", "no native instance", null);
    ...
    public static void queryMessageReactionUserList(MethodCall call, Result result) {
        ...
        ZIMMessageReactionUserQueryConfig config =
            ZIMPluginConverter.oZIMMessageReactionUsersQueryConfig(
                Objects.requireNonNull(call.argument("config")));

        zim.queryMessageReactionUserList(
            message, config, new ZIMMessageReactionUserListQueriedCallback() {
                @Override
                public void onMessageReactionUserListQueried(
                    ZIMMessage message, ArrayList<ZIMMessageReactionUserFullInfo> userList,
                    ...
                    if (error.code == ZIMErrorCode.SUCCESS) {
                        ...
                        resultMap.put(
                            "userList",
                            ZIMPluginConverter.mZIMMessageReactionUserInfoListByFullInfoList(
                                userList));
                        resultMap.put(
                            "userInfoList",
                            ZIMPluginConverter.mZIMMessageReactionUserFullInfoList(userList));
    ...
    public static void queryCallInvitationList(MethodCall call, Result result) {
        String handle = call.argument("handle");
        ZIM zim = engineMap.get(handle);
        if (zim == null) {
            result.error("-1", "no native instance", null);
        ...
        ZIMCallInvitationQueryConfig config = ZIMPluginConverter.oZIMQueryCallListConfig(
            Objects.requireNonNull(call.argument("config")));
    ...
    public static void addFriend(MethodCall call, Result result) {
        ...
        LogWriter.writeLog("Flutter Android invoke add Friend. attributes:" +
                           config.friendAttributes.toString());
        zim.addFriend(userID, config, new ZIMFriendAddedCallback() {
            ...
            public void onFriendAddedCallback(ZIMFriendInfo friendInfo, ZIMError zimError) {
                LogWriter.writeLog(
                    "Flutter Android add Friend Callback receive.friendInfo attributes:" +
                    friendInfo.friendAttributes.toString());
                if (zimError.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    resultMap.put("friendInfo", ZIMPluginConverter.mZIMFriendInfo(
                                                    friendInfo)); // Assuming mZIMFriendInfo exists
                    result.success(resultMap);
                } else {
    ...
    public static void sendFriendApplication(MethodCall call, Result result) {
        ...
        ZIMFriendApplicationSendConfig config =
            ZIMPluginConverter.oZIMFriendApplicationSendConfig(configMap);
        LogWriter.writeLog("Flutter Native Android invoke sendFriendApplication,attributes:" +
                           config.friendAttributes.toString());
        zim.sendFriendApplication(userID, config, new ZIMFriendApplicationSentCallback() {
            @Override
            public void onFriendApplicationSentCallback(ZIMFriendApplicationInfo applicationInfo,
                                                        ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    resultMap.put(
                        "applicationInfo",
                        ZIMPluginConverter.mZIMFriendApplicationInfo(
                            applicationInfo)); // Assuming mZIMFriendApplicationInfo exists
                    result.success(resultMap);
                } else {
                    result.error(String.valueOf(errorInfo.code.value()), errorInfo.message, null);
                }
    ...
    public static void deleteFriends(MethodCall call, Result result) {
        ...
        zim.deleteFriends(userIDs, config, new ZIMFriendsDeletedCallback() {
            @Override
            public void onFriendsDeletedCallback(ArrayList<ZIMErrorUserInfo> errorUserList,
                                                 ZIMError zimError) {
                if (zimError.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    ArrayList<HashMap<String, Object>> errorUsersMapList = new ArrayList<>();
                    for (ZIMErrorUserInfo userInfo : errorUserList) {
                        HashMap<String, Object> userInfoMap = ZIMPluginConverter.mZIMErrorUserInfo(
                            userInfo); // 假设存在 mZIMErrorUserInfo 转换函数
    ...
    public static void checkFriendsRelation(MethodCall call, Result result) {
        ...
        ZIMFriendRelationCheckConfig config =
            ZIMPluginConverter.oZIMFriendRelationCheckConfig(configMap);

        zim.checkFriendsRelation(userIDs, config, new ZIMFriendsRelationCheckedCallback() {
            @Override
            public void onFriendsChecked(ArrayList<ZIMFriendRelationInfo> relationInfos,
                                         ArrayList<ZIMErrorUserInfo> errorUserList,
                                         ZIMError zimError) {
                if (zimError.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    ...
                    for (ZIMFriendRelationInfo info : relationInfos) {
                        HashMap<String, Object> infoMap = ZIMPluginConverter.mZIMFriendRelationInfo(
                            info); // 假设存在 mZIMFriendRelationInfo 转换函数
                    ...
                    for (ZIMErrorUserInfo errorInfo : errorUserList) {
                        HashMap<String, Object> errorInfoMap = ZIMPluginConverter.mZIMErrorUserInfo(
                            errorInfo); // 假设存在 mZIMErrorUserInfo 转换函数
    ...
    public static void updateFriendAlias(MethodCall call, Result result) {
        ...
        zim.updateFriendAlias(friendAlias, userID, new ZIMFriendAliasUpdatedCallback() {
            ...
            public void onFriendAliasUpdated(ZIMFriendInfo friendInfo, ZIMError zimError) {
                if (zimError.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    resultMap.put("friendInfo",
                                  ZIMPluginConverter.mZIMFriendInfo(
                                      friendInfo)); // 假设存在 mZIMFriendInfo 转换函数
                    result.success(resultMap);
                } else {
                    result.error(String.valueOf(zimError.code.value()), zimError.message, null);
                }
    ...
    public static void updateFriendAttributes(MethodCall call, Result result) {
        ...
        zim.updateFriendAttributes(
            friendAttributes, userID, new ZIMFriendAttributesUpdatedCallback() {
                @Override
    ...
    public static void queryFriendsInfo(MethodCall call, Result result) {
        ...
        zim.queryFriendsInfo(userIDs, new ZIMFriendsInfoQueriedCallback() {
            @Override
            public void onFriendsInfoQueried(ArrayList<ZIMFriendInfo> friendInfos,
                                             ArrayList<ZIMErrorUserInfo> errorUserList,
                                             ZIMError zimError) {
                if (zimError.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    ...
                    for (ZIMFriendInfo friendInfo : friendInfos) {
                        HashMap<String, Object> friendInfoMap = ZIMPluginConverter.mZIMFriendInfo(
                            friendInfo); // 假设存在 mZIMFriendInfo 转换函数
                        friendInfoMapList.add(friendInfoMap);
                    }
                    LogWriter.writeLog(
                        "flutter native android onFriendsInfoQueried,friendsInfos size:" +
                        friendInfos.size() + "friendsMapList size:" + friendInfoMapList.size());
    ...
    public static void acceptFriendApplication(MethodCall call, Result result) {
        ...
        ZIMFriendApplicationAcceptConfig config =
            ZIMPluginConverter.oZIMFriendApplicationAcceptConfig(configMap);
        LogWriter.writeLog("flutter native android acceptFriendApplication,attributes:" +
                           config.friendAttributes.toString() + "alias:" + config.friendAlias);
        zim.acceptFriendApplication(userID, config, new ZIMFriendApplicationAcceptedCallback() {
            ...
            public void onFriendApplicationAccepted(ZIMFriendInfo friendInfo, ZIMError errorInfo) {
                LogWriter.writeLog(
                    "flutter native android onFriendApplicationAccepted,attributes:" +
                    friendInfo.friendAttributes.toString() + "alias:" + friendInfo.friendAlias);
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    resultMap.put("friendInfo",
                                  ZIMPluginConverter.mZIMFriendInfo(
                                      friendInfo)); // 假设存在 mZIMFriendApplicationInfo 转换函数
                    result.success(resultMap);
                } else {
                    result.error(String.valueOf(errorInfo.code.value()), errorInfo.message, null);
                }
    ...
    public static void rejectFriendApplication(MethodCall call, Result result) {
        ...
        ZIMFriendApplicationRejectConfig config =
            ZIMPluginConverter.oZIMFriendApplicationRejectConfig(configMap);
        ...
        zim.rejectFriendApplication(userID, config, new ZIMFriendApplicationRejectedCallback() {
            ...
            public void onFriendApplicationRejected(ZIMUserInfo userInfo, ZIMError zimError) {
                LogWriter.writeLog("Flutter Android Native onFriendApplicationRejected,userInfo:" +
                                   userInfo.toString());
                if (zimError.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    resultMap.put("userInfo", ZIMPluginConverter.mZIMUserInfo(
                                                  userInfo)); // 假设存在 mZIMUserInfo 转换函数
                    result.success(resultMap);
                } else {
                    result.error(String.valueOf(zimError.code.value()), zimError.message, null);
                }
    ...
    public static void queryFriendApplicationList(MethodCall call, Result result) {
        ...
        ZIMFriendApplicationListQueryConfig config =
            ZIMPluginConverter.oZIMFriendApplicationListQueryConfig(configMap);
        ...
        zim.queryFriendApplicationList(config, new ZIMFriendApplicationListQueriedCallback() {
            ...
            public void onFriendApplicationListQueried(
                ArrayList<ZIMFriendApplicationInfo> applicationList, int nextFlag,
                ZIMError zimError) {
                if (zimError.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
    ...
    public static void searchLocalFriends(MethodCall call, Result result) {
        ...
        zim.searchLocalFriends(config, new ZIMFriendsSearchedCallback() {
            @Override
            public void onFriendsSearched(ArrayList<ZIMFriendInfo> friendInfos, int nextFlag,
                                          ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    ...
                    for (ZIMFriendInfo friendInfo : friendInfos) {
                        HashMap<String, Object> friendHashMap =
                            ZIMPluginConverter.mZIMFriendInfo(friendInfo);
    ...
    public static void addUsersToBlacklist(MethodCall call, Result result) {
        ...
        zim.addUsersToBlacklist(userIDs, new ZIMBlacklistUsersAddedCallback() {
            @Override
            public void onBlacklistUsersAdded(ArrayList<ZIMErrorUserInfo> errorUserList,
                                              ZIMError error) {
                if (error.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    ...
                    for (ZIMErrorUserInfo errorUserInfo : errorUserList) {
                        HashMap<String, Object> errorUserInfoMap =
                            ZIMPluginConverter.mZIMErrorUserInfo(
                                errorUserInfo); // 假设存在 mZIMErrorUserInfo 转换函数
    ...
    public static void removeUsersFromBlacklist(MethodCall call, Result result) {
        ...
        zim.removeUsersFromBlacklist(userIDs, new ZIMBlacklistUsersRemovedCallback() {
            @Override
            public void onBlacklistUsersRemoved(ArrayList<ZIMErrorUserInfo> errorUserInfoArrayList,
                                                ZIMError zimError) {
                if (zimError.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
    ...
    public static void queryBlacklist(MethodCall call, Result result) {
        ...
        ZIMBlacklistQueryConfig config = ZIMPluginConverter.oZIMBlacklistQueryConfig(
            Objects.requireNonNull(call.argument("config"))); // 从 call 中提取并转换配置
        zim.queryBlacklist(config, new ZIMBlacklistQueriedCallback() {
            ...
            public void onBlacklistQueried(ArrayList<ZIMUserInfo> blacklist, int nextFlag,
                                           ZIMError zimError) {
                LogWriter.writeLog("Flutter Android onBlacklistQueried,size:%d " +
                                   blacklist.size());
                if (zimError.code == ZIMErrorCode.SUCCESS) {
                    // 在成功的情况下，处理并返回黑名单用户信息列表
                    ArrayList<HashMap<String, Object>> blacklistMapList = new ArrayList<>();
                    for (ZIMUserInfo userInfo : blacklist) {
                        HashMap<String, Object> userInfoMap = ZIMPluginConverter.mZIMUserInfo(
                            userInfo); // 假设存在 mZIMUserInfo 转换函数
    ...
    public static void queryCombineMessageDetail(MethodCall call, Result result) {
        ...
        ZIMCombineMessage message = (ZIMCombineMessage)ZIMPluginConverter.oZIMMessage(
            Objects.requireNonNull(call.argument("message")));
    ...
    public static void exportLocalMessages(MethodCall call, Result result) {
        ...
        zim.exportLocalMessages(folderPath, config, new ZIMMessageExportedCallback() {
            ...
            @Override
            public void onMessageExportingProgress(long exportedMessageCount,
    ...
    public static void importLocalMessages(MethodCall call, Result result) {
        ...
        zim.importLocalMessages(folderPath, config, new ZIMMessageImportedCallback() {
            ...
            @Override
            public void onMessageImportingProgress(long importedMessageCount,
                                                   long totalMessageCount) {
                if (ZIMPluginEventHandler.mysink == null) {
                    return;
                }
    ...
    public static void clearLocalFileCache(MethodCall call, Result result) {
        ...
        ZIMFileCacheClearConfig config =
            ZIMPluginConverter.oZIMFileCacheClearConfig(call.argument("config"));
    ...
    public static void queryLocalFileCache(MethodCall call, Result result) {
        ...
        ZIMFileCacheQueryConfig config =
            ZIMPluginConverter.oZIMFileCacheQueryConfig(call.argument("config"));
        zim.queryLocalFileCache(config, new ZIMFileCacheQueriedCallback() {
            ...
            public void onFileCacheQueried(ZIMFileCacheInfo fileCacheInfo, ZIMError errorInfo) {
                if (errorInfo.code == ZIMErrorCode.SUCCESS) {
                    HashMap<String, Object> resultMap = new HashMap<>();
                    resultMap.put("fileCacheInfo",
                                  ZIMPluginConverter.mZIMFileCacheInfo(fileCacheInfo));
                    result.success(resultMap);
                } else {
                    result.error(String.valueOf(errorInfo.code.value()), errorInfo.message, null);
                }
