...
public class ZIMPluginConverter {
    ...
    static public ZIMLoginConfig oZIMLoginConfig(HashMap<String, Object> configMap) {
        ...
        config.customStatus = (String)(configMap.get("customStatus"));
        config.customStatusDuration = ZIMPluginCommonTools.safeGetLongValue(configMap.get("customStatusDuration"));
        return config;
    }

    static public ZIMUserCustomStatusUpdateConfig oZIMUserCustomStatusUpdateConfig(HashMap<String, Object> configMap) {
        ZIMUserCustomStatusUpdateConfig config = new ZIMUserCustomStatusUpdateConfig();
        config.setDuration(ZIMPluginCommonTools.safeGetLongValue(configMap.get("duration")));
        return config;
    }
    ...
    static public HashMap<String, Object> mZIMConversation(ZIMConversation conversation) {
        ...
        conversationMap.put("pinnedTime", conversation.pinnedTime);
        conversationMap.put("draft", conversation.draft);
        conversationMap.put("marks", conversation.marks);
        conversationMap.put("readMessageSeq", conversation.readMessageSeq);
    ...
    static public HashMap<String, Object> mZIMMessage(ZIMMessage message) {
        ...
        messageMap.put("editorUserID", message.getEditorUserID());
        messageMap.put("editedTime", message.getEditedTime());
        messageMap.put("isGroupTargetedMessage", message.isGroupTargetedMessage());
        messageMap.put("pinnedUserID", message.getPinnedUserID());
        messageMap.put("pinnedTime", message.getPinnedTime());
        ...
        case MULTIPLE:
            ...
            messageMap.put(
                "messageInfoList",
                mZIMMessageLiteInfoList(((ZIMMultipleMessage)message).getMessageInfoList()));
            messageMap.put("failedIndexList", ((ZIMMultipleMessage)message).getFailedIndexList());
            break;
        case TIPS:
    ...
    static public ZIMMessage oZIMMessage(HashMap<String, Object> messageMap) {
        ...
        case MULTIPLE:
            ...
            for (HashMap<String, Object> map :
                 (ArrayList<HashMap<String, Object>>)messageMap.get("messageInfoList")) {
                messageInfoList.add(oZIMMessageLiteInfo(map));
            }
            ArrayList<Integer> failedIndexList = new ArrayList<>();
            Object failedIndexListMap = messageMap.get("failedIndexList");
            if (failedIndexListMap instanceof ArrayList) {
                ArrayList<?> list = (ArrayList<?>)failedIndexListMap;
                if (list.stream().allMatch(Integer.class ::isInstance)) {
                    failedIndexList = (ArrayList<Integer>)list;
                }
            }
        ...
        try {
            ...
            Field editorUserIDField = ZIMMessage.class.getDeclaredField("editorUserID");
            editorUserIDField.setAccessible(true);
            editorUserIDField.set(message, messageMap.get("editorUserID"));
            editorUserIDField.setAccessible(false);

            Field editedTimeField = ZIMMessage.class.getDeclaredField("editedTime");
            editedTimeField.setAccessible(true);
            editedTimeField.set(message, messageMap.get("editedTime"));
            editedTimeField.setAccessible(false);

            Field isGroupTargetedMessageField =
                ZIMMessage.class.getDeclaredField("isGroupTargetedMessage");
            isGroupTargetedMessageField.setAccessible(true);
            isGroupTargetedMessageField.set(message, ZIMPluginCommonTools.safeGetBoolValue(
                                                         messageMap.get("isGroupTargetedMessage")));
            isGroupTargetedMessageField.setAccessible(false);

            Field pinnedUserIDField = ZIMMessage.class.getDeclaredField("pinnedUserID");
            pinnedUserIDField.setAccessible(true);
            pinnedUserIDField.set(message, messageMap.get("pinnedUserID"));
            pinnedUserIDField.setAccessible(false);

            Field pinnedTimeField = ZIMMessage.class.getDeclaredField("pinnedTime");
            pinnedTimeField.setAccessible(true);
            pinnedTimeField.set(message, messageMap.get("pinnedTime"));
            pinnedTimeField.setAccessible(false);
    ...
    static public HashMap<String, Object> mZIMMessageLiteInfo(ZIMMessageLiteInfo info) {
        ...
        case CUSTOM:
            ...
            infoMap.put("searchedContent", customLiteInfo.searchedContent);
            break;
        case COMBINE:
        ...
        case VIDEO:
            ...
            break;
        case MULTIPLE:
            ZIMMultipleMessageLiteInfo multipleMessageLiteInfo = (ZIMMultipleMessageLiteInfo)info;
            infoMap.put("messageInfoList",
                        mZIMMessageLiteInfoList(multipleMessageLiteInfo.messageInfoList));
            break;
        default:
            break;
        }
    ...
    static public ArrayList<HashMap<String, Object>>
    mZIMMessageLiteInfoList(ArrayList<ZIMMessageLiteInfo> infoList) {
        if (infoList == null) {
            return null;
        }

        ArrayList<HashMap<String, Object>> infoMapArray = new ArrayList<>();
        for (ZIMMessageLiteInfo info : infoList) {
            HashMap<String, Object> infoMap = mZIMMessageLiteInfo(info);
            if (infoMap != null) {
    ...
    static public ZIMMessageLiteInfo oZIMMessageLiteInfo(HashMap<String, Object> infoMap) {
        ...
        case CUSTOM:
            ...
            customLiteInfo.searchedContent = (String)infoMap.get("searchedContent");
            break;
        case COMBINE:
        ...
        case VIDEO:
            ...
            break;
        case MULTIPLE:
            info = new ZIMMultipleMessageLiteInfo();
            ZIMMultipleMessageLiteInfo multipleMessageLiteInfo = (ZIMMultipleMessageLiteInfo)info;
            ArrayList<ZIMMessageLiteInfo> messageInfoList = new ArrayList<>();
            for (HashMap<String, Object> map :
                 (ArrayList<HashMap<String, Object>>)infoMap.get("messageInfoList")) {
                messageInfoList.add(oZIMMessageLiteInfo(map));
            }
            multipleMessageLiteInfo.messageInfoList = messageInfoList;
            break;
        default:
    ...
    static public HashMap<String, Object>
    mZIMMessagePinStatusChangeInfo(ZIMMessagePinStatusChangeInfo info) {
        if (info == null) {
            return null;
        }

        HashMap<String, Object> infoMap = new HashMap<>();
        infoMap.put("message", mZIMMessage(info.getMessage()));
        infoMap.put("pinStatus", info.getPinStatus().value());

        return infoMap;
    }

    static public ArrayList<HashMap<String, Object>>
    mZIMMessagePinStatusChangeInfoList(ArrayList<ZIMMessagePinStatusChangeInfo> infoList) {
        if (infoList == null) {
            return null;
        }

        ArrayList<HashMap<String, Object>> infoMapArray = new ArrayList<>();
        for (ZIMMessagePinStatusChangeInfo info : infoList) {
            HashMap<String, Object> infoMap = mZIMMessagePinStatusChangeInfo(info);
            if (infoMap != null) {
                infoMapArray.add(infoMap);
            }
        }
    ...
    static public HashMap<String, Object> mZIMMessageReceiptInfo(ZIMMessageReceiptInfo info) {
        ...
        infoModel.put("readTime", info.readTime);
        return infoModel;
    }
    ...
    static public ZIMMediaDownloadConfig
    oZIMMediaDownloadConfig(HashMap<String, Object> configMap) {
        if (configMap == null) {
            return null;
        }
        ...
        config.messageInfoIndex =
            ZIMPluginCommonTools.safeGetIntValue(configMap.get("messageInfoIndex"));
    ...
    oZIMConversationMessageGlobalSearchConfig(HashMap<String, Object> configMap) {
        ...
        config.mode = ZIMConversationSearchMode.getZIMConversationSearchMode(
    ...
    mZIMConversationSearchInfoList(ArrayList<ZIMConversationSearchInfo> globalInfoList) {
        ...
        for (ZIMConversationSearchInfo info : globalInfoList) {
            ...
            map.put("conversation", mZIMConversation(info.conversation));
    ...
    static public HashMap<String, Object> mZIMUserInfo(ZIMUserInfo userInfo) {
        ...
        userInfoMap.put("userExtendedData", userInfo.userExtendedData);
    ...
    static public HashMap<String, Object> mZIMSelfUserInfo(ZIMSelfUserInfo selfUserInfo) {
        ...
        selfInfoMap.put("userStatus", ZIMPluginConverter.mZIMUserStatus(selfUserInfo.userStatus));
        return selfInfoMap;
    }
    ...
    static public ZIMUserInfo oZIMUserInfo(HashMap<String, Object> map, ZIMUserInfo userInfo) {
        ...
        userInfo.userExtendedData = (String)map.get("userExtendedData");
        if (userInfo instanceof ZIMGroupMemberSimpleInfo) {
            ((ZIMGroupMemberSimpleInfo)userInfo).memberNickname = (String)map.get("memberNickname");
            ((ZIMGroupMemberSimpleInfo)userInfo).memberRole =
                ZIMPluginCommonTools.safeGetIntValue(map.get("memberRole"));
        } else if (userInfo instanceof ZIMGroupMemberInfo) {
            ((ZIMGroupMemberInfo)userInfo).memberNickname = (String)map.get("memberNickname");
            ((ZIMGroupMemberInfo)userInfo).memberRole =
                ZIMPluginCommonTools.safeGetIntValue(map.get("memberRole"));
            ((ZIMGroupMemberInfo)userInfo).memberAvatarUrl = (String)map.get("memberAvatarUrl");
            ((ZIMGroupMemberInfo)userInfo).muteExpiredTime =
                ZIMPluginCommonTools.safeGetLongValue(map.get("muteExpiredTime"));
        } else if (userInfo instanceof ZIMFriendInfo) {
            ((ZIMFriendInfo)userInfo).friendAlias = (String)map.get("friendAlias");
            ((ZIMFriendInfo)userInfo).createTime =
                ZIMPluginCommonTools.safeGetLongValue(map.get("createTime"));
    ...
    oZIMConversationFilterOption(HashMap<String, Object> resultMap) {
        ...
        Object pinnedFilterObj = resultMap.get("pinnedFilter");
        if (pinnedFilterObj instanceof Integer) {
            option.pinnedFilter = ZIMConversationPinnedFilter.getZIMConversationPinnedFilter(
                ((Integer)pinnedFilterObj).intValue());
        }
        return option;
    }
    ...
    static public ZIMConversation oZIMConversation(HashMap<String, Object> resultMap) {
        ...
        if (type == ZIMConversationType.GROUP) {
            ...
            if (resultMap.containsKey("mutedExpiredTime") &&
                ...
                ((ZIMGroupConversation)conversation).mutedExpiredTime =
                    ZIMPluginCommonTools.safeGetLongValue(resultMap.get("mutedExpiredTime"));
            } else {
        ...
        conversation.pinnedTime =
            ZIMPluginCommonTools.safeGetLongValue(resultMap.get("pinnedTime"));
        conversation.draft = (String)resultMap.get("draft");
        conversation.readMessageSeq = ZIMPluginCommonTools.safeGetLongValue(resultMap.get("readMessageSeq"));
        return conversation;
    }
    ...
    static public ZIMPushConfig oZIMPushConfig(HashMap<String, Object> configMap) {
        ...
        config.threadID = (String)configMap.get("threadID");
        config.enableBadge = (Boolean)configMap.get("enableBadge");
        config.badgeIncrement =
            ZIMPluginCommonTools.safeGetIntValue(configMap.get("badgeIncrement"));
        config.voIPConfig =
            ZIMPluginConverter.oZIMVoIPconfig((HashMap<String, Object>)configMap.get("voIPConfig"));
        config.privateMessageTemplate = ZIMPluginConverter.oZIMOfflinePushPrivateMessageTemplate(
            (HashMap<String, Object>)configMap.get("privateMessageTemplate"));
        return config;
    }
    ...
    static public ZIMMessageSendConfig oZIMMessageSendConfig(HashMap<String, Object> configMap) {
        ...
        config.isRetrySend = (boolean)configMap.get("isRetrySend");
        config.disableUnreadMessageCount = (boolean)configMap.get("disableUnreadMessageCount");
        config.isAllowMultipleMessagePartialFailed =
            (boolean)configMap.get("isAllowMultipleMessagePartialFailed");
        return config;
    }
    ...
    static public ZIMMessageQueryConfig oZIMMessageQueryConfig(HashMap<String, Object> configMap) {
        ...
        config.mode = ZIMMessageQueryMode.getZIMMessageQueryMode(ZIMPluginCommonTools.safeGetIntValue(configMap.get("mode")));
        return config;
    }
    ...
    static public ZIMGroupMuteInfo oZIMGroupMuteInfo(HashMap<String, Object> infoMap) {
        ...
        muteInfo.expiredTime = ZIMPluginCommonTools.safeGetLongValue(infoMap.get("expiredTime"));
    ...
    static public HashMap<String, Object> mZIMGroupMemberInfo(ZIMGroupMemberInfo groupMemberInfo) {
        ...
        groupMemberInfoMap.put("userAvatarUrl", groupMemberInfo.userAvatarUrl != null
                                                    ? groupMemberInfo.userAvatarUrl
                                                    : "");
        groupMemberInfoMap.put("userExtendedData", groupMemberInfo.userExtendedData != null
                                                       ? groupMemberInfo.userExtendedData
                                                       : "");
    ...
    oZIMGroupAdvancedConfig(HashMap<String, Object> configMap) {
        ...
        config.inviteMode = ZIMGroupInviteMode.getZIMGroupInviteMode(
            ZIMPluginCommonTools.safeGetIntValue(configMap.get("inviteMode")));
        config.joinMode = ZIMGroupJoinMode.getZIMGroupJoinMode(
            ZIMPluginCommonTools.safeGetIntValue(configMap.get("joinMode")));
        config.beInviteMode = ZIMGroupBeInviteMode.getZIMGroupBeInviteMode(
            ZIMPluginCommonTools.safeGetIntValue(configMap.get("beInviteMode")));
        config.maxMemberCount =
            ZIMPluginCommonTools.safeGetIntValue(configMap.get("maxMemberCount"));
    ...
    static public ZIMGroupMuteConfig oZIMGroupMuteConfig(HashMap<String, Object> configMap) {
        ...
        config.mode = ZIMGroupMuteMode.getZIMGroupMuteMode(
            ZIMPluginCommonTools.safeGetIntValue(configMap.get("mode")));
        config.duration = ZIMPluginCommonTools.safeGetIntValue(configMap.get("duration"));
    ...
    static public HashMap<String, Object> mZIMCallInfo(ZIMCallInfo callInfo) {
        ...
        callInfoMap.put("inviter", callInfo.inviter);
    ...
    mZIMCallInvitationSentInfo(ZIMCallInvitationSentInfo info) {
        ...
        infoMap.put("errorUserList", mZIMErrorUserInfoList(info.errorUserList));
    ...
    public static HashMap<String, Object> mZIMMessageReaction(ZIMMessageReaction reaction) {
        ...
        infoMap.put("sumCount", reaction.sumCount);
    ...
    public static ArrayList<HashMap<String, Object>> mZIMMessageReactionUserInfoListByFullInfoList(
        ArrayList<ZIMMessageReactionUserFullInfo> userInfos) {
        ArrayList<HashMap<String, Object>> userInfoMaps = new ArrayList<>();
        for (ZIMMessageReactionUserFullInfo userInfo : userInfos) {
            HashMap<String, Object> userInfoMap = new HashMap<>();
            userInfoMap.put("userID", userInfo.getUserID());
            userInfoMaps.add(userInfoMap);
        }
        return userInfoMaps;
    }
    ...
    public static HashMap<String, Object>
    mZIMMessageReactionSimpleInfo(ZIMMessageReactionSimpleInfo info) {
        HashMap<String, Object> infoMap = new HashMap<>();
        infoMap.put("reactionType", info.getReactionType());
        infoMap.put("sumCount", info.getSumCount());

        return infoMap;
    }

    public static ArrayList<HashMap<String, Object>>
    mZIMMessageReactionSimpleInfoList(ArrayList<ZIMMessageReactionSimpleInfo> infoList) {
        ArrayList<HashMap<String, Object>> infoMapList = new ArrayList<>();
        for (ZIMMessageReactionSimpleInfo simpleInfo : infoList) {
            infoMapList.add(mZIMMessageReactionSimpleInfo(simpleInfo));
        }
    ...
    public static HashMap<String, Object>
    mZIMMessageReactionUserFullInfo(ZIMMessageReactionUserFullInfo userInfo) {
        HashMap<String, Object> userInfoMap = new HashMap<>();
        userInfoMap.put("userID", userInfo.getUserID());
        userInfoMap.put("reactions", ZIMPluginConverter.mZIMMessageReactionSimpleInfoList(
                                         userInfo.getReactions()));

        return userInfoMap;
    }

    public static ArrayList<HashMap<String, Object>>
    mZIMMessageReactionUserFullInfoList(ArrayList<ZIMMessageReactionUserFullInfo> infoList) {
        ArrayList<HashMap<String, Object>> infoMapList = new ArrayList<>();
        for (ZIMMessageReactionUserFullInfo userFullInfo : infoList) {
            infoMapList.add(mZIMMessageReactionUserFullInfo(userFullInfo));
        }
    ...
    public static ZIMMessageReactionAddConfig
    oZIMMessageReactionAddConfig(HashMap<String, Object> configMap) {
        ZIMMessageReactionAddConfig config = new ZIMMessageReactionAddConfig();
        config.setIncreaseCount(
            ZIMPluginCommonTools.safeGetIntValue(configMap.get("increaseCount")));
    ...
    public static HashMap<String, Object>
    mZIMMessageReactionUserChangeInfo(ZIMMessageReactionUserChangeInfo info) {
        HashMap<String, Object> infoMap = new HashMap<>();

        infoMap.put("userID", info.getUserID());
        infoMap.put("reactionType", info.getReactionType());
        infoMap.put("action", info.getAction().value());
        infoMap.put("sumCount", info.getSumCount());
    ...
    public static ArrayList<HashMap<String, Object>>
    mZIMMessageReactionUserChangeInfoList(ArrayList<ZIMMessageReactionUserChangeInfo> infoList) {
        ArrayList<HashMap<String, Object>> infoMapList = new ArrayList<>();
        for (ZIMMessageReactionUserChangeInfo changeInfo : infoList) {
            infoMapList.add(mZIMMessageReactionUserChangeInfo(changeInfo));
        }
    ...
    public static HashMap<String, Object>
    mZIMMessageReactionChangeInfo(ZIMMessageReactionChangeInfo info) {
        HashMap<String, Object> infoMap = new HashMap<>();

        infoMap.put("message", ZIMPluginConverter.mZIMMessage(info.getMessage()));
        infoMap.put("userChangeInfoList", ZIMPluginConverter.mZIMMessageReactionUserChangeInfoList(
                                              info.getUserChangeInfoList()));

        return infoMap;
    }

    public static ArrayList<HashMap<String, Object>>
    mZIMMessageReactionChangeInfoList(ArrayList<ZIMMessageReactionChangeInfo> infoList) {
        ArrayList<HashMap<String, Object>> infoMapList = new ArrayList<>();
        for (ZIMMessageReactionChangeInfo changeInfo : infoList) {
            infoMapList.add(mZIMMessageReactionChangeInfo(changeInfo));
        }
    ...
    public static ZIMOfflinePushPrivateMessageTemplate
    oZIMOfflinePushPrivateMessageTemplate(HashMap<String, Object> configMap) {
        if (configMap == null) {
            return null;
        }
        ZIMOfflinePushPrivateMessageTemplate template = new ZIMOfflinePushPrivateMessageTemplate();
        template.templateID = (String)configMap.get("templateID");
        template.titleParameters = (String)configMap.get("titleParameters");
        template.contentParameters = (String)configMap.get("contentParameters");
        return template;
    }
    ...
    oZIMFriendApplicationInfo(HashMap<String, Object> infoMap) {
        ...
        info.createTime = ZIMPluginCommonTools.safeGetLongValue(infoMap.get("createTime"));
        info.updateTime = ZIMPluginCommonTools.safeGetLongValue(infoMap.get("updateTime"));
    ...
    public static HashMap<String, Object> mZIMTipsMessageChangeInfo(ZIMTipsMessageChangeInfo info) {
        ...
        if (info instanceof ZIMTipsMessageGroupChangeInfo) {
            ...
            infoMap.put("memberRole", ((ZIMTipsMessageGroupMemberChangeInfo)info).memberRole);
            infoMap.put("muteExpiredTime",
                        ((ZIMTipsMessageGroupMemberChangeInfo)info).muteExpiredTime);
            if (((ZIMTipsMessageGroupMemberChangeInfo)info).groupNewOwner != null) {
                infoMap.put(
                    "groupNewOwner",
                    mZIMUserInfo(((ZIMTipsMessageGroupMemberChangeInfo)info).groupNewOwner));
            }
            infoMap.put("classType", "ZIMTipsMessageGroupMemberChangeInfo");
        } else if (info instanceof ZIMTipsMessagePinStatusChangeInfo) {
            infoMap.put("isPinned", ((ZIMTipsMessagePinStatusChangeInfo)info).isPinned);
            infoMap.put("classType", "ZIMTipsMessagePinStatusChangeInfo");
        }
        return infoMap;
    }
    ...
    oZIMUserStatusSubscribeConfig(HashMap<String, Object> map) {
        ...
        config.subscriptionDuration =
            ZIMPluginCommonTools.safeGetIntValue(map.get("subscriptionDuration"));
        return config;
    }
    ...
    public static ZIMUserStatus oZIMUserStatus(HashMap<String, Object> map) {
        ...
        userStatus.customStatus = (String)map.get("customStatus");
        userStatus.customStatusExpiredTime = ZIMPluginCommonTools.safeGetLongValue(map.get("customStatusExpiredTime"));
        ...
        userStatus.lastUpdateTime =
            ZIMPluginCommonTools.safeGetLongValue(map.get("lastUpdateTime"));
        userStatus.lastOnlineStatusUpdateTime =
            ZIMPluginCommonTools.safeGetLongValue(map.get("lastOnlineStatusUpdateTime"));
        userStatus.lastCustomStatusUpdateTime =
            ZIMPluginCommonTools.safeGetLongValue(map.get("lastCustomStatusUpdateTime"));
        return userStatus;
    }
    ...
    public static HashMap<String, Object> mZIMUserStatus(ZIMUserStatus userStatus) {
        ...
        map.put("customStatus", userStatus.customStatus);
        map.put("customStatusExpiredTime", userStatus.customStatusExpiredTime);
        map.put("lastUpdateTime", userStatus.lastUpdateTime);
        map.put("lastOnlineStatusUpdateTime", userStatus.lastOnlineStatusUpdateTime);
        map.put("lastCustomStatusUpdateTime", userStatus.lastCustomStatusUpdateTime);
    ...
    public static HashMap<String, Object>
    mZIMMessageReactionsChangedEventResult(ZIMMessageReactionsChangedEventResult result) {
        if (result == null) {
            return null;
        }

        HashMap<String, Object> resultMap = new HashMap<>();
        resultMap.put("reactions", mZIMMessageReactionList(result.getReactions()));
        resultMap.put("changeInfoList",
                      mZIMMessageReactionChangeInfoList(result.getChangeInfoList()));
