...
public class ZIMPluginEventHandler extends ZIMEventHandler {
    ...
    @Override
    public void onExperimentalEventReceived(ZIM zim, String content) {
        if (mysink == null) {
            return;
        }
        ...
        HashMap<String, Object> resultMap = new HashMap<>();
        resultMap.put("method", "onExperimentalEventReceived");
        resultMap.put("handle", handle);
    ...
    public void onConversationSyncStateChanged(ZIM zim, ZIMConversationSyncState state) {
        ...
        HashMap<String, Object> resultMap = new HashMap<>();
        resultMap.put("method", "onConversationSyncStateChanged");
        resultMap.put("handle", handle);
        resultMap.put("state", state.value());
        mysink.success(resultMap);
    }
    ...
    public void onMessageEdited(ZIM zim, ArrayList<ZIMMessage> messageList) {
        ...
        HashMap<String, Object> resultMap = new HashMap<>();
        resultMap.put("messageList", ZIMPluginConverter.mZIMMessageList(messageList));
        resultMap.put("method", "onMessageEdited");
        resultMap.put("handle", handle);
        mysink.success(resultMap);
    }

    @Override
    public void onMessagePinStatusChanged(ZIM zim,
                                          ArrayList<ZIMMessagePinStatusChangeInfo> changeInfoList) {
        if (mysink == null) {
            return;
        }
        String handle = engineMapForCallback.get(zim);
        ...
        resultMap.put("changeInfoList",
                      ZIMPluginConverter.mZIMMessagePinStatusChangeInfoList(changeInfoList));
        resultMap.put("method", "onMessagePinStatusChanged");
        resultMap.put("handle", handle);
        mysink.success(resultMap);
    }
    ...
    public void onMessageReactionsChanged(ZIM zim, ZIMMessageReactionsChangedEventResult result) {
        super.onMessageReactionsChanged(zim, result);
        if (mysink == null) {
            return;
        }
        String handle = engineMapForCallback.get(zim);
        HashMap<String, Object> resultMap = new HashMap<>();
        resultMap.put("result", ZIMPluginConverter.mZIMMessageReactionsChangedEventResult(result));
