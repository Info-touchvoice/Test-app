...
class ZIMPluginEventHandler : public ZIMEventHandler {
  ...
  protected:
    ...
    void onExperimentalEventReceived(ZIM *zim, const std::string &content);
    ...
    void onMessageReactionsChanged(ZIM *zim, const ZIMMessageReactionsChangedEventResult &result);
    ...
    void onMessageEdited(ZIM *zim,
                         const std::vector<std::shared_ptr<ZIMMessage>> &messageList) override;
