...
struct ZIM_FriendlyGet_isGroupTargetedMessage {
    typedef bool ZIMMessage::*type;
};
...
struct ZIM_FriendlyGet_editorUserID {
    typedef std::string ZIMMessage::*type;
};

struct ZIM_FriendlyGet_editedTime {
    typedef long long ZIMMessage::*type;
};

struct ZIM_FriendlyGet_pinnedUserID {
    typedef std::string ZIMMessage::*type;
};

struct ZIM_FriendlyGet_pinnedTime {
    typedef long long ZIMMessage::*type;
};
...
class ZIMPluginConverter {
  ...
  public:
    ...
    static FTArray cnvZIMMessageLiteInfoListToArray(
    ...
    static FTArray cnvZIMMessagePinStatusChangeInfoListToArray(
    ...
    static FTMap mZIMMessageReactionSimpleInfo(const ZIMMessageReactionSimpleInfo &info);
    static FTArray
    mZIMMessageReactionSimpleInfoList(const std::vector<ZIMMessageReactionSimpleInfo> &infoList);
    static FTArray cnvZIMMessageReactionUserInfoListToArrayByUserFullInfoList(
        const std::vector<ZIMMessageReactionUserFullInfo> &reactionUserInfoList);
    static FTMap mZIMMessageReactionUserFullInfo(const ZIMMessageReactionUserFullInfo &info);
    static FTArray mZIMMessageReactionUserFullInfoList(
        const std::vector<ZIMMessageReactionUserFullInfo> &reactionUserInfoList);
    static FTMap mZIMMessageReactionUserChangeInfo(const ZIMMessageReactionUserChangeInfo &info);
    static FTArray mZIMMessageReactionUserChangeInfoList(
        const std::vector<ZIMMessageReactionUserChangeInfo> &infoList);
    static FTMap mZIMMessageReactionChangeInfo(const ZIMMessageReactionChangeInfo &info);
    static FTArray
    mZIMMessageReactionChangeInfoList(const std::vector<ZIMMessageReactionChangeInfo> &infoList);
  ...
  public:
    ...
    static ZIMMediaDownloadConfig oZIMMediaDownloadConfig(FTMap configMap);
    ...
    static ZIMMessageReactionAddConfig mZIMMessageReactionAddConfig(FTMap configMap);
    static std::shared_ptr<ZIMOfflinePushPrivateMessageTemplate>
    cnvZIMOfflinePushPrivateMessageTemplateToObject(FTMap configMap);
    ...
    static ZIMUserCustomStatusUpdateConfig oZIMUserCustomStatusUpdateConfig(FTMap configMap);
  ...
  public:
    ...
    static ZIMMessageEditConfig oZIMMessageEditConfig(FTMap ftmap);
    static ZIMSendingMessageCancelConfig oZIMSendingMessageCancelConfig(FTMap ftmap);

    static FTMap
    mZIMMessageReactionsChangedEventResult(const ZIMMessageReactionsChangedEventResult &result);
};
