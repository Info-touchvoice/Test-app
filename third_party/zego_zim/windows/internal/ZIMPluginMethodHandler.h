...
class ZIMPluginMethodHandler {
  ...
  public:
    ...
    void callExperimentalAPI(FArgument &argument, FResult result);
    ...
    void updateUserCustomStatus(FArgument &argument, FResult result);
    void updateUserBadge(FArgument &argument, FResult result);
    ...
    void editMessage(FArgument &argument, FResult result);
    void cancelSendingMessage(FArgument &argument, FResult result);
    ...
    void pinMessage(FArgument &argument, FResult result);
    void queryPinnedMessageList(FArgument &argument, FResult result);
    ...
    void deleteMessageAllReactions(FArgument &argument, FResult result);
