...
void ZegoZimPlugin::HandleMethodCall(
    ...
    if (method_call.method_name().compare("getVersion") == 0) {
        ...
        return;
    } else if (method_call.method_name() == "setAdvancedConfig") {
        ZIMPluginMethodHandler::getInstance().setAdvancedConfig(argument, std::move(result));
        return;
        ...
        return;
    } else if (method_call.method_name() == "callExperimentalAPI") {
        ZIMPluginMethodHandler::getInstance().callExperimentalAPI(argument, std::move(result));
        return;
    ...
    if (method_call.method_name() == "queryConversationList") {
        ...
        return;
    } else if (method_call.method_name() == "queryConversationTotalUnreadMessageCount") {
        ...
        return;
    } else if (method_call.method_name() == "editMessage") {
        ZIMPluginMethodHandler::getInstance().editMessage(argument, std::move(result));
        return;
    } else if (method_call.method_name() == "cancelSendingMessage") {
        ZIMPluginMethodHandler::getInstance().cancelSendingMessage(argument, std::move(result));
        return;
    } else if (method_call.method_name() == "pinMessage") {
        ZIMPluginMethodHandler::getInstance().pinMessage(argument, std::move(result));
        return;
    } else if (method_call.method_name() == "queryPinnedMessageList") {
        ZIMPluginMethodHandler::getInstance().queryPinnedMessageList(argument, std::move(result));
        return;
    }
    ...
    if (method_call.method_name() == "callInvite") {
        ...
        return;
    } else if (method_call.method_name() == "queryCallInvitationList") {
        ...
        return;
    } else if (method_call.method_name() == "deleteMessageAllReactions") {
        ZIMPluginMethodHandler::getInstance().deleteMessageAllReactions(argument,
                                                                        std::move(result));
        return;
        ...
        ZIMPluginMethodHandler::getInstance().importLocalMessages(argument, std::move(result));
        return;
    } else if (method_call.method_name() == "exportLocalMessages") {
        ZIMPluginMethodHandler::getInstance().exportLocalMessages(argument, std::move(result));
        return;
    ...
    if (method_call.method_name() == "rejectGroupJoinApplication") {
        ...
        ZIMPluginMethodHandler::getInstance().querySubscribedUserStatusList(argument,
                                                                            std::move(result));
    } else if (method_call.method_name() == "updateUserCustomStatus") {
        ZIMPluginMethodHandler::getInstance().updateUserCustomStatus(argument, std::move(result));
    } else if (method_call.method_name() == "updateUserBadge") {
        ZIMPluginMethodHandler::getInstance().updateUserBadge(argument, std::move(result));
    } else {
