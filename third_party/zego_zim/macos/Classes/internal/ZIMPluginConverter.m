...
+ (nullable ZIMLoginConfig *)oZIMLoginConfig:(nullable NSDictionary *)configDic {
    ...
    config.customStatus = [configDic objectForKey:@"customStatus"];
    config.customStatusDuration = [[configDic objectForKey:@"customStatusDuration"] longLongValue];
    return config;
}
...
+ (nullable ZIMUserCustomStatusUpdateConfig *)oZIMUserCustomStatusUpdateConfig:(nullable NSDictionary *)configDic {
    if (configDic == nil || configDic == NULL || [configDic isEqual:[NSNull null]]) {
        return nil;
    }
    ZIMUserCustomStatusUpdateConfig *config = [[ZIMUserCustomStatusUpdateConfig alloc] init];
    config.duration = [[configDic safeObjectForKey:@"duration"] longLongValue];
    return config;
}
...
+ (nullable NSDictionary *)mZIMUserInfo:(nullable ZIMUserInfo *)userInfo {
    ...
    if (userInfo.userExtendedData != nil) {
        [userInfoDic safeSetObject:userInfo.userExtendedData forKey:@"userExtendedData"];
    } else {
        [userInfoDic safeSetObject:@"" forKey:@"userExtendedData"];
    }
...
+ (nullable NSDictionary *)mZIMGroupMemberSimpleInfo:
    ...
    [groupMemberSimpleInfoDic safeSetObject:groupMemberSimpleInfo.userExtendedData
                                     forKey:@"userExtendedData"];
...
+ (nullable NSDictionary *)mZIMSelfUserInfo:(nullable ZIMSelfUserInfo *)selfUserInfo {
    ...
    [dic setObject:[ZIMPluginConverter mZIMUserFullInfo:selfUserInfo.userFullInfo]
            forKey:@"userFullInfo"];
    [dic setObject:[ZIMPluginConverter mZIMUserStatus:selfUserInfo.userStatus]
            forKey:@"userStatus"];
    return dic;
}
...
+ (nullable ZIMConversation *)oZIMConversation:(nullable NSDictionary *)conversationDic {
    ...
    conversation.pinnedTime = [[conversationDic objectForKey:@"pinnedTime"] longLongValue];
    conversation.draft = (NSString *)[conversationDic objectForKey:@"draft"];
    conversation.marks = [conversationDic objectForKey:@"marks"];
    conversation.readMessageSeq = ((NSNumber *)[conversationDic objectForKey:@"readMessageSeq"]).longLongValue;
    return conversation;
}
...
+ (nullable NSDictionary *)mZIMConversation:(nullable ZIMConversation *)conversation {
    ...
    [conversationDic safeSetObject:[NSNumber numberWithLongLong:conversation.readMessageSeq]
                            forKey:@"readMessageSeq"];
...
+ (nullable ZIMMessage *)oZIMMessage:(nullable NSDictionary *)messageDic {
    ...
    case ZIMMessageTypeMultiple: {
        ...
        NSArray *messageInfoList = [ZIMPluginConverter
            oZIMMessageLiteInfoList:[messageDic safeObjectForKey:@"messageInfoList"]];
        NSArray *failedIndexList = [messageDic objectForKey:@"failedIndexList"];
        ((ZIMMultipleMessage *)msg).messageInfoList = messageInfoList;
        ((ZIMMultipleMessage *)msg).failedIndexList = failedIndexList;
        break;
    }
    ...
    [msg safeSetValue:[ZIMPluginConverter
               ...
               forKey:@"repliedInfo"];
    [msg safeSetValue:(NSString *)[messageDic safeObjectForKey:@"editorUserID"]
               forKey:@"editorUserID"];
    [msg safeSetValue:(NSNumber *)[messageDic safeObjectForKey:@"editedTime"] forKey:@"editedTime"];

    [msg safeSetValue:(NSNumber *)[messageDic safeObjectForKey:@"isGroupTargetedMessage"]
               forKey:@"isGroupTargetedMessage"];
    [msg safeSetValue:(NSString *)[messageDic safeObjectForKey:@"pinnedUserID"]
               forKey:@"pinnedUserID"];
    [msg safeSetValue:(NSNumber *)[messageDic safeObjectForKey:@"pinnedTime"] forKey:@"pinnedTime"];
...
+ (nullable NSDictionary *)mZIMMessage:(nullable ZIMMessage *)message {
    ...
    [messageDic safeSetObject:[NSNumber numberWithLongLong:message.editedTime]
                       forKey:@"editedTime"];
    ...
    [messageDic safeSetObject:[NSNumber numberWithLongLong:message.pinnedTime]
                       forKey:@"pinnedTime"];
    ...
    case ZIMMessageTypeMultiple: {
        ...
        [messageDic safeSetObject:[ZIMPluginConverter
                                      mZIMMessageLiteInfoList:multipleMessage.messageInfoList]
                           forKey:@"messageInfoList"];
        [messageDic safeSetObject:multipleMessage.failedIndexList forKey:@"failedIndexList"];
        break;
    }
    case ZIMMessageTypeTips: {
...
+ (nullable NSDictionary *)mZIMMessageReceiptInfo:(nullable ZIMMessageReceiptInfo *)info {
    ...
    [infoModel safeSetObject:[NSNumber numberWithUnsignedLongLong:info.readTime]
                      forKey:@"readTime"];
    return infoModel;
}
...
+ (nullable ZIMConversationSearchConfig *)oZIMConversationMessageGlobalSearchConfig:
    ...
    config.mode = [[configDic safeObjectForKey:@"mode"] unsignedIntegerValue];
...
+ (nullable NSDictionary *)mZIMConversationMessageSearchInfo:
    ...
    [configDic safeSetObject:[ZIMPluginConverter mZIMConversation:info.conversation]
                      forKey:@"conversation"];
...
+ (nullable ZIMMessageSendConfig *)oZIMMessageSendConfig:(nullable NSDictionary *)configDic {
    ...
    sendConfig.isRetrySend = [[configDic safeObjectForKey:@"isRetrySend"] boolValue];
    sendConfig.disableUnreadMessageCount =
        [[configDic objectForKey:@"disableUnreadMessageCount"] boolValue];
    sendConfig.isAllowMultipleMessagePartialFailed =
        [[configDic objectForKey:@"isAllowMultipleMessagePartialFailed"] boolValue];
    return sendConfig;
}
...
+ (nullable ZIMPushConfig *)oZIMPushConfig:(nullable NSDictionary *)configDic {
    ...
    pushConfig.threadID = (NSString *)[configDic objectForKey:@"threadID"];
    ...
    pushConfig.privateMessageTemplate = [ZIMPluginConverter
        oZIMOfflinePushPrivateMessageTemplate:[configDic objectForKey:@"privateMessageTemplate"]];
    return pushConfig;
}
...
+ (nullable ZIMMessageQueryConfig *)oZIMMessageQueryConfig:(nullable NSDictionary *)configDic {
    ...
    config.mode = (ZIMMessageQueryMode)(((NSNumber *)[configDic objectForKey:@"mode"]).integerValue);
    return config;
}
...
+ (nullable ZIMMessageLiteInfo *)oZIMMessageLiteInfo:(nullable NSDictionary *)infoDic {
    ...
    if (type == ZIMMessageTypeText) {
        ...
        customLiteInfo.searchedContent = [infoDic safeObjectForKey:@"searchedContent"];
    ...
    } else if (type == ZIMMessageTypeMultiple) {
        info = [[ZIMMultipleMessageLiteInfo alloc] init];
        ZIMMultipleMessageLiteInfo *multipleLiteInfo = (ZIMMultipleMessageLiteInfo *)info;
        multipleLiteInfo.messageInfoList = [ZIMPluginConverter
            oZIMMessageLiteInfoList:[infoDic safeObjectForKey:@"messageInfoList"]];
    } else {
        info = [[ZIMMessageLiteInfo alloc] init];
    }

    if ([info isKindOfClass:[ZIMMediaMessageLiteInfo class]]) {
...
+ (nullable NSArray<ZIMMessageLiteInfo *> *)oZIMMessageLiteInfoList:
    (nullable NSArray *)infoDicList {
    if (infoDicList == nil || infoDicList == NULL || [infoDicList isEqual:[NSNull null]]) {
        return nil;
    }

    NSMutableArray *messageInfoList = [[NSMutableArray alloc] init];
    for (NSDictionary *dic in infoDicList) {
        [messageInfoList addObject:[ZIMPluginConverter oZIMMessageLiteInfo:dic]];
    }
...
+ (nullable NSDictionary *)mZIMMessageLiteInfo:(nullable ZIMMessageLiteInfo *)info {
    ...
    if (info.type == ZIMMessageTypeText) {
        ...
        [infoDic safeSetObject:customLiteInfo.searchedContent forKey:@"searchedContent"];
        ...
        [infoDic safeSetObject:[NSNumber numberWithInt:videoLiteInfo.videoFirstFrameSize.height]
                        forKey:@"videoFirstFrameHeight"];
    } else if (info.type == ZIMMessageTypeMultiple) {
        ZIMMultipleMessageLiteInfo *multipleLiteInfo = (ZIMMultipleMessageLiteInfo *)info;
        [infoDic safeSetObject:[ZIMPluginConverter
                                   mZIMMessageLiteInfoList:multipleLiteInfo.messageInfoList]
                        forKey:@"messageInfoList"];
    }
...
+ (nullable NSArray *)mZIMMessageLiteInfoList:(nullable NSArray<ZIMMessageLiteInfo *> *)infoList {
    ...
    NSMutableArray *DicArr = [[NSMutableArray alloc] init];
    for (ZIMMessageLiteInfo *info in infoList) {
        [DicArr addObject:[ZIMPluginConverter mZIMMessageLiteInfo:info]];
    }
...
+ (nullable NSDictionary *)mZIMGroupMemberInfo:(nullable ZIMGroupMemberInfo *)memberInfo {
    ...
    [memberInfoDic safeSetObject:memberInfo.userAvatarUrl ? memberInfo.userAvatarUrl : @""
                          forKey:@"userAvatarUrl"];
    [memberInfoDic safeSetObject:memberInfo.userExtendedData ? memberInfo.userExtendedData : @""
                          forKey:@"userExtendedData"];
...
+ (nullable NSDictionary *)mZIMCallInfo:(ZIMCallInfo *)callInfo {
    ...
    [callInfoDic safeSetObject:callInfo.inviter forKey:@"inviter"];
...
+ (nullable NSDictionary *)mZIMMessageReaction:(nullable ZIMMessageReaction *)reaction {
    ...
    [infoDic safeSetObject:[ZIMPluginConverter mZIMMessageReactionUserInfoList:reaction.userList]
                    forKey:@"userList"];
    [infoDic safeSetObject:@(reaction.sumCount) forKey:@"sumCount"];
...
+ (nullable NSDictionary *)mZIMMessageReactionSimpleInfo:
    (nullable ZIMMessageReactionSimpleInfo *)userInfo {
    if (userInfo == nil || userInfo == NULL || [userInfo isEqual:[NSNull null]]) {
        return nil;
    }
    NSMutableDictionary *infoDic = [[NSMutableDictionary alloc] init];
    [infoDic safeSetObject:userInfo.reactionType forKey:@"reactionType"];
    [infoDic safeSetObject:@(userInfo.sumCount) forKey:@"sumCount"];
    return infoDic;
}

+ (nullable NSArray *)mZIMMessageReactionSimpleInfoList:
    (nullable NSArray<ZIMMessageReactionSimpleInfo *> *)reactions {
    if (reactions == nil || reactions == NULL || [reactions isEqual:[NSNull null]]) {
        return nil;
    }
    NSMutableArray *infoDic = [[NSMutableArray alloc] init];
    for (ZIMMessageReactionSimpleInfo *reaction in reactions) {
        NSDictionary *reactionInfoDic = [ZIMPluginConverter mZIMMessageReactionSimpleInfo:reaction];
...
+ (nullable NSDictionary *)mZIMMessageReactionUserFullInfo:
    (nullable ZIMMessageReactionUserFullInfo *)userInfo {
    if (userInfo == nil || userInfo == NULL || [userInfo isEqual:[NSNull null]]) {
        return nil;
    }
    NSMutableDictionary *infoDic = [[NSMutableDictionary alloc] init];
    [infoDic safeSetObject:userInfo.userID forKey:@"userID"];
    [infoDic safeSetObject:[ZIMPluginConverter mZIMMessageReactionSimpleInfoList:userInfo.reactions]
                    forKey:@"reactions"];
    return infoDic;
}

+ (nullable NSArray *)mZIMMessageReactionUserFullInfoList:
    (nullable NSArray<ZIMMessageReactionUserFullInfo *> *)userInfoList {
    if (userInfoList == nil || userInfoList == NULL || [userInfoList isEqual:[NSNull null]]) {
        return nil;
    }
    NSMutableArray *infoDic = [[NSMutableArray alloc] init];
    for (ZIMMessageReactionUserFullInfo *userInfo in userInfoList) {
        NSDictionary *userInfoDic = [ZIMPluginConverter mZIMMessageReactionUserFullInfo:userInfo];
        [infoDic safeAddObject:userInfoDic];
    }
    return infoDic;
}

// 用于兼容返回旧的 userInfoList
+ (nullable NSArray *)mZIMMessageReactionUserInfoListByFullInfoList:
    (nullable NSArray<ZIMMessageReactionUserFullInfo *> *)userInfoList {
    if (userInfoList == nil || userInfoList == NULL || [userInfoList isEqual:[NSNull null]]) {
        return nil;
    }
    NSMutableArray *infoDicArray = [[NSMutableArray alloc] init];
    for (ZIMMessageReactionUserFullInfo *userInfo in userInfoList) {
        NSMutableDictionary *infoDic = [[NSMutableDictionary alloc] init];
        [infoDic safeSetObject:userInfo.userID forKey:@"userID"];
        [infoDicArray safeAddObject:infoDic];
    }
    return infoDicArray;
}

+ (nullable NSDictionary *)mZIMMessageReactionUserChangeInfo:
    (nullable ZIMMessageReactionUserChangeInfo *)info {
    if (info == nil || info == NULL || [info isEqual:[NSNull null]]) {
        return nil;
    }
    ...
    [infoDic safeSetObject:info.userID forKey:@"userID"];
    [infoDic safeSetObject:info.reactionType forKey:@"reactionType"];
    [infoDic safeSetObject:@(info.sumCount) forKey:@"sumCount"];
    [infoDic safeSetObject:@(info.action) forKey:@"action"];

    return infoDic;
}

+ (nullable NSArray *)mZIMMessageReactionUserChangeInfoList:
    (nullable NSArray<ZIMMessageReactionUserChangeInfo *> *)changeInfoList {
    if (changeInfoList == nil || changeInfoList == NULL || [changeInfoList isEqual:[NSNull null]]) {
        return nil;
    }
    NSMutableArray *infoDicArray = [[NSMutableArray alloc] init];
    for (ZIMMessageReactionUserChangeInfo *changeInfo in changeInfoList) {
        NSDictionary *infoDic = [ZIMPluginConverter mZIMMessageReactionUserChangeInfo:changeInfo];
        [infoDicArray safeAddObject:infoDic];
    }
...
+ (nullable NSDictionary *)mZIMMessageReactionChangeInfo:
    (nullable ZIMMessageReactionChangeInfo *)info {
    if (info == nil || info == NULL || [info isEqual:[NSNull null]]) {
        return nil;
    }
    ...
    [infoDic safeSetObject:[ZIMPluginConverter mZIMMessage:info.message] forKey:@"message"];
    [infoDic safeSetObject:[ZIMPluginConverter
                               mZIMMessageReactionUserChangeInfoList:info.userChangeInfoList]
                    forKey:@"userChangeInfoList"];

    return infoDic;
}

+ (nullable NSArray *)mZIMMessageReactionChangeInfoList:
    (nullable NSArray<ZIMMessageReactionChangeInfo *> *)changeInfoList {
    if (changeInfoList == nil || changeInfoList == NULL || [changeInfoList isEqual:[NSNull null]]) {
        return nil;
    }
    NSMutableArray *infoDicArray = [[NSMutableArray alloc] init];
    for (ZIMMessageReactionChangeInfo *changeInfo in changeInfoList) {
        NSDictionary *infoDic = [ZIMPluginConverter mZIMMessageReactionChangeInfo:changeInfo];
        [infoDicArray safeAddObject:infoDic];
    }
...
+ (nullable ZIMMessageReactionAddConfig *)oZIMMessageReactionAddConfig:
    (nullable NSDictionary *)configDic {
    if (configDic == nil || configDic == NULL || [configDic isEqual:[NSNull null]]) {
        return nil;
    }
    ZIMMessageReactionAddConfig *config = [[ZIMMessageReactionAddConfig alloc] init];
    config.increaseCount = ((NSNumber *)[configDic objectForKey:@"increaseCount"]).intValue;
    return config;
}
...
+ (nullable ZIMMediaDownloadConfig *)oZIMMediaDownloadConfig:(nullable NSDictionary *)configMap {
    ...
    config.messageInfoIndex = [[configMap safeObjectForKey:@"messageInfoIndex"] unsignedIntValue];
    return config;
}
...
+ (nullable ZIMUserInfo *)oZIMUserInfo:(nullable NSDictionary *)infoDic {
    ...
    info.userExtendedData = (NSString *)[infoDic objectForKey:@"userExtendedData"];
    return info;
}
...
+ (nullable NSDictionary *)mZIMFriendInfo:(nullable ZIMFriendInfo *)info {
    ...
    [infoDic safeSetObject:info.userExtendedData forKey:@"userExtendedData"];
...
+ (nullable NSDictionary *)mZIMTipsMessageChangeInfo:(nullable ZIMTipsMessageChangeInfo *)info {
    ...
    if ([info isKindOfClass:[ZIMTipsMessageGroupChangeInfo class]]) {
        ...
        [dic setObject:@(subInfo.memberRole) forKey:@"memberRole"];
        [dic setObject:@(subInfo.muteExpiredTime) forKey:@"muteExpiredTime"];
        if (subInfo.groupNewOwner != nil) {
            [dic setObject:[ZIMPluginConverter mZIMUserInfo:subInfo.groupNewOwner]
                    forKey:@"groupNewOwner"];
        }
        ...
        ZIMTipsMessagePinStatusChangeInfo *subInfo = (ZIMTipsMessagePinStatusChangeInfo *)info;
        [dic setObject:[NSNumber numberWithBool:subInfo.isPinned] forKey:@"isPinned"];
        [dic setObject:@"ZIMTipsMessagePinStatusChangeInfo" forKey:@"classType"];
    }
    return dic;
}
...
+ (nullable ZIMConversationFilterOption *)oZIMConversationFilterOption:
    ...
    option.pinnedFilter =
        (ZIMConversationPinnedFilter)[[optionMap objectForKey:@"pinnedFilter"] intValue];
    return option;
}
...
+ (nullable NSDictionary *)mZIMUserStatus:(nullable ZIMUserStatus *)status {
    ...
    [dic setObject:@(status.customStatusExpiredTime) forKey:@"customStatusExpiredTime"];
    return dic;
}
...
+ (nullable ZIMOfflinePushPrivateMessageTemplate *)oZIMOfflinePushPrivateMessageTemplate:
    (nullable NSDictionary *)configMap {
    if (configMap == nil || [configMap isEqual:[NSNull null]]) {
        return nil;
    }
    ZIMOfflinePushPrivateMessageTemplate *template =
        [[ZIMOfflinePushPrivateMessageTemplate alloc] init];
    template.templateID = [configMap objectForKey:@"templateID"];
    template.titleParameters = [configMap objectForKey:@"titleParameters"];
    template.contentParameters = [configMap objectForKey:@"contentParameters"];
    return template;
}

+ (nullable NSDictionary *)mZIMMessagePinStatusChangeInfo:
    (nullable ZIMMessagePinStatusChangeInfo *)info {
    if (info == nil || [info isEqual:[NSNull null]]) {
        return nil;
    }
    NSMutableDictionary *basicInfo = [[NSMutableDictionary alloc] init];
    [basicInfo setObject:@(info.pinStatus) forKey:@"pinStatus"];
    [basicInfo setObject:[ZIMPluginConverter mZIMMessage:info.message] forKey:@"message"];
    return basicInfo;
}

+ (nullable NSDictionary *)mZIMMessageReactionsChangedEventResult:
    (nullable ZIMMessageReactionsChangedEventResult *)result {
    if (result == nil || [result isEqual:[NSNull null]]) {
        return nil;
    }

    NSMutableDictionary *resultDic = [[NSMutableDictionary alloc] init];
    [resultDic safeSetObject:[ZIMPluginConverter mZIMMessageReactionList:result.reactions]
                      forKey:@"reactions"];
    [resultDic
        safeSetObject:[ZIMPluginConverter mZIMMessageReactionChangeInfoList:result.changeInfoList]
               forKey:@"changeInfoList"];
