...
- (void)zim:(ZIM *)zim experimentalEventReceived:(NSString *)content {
    ...
    NSDictionary *resultDic =
        @{@"method" : @"onExperimentalEventReceived", @"handle" : handle, @"content" : content};
    _events(resultDic);
}
...
- (void)zim:(ZIM *)zim conversationSyncStateChanged:(ZIMConversationSyncState)state {
    ...
    NSMutableDictionary *resultDic = [[NSMutableDictionary alloc] init];
    [resultDic safeSetObject:@"onConversationSyncStateChanged" forKey:@"method"];
    [resultDic safeSetObject:handle forKey:@"handle"];
    [resultDic safeSetObject:[NSNumber numberWithInt:(int)state] forKey:@"state"];
    _events(resultDic);
}
...
- (void)zim:(ZIM *)zim
    messagePinStatusChanged:(nonnull NSArray<ZIMMessagePinStatusChangeInfo *> *)changeInfoList {
    if (_events == nil) {
        return;
    }
    NSString *handle = [_engineEventMap objectForKey:zim];
    ...
    NSMutableDictionary *resultDic = [[NSMutableDictionary alloc] init];
    [resultDic safeSetObject:@"onMessagePinStatusChanged" forKey:@"method"];
    [resultDic safeSetObject:handle forKey:@"handle"];
    NSMutableArray *infosModel = [[NSMutableArray alloc] init];
    for (ZIMMessagePinStatusChangeInfo *info in changeInfoList) {
        [infosModel safeAddObject:[ZIMPluginConverter mZIMMessagePinStatusChangeInfo:info]];
    }
    [resultDic safeSetObject:infosModel forKey:@"changeInfoList"];
    _events(resultDic);
}
...
- (void)zim:(ZIM *)zim messageEdited:(nonnull NSArray<ZIMMessage *> *)messageList {
    if (_events == nil) {
        return;
    }
    NSString *handle = [_engineEventMap objectForKey:zim];
    ...
    NSMutableDictionary *resultDic = [[NSMutableDictionary alloc] init];
    [resultDic safeSetObject:@"onMessageEdited" forKey:@"method"];
    [resultDic safeSetObject:handle forKey:@"handle"];
    [resultDic safeSetObject:[ZIMPluginConverter mZIMMessageList:messageList]
                      forKey:@"messageList"];
    _events(resultDic);
...
- (void)zim:(ZIM *)zim
    messageReactionsChangedWithResult:(ZIMMessageReactionsChangedEventResult *)result {
    if (_events == nil) {
        return;
    }
    NSString *handle = [_engineEventMap objectForKey:zim];
    ...
    [resultDic safeSetObject:[ZIMPluginConverter mZIMMessageReactionsChangedEventResult:result]
                      forKey:@"result"];
    [resultDic safeSetObject:handle forKey:@"handle"];
    _events(resultDic);
}
