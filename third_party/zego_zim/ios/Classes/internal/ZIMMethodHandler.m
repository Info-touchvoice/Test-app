...
- (void)callExperimentalAPI:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    NSString *inputParams = [call.arguments objectForKey:@"params"];
    [zim callExperimentalAPI:inputParams
                    callback:^(NSString *_Nonnull cb_result, ZIMError *_Nonnull errorInfo) {
                      if (errorInfo.code == 0) {
                          result(cb_result);
                      } else {
                          result([FlutterError
...
- (void)updateUserBadge:(FlutterMethodCall *)call result:(FlutterResult)result {
    NSString *handle = [call.arguments objectForKey:@"handle"];
    ZIM *zim = self.engineMap[handle];
    if (!zim) {
        result([FlutterError errorWithCode:@"-1" message:@"no native instance" details:nil]);
...
- (void)updateUserCustomStatus:(FlutterMethodCall *)call result:(FlutterResult)result {
    NSString *handle = [call.arguments objectForKey:@"handle"];
    ZIM *zim = self.engineMap[handle];
    if (!zim) {
        result([FlutterError errorWithCode:@"-1" message:@"no native instance" details:nil]);
    ...
    NSString *customStatus = [call.arguments objectForKey:@"customStatus"];
    ZIMUserCustomStatusUpdateConfig *config = [ZIMPluginConverter oZIMUserCustomStatusUpdateConfig:[call.arguments objectForKey:@"config"]];
    [zim
        updateUserCustomStatus:customStatus
                        config:config
                      callback:^(NSString *customStatus, ZIMError *errorInfo) {
                        if (errorInfo.code == 0) {
                            NSMutableDictionary *resultDic = [[NSMutableDictionary alloc] init];
                            [resultDic safeSetObject:customStatus forKey:@"customStatus"];
                            result(resultDic);
                        } else {
                            result([FlutterError
                                errorWithCode:[NSString stringWithFormat:@"%d", (int)errorInfo.code]
...
- (void)queryConversationTotalUnreadMessageCount:(FlutterMethodCall *)call
...
- (void)sendMessage:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    NSNumber *mediaUploadingCallbackID =
        [call.arguments safeObjectForKey:@"mediaUploadingCallbackID"];
    NSNumber *multipleMediaUploadingCallbackID =
        [call.arguments safeObjectForKey:@"multipleMediaUploadingCallbackID"];
    ...
    sendNotification.onMediaUploadingProgress =
        ^(ZIMMediaMessage *_Nonnull message, unsigned long long currentFileSize,
          ...
          if (mediaUploadingCallbackID == nil) {
              return;
          }
          NSDictionary *messageDic = [ZIMPluginConverter mZIMMessage:message];
          ...
          [resultDic safeSetObject:mediaUploadingCallbackID forKey:@"mediaUploadingCallbackID"];
          [resultDic safeSetObject:messageID forKey:@"messageID"];
          [resultDic safeSetObject:messageDic forKey:@"message"];
    ...
    sendNotification.onMultipleMediaUploadingProgress =
        ^(ZIMMultipleMessage *_Nonnull message, unsigned long long currentFileSize,
          ...
          if (multipleMediaUploadingCallbackID == nil) {
              return;
          }
          NSDictionary *messageDic = [ZIMPluginConverter mZIMMessage:message];
          ...
          NSMutableDictionary *resultDic = [[NSMutableDictionary alloc] init];
          [resultDic safeSetObject:handle forKey:@"handle"];
          [resultDic safeSetObject:@"multipleUploadMediaProgress" forKey:@"method"];
          [resultDic safeSetObject:multipleMediaUploadingCallbackID
                            forKey:@"multipleMediaUploadingCallbackID"];
          [resultDic safeSetObject:messageID forKey:@"messageID"];
          [resultDic safeSetObject:messageDic forKey:@"message"];
          [resultDic safeSetObject:[NSNumber numberWithUnsignedLongLong:currentFileSize]
                            forKey:@"currentFileSize"];
          [resultDic safeSetObject:[NSNumber numberWithUnsignedLongLong:totalFileSize]
                            forKey:@"totalFileSize"];
          [resultDic safeSetObject:[NSNumber numberWithUnsignedInt:messageInfoIndex]
                            forKey:@"messageInfoIndex"];
          [resultDic safeSetObject:[NSNumber numberWithUnsignedLongLong:currentIndexFileSize]
                            forKey:@"currentIndexFileSize"];
          [resultDic safeSetObject:[NSNumber numberWithUnsignedLongLong:totalIndexFileSize]
                            forKey:@"totalIndexFileSize"];
          self.events(resultDic);
        };
...
- (void)sendMediaMessage:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    ZIMMessageSendConfig *sendConfig =
        [ZIMPluginConverter oZIMMessageSendConfig:[call.arguments safeObjectForKey:@"config"]];
    NSNumber *messageID = [call.arguments safeObjectForKey:@"messageID"];
    NSNumber *progressID = [call.arguments safeObjectForKey:@"mediaUploadingCallbackID"];
    NSNumber *messageAttachedCallbackID =
        [call.arguments safeObjectForKey:@"messageAttachedCallbackID"];
    ...
    sendNotification.onMediaUploadingProgress =
        ^(ZIMMediaMessage *_Nonnull message, unsigned long long currentFileSize,
          ...
          [resultDic safeSetObject:handle forKey:@"handle"];
          [resultDic safeSetObject:@"uploadMediaProgress" forKey:@"method"];
          [resultDic safeSetObject:progressID forKey:@"mediaUploadingCallbackID"];
          [resultDic safeSetObject:messageID forKey:@"messageID"];
          [resultDic safeSetObject:messageDic forKey:@"message"];
          [resultDic safeSetObject:[NSNumber numberWithUnsignedLongLong:currentFileSize]
                            forKey:@"currentFileSize"];
...
- (void)downloadMediaFile:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    ZIMMediaDownloadConfig *config =
        [ZIMPluginConverter oZIMMediaDownloadConfig:[call.arguments safeObjectForKey:@"config"]];
...
- (void)editMessage:(FlutterMethodCall *)call result:(FlutterResult)result {
    NSString *handle = [call.arguments objectForKey:@"handle"];
    ZIM *zim = self.engineMap[handle];
    if (!zim) {
        result([FlutterError errorWithCode:@"-1" message:@"no native instance" details:nil]);
    ...
    ZIMMessage *message = (ZIMMediaMessage *)[ZIMPluginConverter
        oZIMMessage:[call.arguments safeObjectForKey:@"message"]];
    NSNumber *messageID = [call.arguments safeObjectForKey:@"messageID"];
    NSNumber *mediaUploadingCallbackID =
        [call.arguments safeObjectForKey:@"mediaUploadingCallbackID"];
...
- (void)cancelSendingMessage:(FlutterMethodCall *)call result:(FlutterResult)result {
    NSString *handle = [call.arguments objectForKey:@"handle"];
    ZIM *zim = self.engineMap[handle];
    if (!zim) {
        result([FlutterError errorWithCode:@"-1" message:@"no native instance" details:nil]);
    ...
    ZIMSendingMessageCancelConfig *config = [[ZIMSendingMessageCancelConfig alloc] init];
    [zim cancelSendingMessage:message
                       config:config
                     callback:^(ZIMError *_Nonnull errorInfo) {
                       if (errorInfo.code == 0) {
                           result(nil);
...
- (void)pinMessage:(FlutterMethodCall *)call result:(FlutterResult)result {
    NSString *handle = [call.arguments objectForKey:@"handle"];
    ZIM *zim = self.engineMap[handle];
    if (!zim) {
        result([FlutterError errorWithCode:@"-1" message:@"no native instance" details:nil]);
    ...
    ZIMMessagePinConfig *config = [[ZIMMessagePinConfig alloc] init];
    config.disableAutoReplace = ((NSNumber *)[[call.arguments safeObjectForKey:@"config"]
                                     safeObjectForKey:@"disableAutoReplace"])
                                    .boolValue;

    [zim pinMessage:message
           isPinned:isPinned
             config:config
           callback:^(ZIMError *_Nonnull errorInfo) {
             if (errorInfo.code == 0) {
...
- (void)queryPinnedMessageList:(FlutterMethodCall *)call result:(FlutterResult)result {
    NSString *handle = [call.arguments objectForKey:@"handle"];
    ZIM *zim = self.engineMap[handle];
    if (!zim) {
        result([FlutterError errorWithCode:@"-1" message:@"no native instance" details:nil]);
...
- (void)leaveAllRoom:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    [zim leaveAllRoom:^(NSArray<NSString *> *_Nonnull roomIDList, ZIMError *_Nonnull errorInfo) {
      if (errorInfo.code == 0) {
          NSMutableDictionary *resultDic = [[NSMutableDictionary alloc] init];
          [resultDic setObject:roomIDList forKey:@"roomIDs"];
          result(resultDic);
      } else {
          result([FlutterError errorWithCode:[NSString stringWithFormat:@"%d", (int)errorInfo.code]
                                     message:errorInfo.message
    ...
    [zim muteGroup:isMute
          ...
          callback:^(NSString *_Nonnull groupID, BOOL isMuted, ZIMGroupMuteInfo *_Nonnull info,
            ...
            if (errorInfo.code == 0) {
                ...
                [resultDic safeSetObject:groupMuteInfoDic forKey:@"mutedInfo"];
                result(resultDic);
            } else {
                result([FlutterError
                    errorWithCode:[NSString stringWithFormat:@"%d", (int)errorInfo.code]
...
- (void)queryGroupList:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    NSNumber *countModel = [call.arguments safeObjectForKey:@"count"];

    NSDictionary *configModel = [call.arguments safeObjectForKey:@"config"];
    if (countModel) {
        ZIMGroupListQueryConfig *config = [[ZIMGroupListQueryConfig alloc] init];
        if ([configModel safeObjectForKey:@"userIDs"])
            config.userIDs = [configModel safeObjectForKey:@"userIDs"];
        if ([configModel safeObjectForKey:@"nextFlag"])
            config.nextFlag = [[configModel safeObjectForKey:@"nextFlag"] longLongValue];
        int tempCount = [countModel intValue];
        if (tempCount < 0) {
            tempCount = 0;
        }
        unsigned int count = tempCount;
        [zim queryGroupListWithCount:count
                              config:config
                            callback:^(NSArray<ZIMGroup *> *_Nonnull groupList, long long nextFlag,
                                       ZIMError *_Nonnull errorInfo) {
                              if (errorInfo.code == 0) {
                                  NSArray *basicGroupList =
        ...
        [zim queryGroupList:^(NSArray<ZIMGroup *> *_Nonnull groupList, long long nextFlag,
                              ZIMError *_Nonnull errorInfo) {
          if (errorInfo.code == 0) {
...
- (void)queryCallInvitationList:(FlutterMethodCall *)call result:(FlutterResult)result {
    NSString *handle = [call.arguments objectForKey:@"handle"];
    ZIM *zim = self.engineMap[handle];
    if (!zim) {
        result([FlutterError errorWithCode:@"-1" message:@"no native instance" details:nil]);
...
- (void)addMessageReaction:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    ZIMMessageReactionAddConfig *config =
        [ZIMPluginConverter oZIMMessageReactionAddConfig:[call.arguments objectForKey:@"config"]];
...
- (void)deleteMessageAllReactions:(FlutterMethodCall *)call result:(FlutterResult)result {
    NSString *handle = [call.arguments objectForKey:@"handle"];
    ZIM *zim = self.engineMap[handle];
    if (!zim) {
        result([FlutterError errorWithCode:@"-1" message:@"no native instance" details:nil]);
    ...
    [zim deleteMessageAllReactionsByMessage:message
                                   callback:^(ZIMError *_Nonnull errorInfo) {
                                     if (errorInfo.code == 0) {
                                         result(nil);
                                     } else {
...
- (void)queryMessageReactionUserList:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    [zim
        queryMessageReactionUserListByMessage:message
                                       config:config
                                     callback:^(ZIMMessage *_Nonnull message,
                                                NSArray<ZIMMessageReactionUserFullInfo *>
                                                    *_Nonnull userList,
                                       ...
                                       if (errorInfo.code == 0) {
                                           ...
                                           NSArray *userListDic = [ZIMPluginConverter
                                               mZIMMessageReactionUserInfoListByFullInfoList:
                                                   userList];
                                           NSArray *newUserListDic = [ZIMPluginConverter
                                               mZIMMessageReactionUserFullInfoList:userList];

                                           [resultMtDic safeSetObject:messageDic forKey:@"message"];
                                           [resultMtDic safeSetObject:userListDic
                                                               forKey:@"userList"];
                                           [resultMtDic safeSetObject:newUserListDic
                                                               forKey:@"userInfoList"];
