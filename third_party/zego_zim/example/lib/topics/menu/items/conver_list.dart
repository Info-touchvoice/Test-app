  ...
  Widget build(BuildContext context) {
    return Scrollbar(
      ...
      child: SingleChildScrollView(
        ...
        controller: scrollController,
        child: Center(child: Column(children: widget._converWidgetList)),
      ),
    );
  }
      ...
      for (ZIMConversationChangeInfo changeInfo in conversationChangeInfoList) {
        switch (changeInfo.event) {
          case ZIMConversationEvent.added:
            ...
            ConverListCell newConverListCell = ConverListCell(
              changeInfo.conversation!,
            );
          ...
          case ZIMConversationEvent.updated:
            ...
            int oldConverListCellIndex = widget._converWidgetList.indexOf(
              oldConverListCell,
            );
            ConverListCell newConverListCell = ConverListCell(
              changeInfo.conversation!,
