            ...
            children: [
              ...
              Container(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    ZIMGroupNoticeUpdatedResult result =
                        await ZIM.getInstance()!.updateGroupNotice(
                              widget.newGroupNotice,
                              widget.groupID,
                            );
                    setState(() {
        ...
        children: [
          Expanded(
            child: Column(
              ...
              children: [
                Text('Group Notice', style: TextStyle(), textScaleFactor: 1.2),
                Text(groupNotice, style: TextStyle(color: Colors.grey)),
              ],
            ),
          ),
          IconButton(
            ...
            icon: Icon(Icons.chevron_right_outlined, color: Colors.grey),
          ),
        ],
      ),
    );
