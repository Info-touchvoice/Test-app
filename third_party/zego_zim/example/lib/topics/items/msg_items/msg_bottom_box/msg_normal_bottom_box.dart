                ...
                IconButton(
                  onPressed: () {
                    setState(() {
                      FocusScope.of(context).unfocus();
                      widget.emojiShowing = false;
                      widget.bottomExpandShowing = !widget.bottomExpandShowing;
            ...
            Offstage(
              ...
              child: MsgNormalBottomBoxExpand(
                onCameraIconButtonOnPressed: (path, [fileName]) {
                  widget.onCameraIconButtonOnPressed(path, fileName);
                },
                onImageIconButtonOnPressed: (path, [fileName]) {
                  widget.onImageIconButtonOnPressed(path, fileName);
                },
                onVideoIconButtonOnPressed: (path, [fileName]) {
                  widget.onVideoIconButtonOnPressed(path, fileName);
                },
              ),
            ),
          ],
